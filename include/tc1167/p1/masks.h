...
#define P1_PDR_PD2_MASK                 0x00007000
#define P1_PDR_PD2_SHIFT                12
#define P1_PDR_PDSSC1B_MASK             0x00070000
#define P1_PDR_PDSSC1B_SHIFT            16
#define P1_PDR_PDBRKOUT0_MASK           0x00700000
#define P1_PDR_PDBRKOUT0_SHIFT          20
