...
/****************** Masks for FLASH0_CFTEST_t **********************/
/*
   FLASH0_CFTEST         "CPU Flash Test Register"
*/
/**********************************************************/

#define FLASH0_CFTEST_MASK              0x000003fd
#define FLASH0_CFTEST_TE_MASK           0x00000001
#define FLASH0_CFTEST_TE_SHIFT          0
#define FLASH0_CFTEST_ECENCDIS_MASK     0x00000004
#define FLASH0_CFTEST_ECENCDIS_SHIFT    2
#define FLASH0_CFTEST_ECDECDIS_MASK     0x00000008
#define FLASH0_CFTEST_ECDECDIS_SHIFT    3
#define FLASH0_CFTEST_CONFSE_MASK       0x00000010
#define FLASH0_CFTEST_CONFSE_SHIFT      4
#define FLASH0_CFTEST_PREFEDIS_MASK     0x00000020
#define FLASH0_CFTEST_PREFEDIS_SHIFT    5
#define FLASH0_CFTEST_FSRAME_MASK       0x00000040
#define FLASH0_CFTEST_FSRAME_SHIFT      6
#define FLASH0_CFTEST_EEAS_MASK         0x00000080
#define FLASH0_CFTEST_EEAS_SHIFT        7
#define FLASH0_CFTEST_FSIINTEN_MASK     0x00000100
#define FLASH0_CFTEST_FSIINTEN_SHIFT    8
#define FLASH0_CFTEST_FSIINT_MASK       0x00000200
#define FLASH0_CFTEST_FSIINT_SHIFT      9



/****************** Masks for FLASH0_ECCR_t **********************/
/*
   FLASH0_ECCR           "ECC Read Register"
*/
/**********************************************************/

#define FLASH0_ECCR_MASK                0x000000ff
#define FLASH0_ECCR_ECCRCode_MASK       0x000000ff
#define FLASH0_ECCR_ECCRCode_SHIFT      0



/****************** Masks for FLASH0_ECCW_t **********************/
/*
   FLASH0_ECCW           "ECC Write Register"
*/
/**********************************************************/

#define FLASH0_ECCW_MASK                0x000000ff
#define FLASH0_ECCW_ECCWCode_MASK       0x000000ff
#define FLASH0_ECCW_ECCWCode_SHIFT      0
...
#define FLASH0_FCON_SLEEP_FSD_MASK      0x00008000
#define FLASH0_FCON_SLEEP_FSD_SHIFT     15
...
/****************** Masks for FLASH0_FSCON_t **********************/
/*
   FLASH0_FSCON          "Flash Size Configuration Register"
*/
/**********************************************************/

#define FLASH0_FSCON_MASK               0x00001fff
#define FLASH0_FSCON_PFSIZE_MASK        0x000000ff
#define FLASH0_FSCON_PFSIZE_SHIFT       0
#define FLASH0_FSCON_DFSIZE_MASK        0x00001f00
#define FLASH0_FSCON_DFSIZE_SHIFT       8
...
#define FLASH0_FSR_MASK                 0xf6edffff
...
#define FLASH0_FSR_VIS_MASK             0x20000000
#define FLASH0_FSR_VIS_SHIFT            29
#define FLASH0_FSR_ORIER_MASK           0x40000000
#define FLASH0_FSR_ORIER_SHIFT          30
...
#define FLASH0_PROCON0_MASK             0x0000dfff
...
#define FLASH0_PROCON1_MASK             0x00001fff
...
#define FLASH0_PROCON2_MASK             0x00009fff
...
#define FLASH0_PROCON2_TP_MASK          0x00008000
#define FLASH0_PROCON2_TP_SHIFT         15
...
#define PMU0_OVRCON_MASK                0x0000ff03
...
#define PMU0_OVRCON_PB0W_MASK           0x00000400
#define PMU0_OVRCON_PB0W_SHIFT          10
#define PMU0_OVRCON_PB1W_MASK           0x00000800
#define PMU0_OVRCON_PB1W_SHIFT          11
#define PMU0_OVRCON_PB0R_MASK           0x00001000
#define PMU0_OVRCON_PB0R_SHIFT          12
#define PMU0_OVRCON_PB1R_MASK           0x00002000
#define PMU0_OVRCON_PB1R_SHIFT          13
#define PMU0_OVRCON_PB0ERR_MASK         0x00004000
#define PMU0_OVRCON_PB0ERR_SHIFT        14
#define PMU0_OVRCON_PB1ERR_MASK         0x00008000
#define PMU0_OVRCON_PB1ERR_SHIFT        15
