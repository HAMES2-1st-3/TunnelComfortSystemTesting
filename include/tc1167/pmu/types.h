...
typedef union { /* 32 bits */
   struct {
      unsigned int TE:1;                /*  = [0..0] = 0x00000001 */
      unsigned int _bit1:1;             /* 0 = [1..1] = 0x00000002 */
      unsigned int ECENCDIS:1;          /*  = [2..2] = 0x00000004 */
      unsigned int ECDECDIS:1;          /*  = [3..3] = 0x00000008 */
      unsigned int CONFSE:1;            /*  = [4..4] = 0x00000010 */
      unsigned int PREFEDIS:1;          /*  = [5..5] = 0x00000020 */
      unsigned int FSRAME:1;            /*  = [6..6] = 0x00000040 */
      unsigned int EEAS:1;              /*  = [7..7] = 0x00000080 */
      unsigned int FSIINTEN:1;          /*  = [8..8] = 0x00000100 */
      unsigned int FSIINT:1;            /*  = [9..9] = 0x00000200 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH0_CFTEST_t_nonv;

typedef volatile FLASH0_CFTEST_t_nonv FLASH0_CFTEST_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int ECCRCode:8;          /*  = [0..7] = 0x000000ff */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH0_ECCR_t_nonv;

typedef volatile FLASH0_ECCR_t_nonv FLASH0_ECCR_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int ECCWCode:8;          /*  = [0..7] = 0x000000ff */
      unsigned int _bit8:1;             /* 0 = [8..8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH0_ECCW_t_nonv;

typedef volatile FLASH0_ECCW_t_nonv FLASH0_ECCW_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int SLEEP_FSD:1;         /*  = [15..15] = 0x00008000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int PFSIZE:8;            /*  = [0..7] = 0x000000ff */
      unsigned int DFSIZE:5;            /*  = [8..12] = 0x00001f00 */
      unsigned int _bit13:1;            /* 0 = [13..13] = 0x00002000 */
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH0_FSCON_t_nonv;

typedef volatile FLASH0_FSCON_t_nonv FLASH0_FSCON_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int VIS:1;               /*  = [29..29] = 0x20000000 */
      unsigned int ORIER:1;             /*  = [30..30] = 0x40000000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit6:1;             /* 0 = [6..6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7..7] = 0x00000080 */
      unsigned int PPERCTR:1;           /*  = [8..8] = 0x00000100 */
      unsigned int PEREN:1;             /*  = [9..9] = 0x00000200 */
      unsigned int PB0W:1;              /*  = [10..10] = 0x00000400 */
      unsigned int PB1W:1;              /*  = [11..11] = 0x00000800 */
      unsigned int PB0R:1;              /*  = [12..12] = 0x00001000 */
      unsigned int PB1R:1;              /*  = [13..13] = 0x00002000 */
      unsigned int PB0ERR:1;            /*  = [14..14] = 0x00004000 */
      unsigned int PB1ERR:1;            /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
