...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int DTMBE:1;             /*  = [16..16] = 0x00010000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
      unsigned int DTIEE:1;             /*  = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int TCPMEM:6;            /*  = [0..5] = 0x0000003f */
      unsigned int TCPCACHE:3;          /*  = [6..8] = 0x000001c0 */
      unsigned int TCDMEM:6;            /*  = [9..14] = 0x00007e00 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
      unsigned int TCDCACHE:3;          /*  = [16..18] = 0x00070000 */
      unsigned int MMUAV:1;             /*  = [19..19] = 0x00080000 */
      unsigned int FPUAV:1;             /*  = [20..20] = 0x00100000 */
      unsigned int _bit21:1;            /* 0 = [21..21] = 0x00200000 */
      unsigned int _bit22:1;            /* 0 = [22..22] = 0x00400000 */
      unsigned int _bit23:1;            /* 0 = [23..23] = 0x00800000 */
      unsigned int _bit24:1;            /* 0 = [24..24] = 0x01000000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) PRDCFG1_t_nonv;

typedef volatile PRDCFG1_t_nonv PRDCFG1_t;
