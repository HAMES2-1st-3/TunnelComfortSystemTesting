...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int EPE:1;               /*  = [8..8] = 0x00000100 */
      ...
      unsigned int SYNC:1;              /*  = [16..16] = 0x00010000 */
      unsigned int DDR:1;               /*  = [17..17] = 0x00020000 */
      unsigned int EBUDIV:2;            /*  = [18..19] = 0x000c0000 */
      unsigned int SYNCACK:1;           /*  = [20..20] = 0x00100000 */
      unsigned int DDRACK:1;            /*  = [21..21] = 0x00200000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int CFGEND:1;            /*  = [0..0] = 0x00000001 */
      unsigned int CFGERR:1;            /*  = [1..1] = 0x00000002 */
      unsigned int _bit2:1;             /* 0 = [2..2] = 0x00000004 */
      unsigned int _bit3:1;             /* 0 = [3..3] = 0x00000008 */
      unsigned int _bit4:1;             /* 0 = [4..4] = 0x00000010 */
      unsigned int _bit5:1;             /* 0 = [5..5] = 0x00000020 */
      ...
      unsigned int _bit29:1;            /* 0 = [29..29] = 0x20000000 */
      unsigned int _bit30:1;            /* 0 = [30..30] = 0x40000000 */
      unsigned int EBUCFG:1;            /*  = [31..31] = 0x80000000 */
   } bits;
   unsigned long reg; 
...
typedef union { /* 32 bits */
   struct {
      unsigned int STS:1;               /*  = [0..0] = 0x00000001 */
      unsigned int LCKABRT:1;           /*  = [1..1] = 0x00000002 */
      unsigned int _bit2:1;             /* 0 = [2..2] = 0x00000004 */
      unsigned int _bit3:1;             /* 0 = [3..3] = 0x00000008 */
      ...
      unsigned int LOCK_TIMEOUT:8;      /*  = [16..23] = 0x00ff0000 */
      unsigned int _bit24:1;            /* 0 = [24..24] = 0x01000000 */
      unsigned int _bit25:1;            /* 0 = [25..25] = 0x02000000 */
      unsigned int _bit26:1;            /* 0 = [26..26] = 0x04000000 */
      unsigned int _bit27:1;            /* 0 = [27..27] = 0x08000000 */
      ...
      unsigned int _bit29:1;            /* 0 = [29..29] = 0x20000000 */
      unsigned int _bit30:1;            /* 0 = [30..30] = 0x40000000 */
      unsigned int ALE:1;               /*  = [31..31] = 0x80000000 */
   } bits;
   unsigned long reg; 
