...
#ifndef _TC1767_FADC_STRUCTS_H_
#define _TC1767_FADC_STRUCTS_H_
/*
   TriCore TC1767
   Some struct definitions for conveniance
*/

#include <tc1767/fadc.h>
#ifndef FADC_BASE
...
typedef struct
{
    ...
    unsigned int    reserved19[0x1];    /* 0x50 */
    FADC_ALR_t      ALR;                /* 0x54 */
    unsigned int    reserved21[0x2];    /* 0x58 */
