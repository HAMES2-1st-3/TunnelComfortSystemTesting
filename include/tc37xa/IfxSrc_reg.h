...
#define SRC_VADC_G8_SR0_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF00386F0u)
/** Alias (User Manual Name) for SRC_VADC_G8_SR0_SR.
* To use register names with standard convension, please use SRC_VADC_G8_SR0_SR.
*/
#define SRC_VADCG8SR0 (SRC_VADC_G8_SR0_SR)

/** \brief 6F4, EVADC Group 8 Service Request 1 */
#define SRC_VADC_G8_SR1_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF00386F4u)
/** Alias (User Manual Name) for SRC_VADC_G8_SR1_SR.
* To use register names with standard convension, please use SRC_VADC_G8_SR1_SR.
*/
#define SRC_VADCG8SR1 (SRC_VADC_G8_SR1_SR)

/** \brief 6F8, EVADC Group 8 Service Request 2 */
#define SRC_VADC_G8_SR2_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF00386F8u)
/** Alias (User Manual Name) for SRC_VADC_G8_SR2_SR.
* To use register names with standard convension, please use SRC_VADC_G8_SR2_SR.
*/
#define SRC_VADCG8SR2 (SRC_VADC_G8_SR2_SR)

/** \brief 6FC, EVADC Group 8 Service Request 3 */
#define SRC_VADC_G8_SR3_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF00386FCu)
/** Alias (User Manual Name) for SRC_VADC_G8_SR3_SR.
* To use register names with standard convension, please use SRC_VADC_G8_SR3_SR.
*/
#define SRC_VADCG8SR3 (SRC_VADC_G8_SR3_SR)

/** \brief 700, EVADC Group 9 Service Request 0 */
#define SRC_VADC_G9_SR0_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038700u)
/** Alias (User Manual Name) for SRC_VADC_G9_SR0_SR.
* To use register names with standard convension, please use SRC_VADC_G9_SR0_SR.
*/
#define SRC_VADCG9SR0 (SRC_VADC_G9_SR0_SR)

/** \brief 704, EVADC Group 9 Service Request 1 */
#define SRC_VADC_G9_SR1_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038704u)
/** Alias (User Manual Name) for SRC_VADC_G9_SR1_SR.
* To use register names with standard convension, please use SRC_VADC_G9_SR1_SR.
*/
#define SRC_VADCG9SR1 (SRC_VADC_G9_SR1_SR)

/** \brief 708, EVADC Group 9 Service Request 2 */
#define SRC_VADC_G9_SR2_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038708u)
/** Alias (User Manual Name) for SRC_VADC_G9_SR2_SR.
* To use register names with standard convension, please use SRC_VADC_G9_SR2_SR.
*/
#define SRC_VADCG9SR2 (SRC_VADC_G9_SR2_SR)

/** \brief 70C, EVADC Group 9 Service Request 3 */
#define SRC_VADC_G9_SR3_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF003870Cu)
/** Alias (User Manual Name) for SRC_VADC_G9_SR3_SR.
* To use register names with standard convension, please use SRC_VADC_G9_SR3_SR.
*/
#define SRC_VADCG9SR3 (SRC_VADC_G9_SR3_SR)

/** \brief 710, EVADC Group 10 Service Request 0 */
#define SRC_VADC_G10_SR0_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038710u)
/** Alias (User Manual Name) for SRC_VADC_G10_SR0_SR.
* To use register names with standard convension, please use SRC_VADC_G10_SR0_SR.
*/
#define SRC_VADCG10SR0 (SRC_VADC_G10_SR0_SR)

/** \brief 714, EVADC Group 10 Service Request 1 */
#define SRC_VADC_G10_SR1_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038714u)
/** Alias (User Manual Name) for SRC_VADC_G10_SR1_SR.
* To use register names with standard convension, please use SRC_VADC_G10_SR1_SR.
*/
#define SRC_VADCG10SR1 (SRC_VADC_G10_SR1_SR)

/** \brief 718, EVADC Group 10 Service Request 2 */
#define SRC_VADC_G10_SR2_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038718u)
/** Alias (User Manual Name) for SRC_VADC_G10_SR2_SR.
* To use register names with standard convension, please use SRC_VADC_G10_SR2_SR.
*/
#define SRC_VADCG10SR2 (SRC_VADC_G10_SR2_SR)

/** \brief 71C, EVADC Group 10 Service Request 3 */
#define SRC_VADC_G10_SR3_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF003871Cu)
/** Alias (User Manual Name) for SRC_VADC_G10_SR3_SR.
* To use register names with standard convension, please use SRC_VADC_G10_SR3_SR.
*/
#define SRC_VADCG10SR3 (SRC_VADC_G10_SR3_SR)

/** \brief 720, EVADC Group 11 Service Request 0 */
#define SRC_VADC_G11_SR0_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038720u)
/** Alias (User Manual Name) for SRC_VADC_G11_SR0_SR.
* To use register names with standard convension, please use SRC_VADC_G11_SR0_SR.
*/
#define SRC_VADCG11SR0 (SRC_VADC_G11_SR0_SR)

/** \brief 724, EVADC Group 11 Service Request 1 */
#define SRC_VADC_G11_SR1_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038724u)
/** Alias (User Manual Name) for SRC_VADC_G11_SR1_SR.
* To use register names with standard convension, please use SRC_VADC_G11_SR1_SR.
*/
#define SRC_VADCG11SR1 (SRC_VADC_G11_SR1_SR)

/** \brief 728, EVADC Group 11 Service Request 2 */
#define SRC_VADC_G11_SR2_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF0038728u)
/** Alias (User Manual Name) for SRC_VADC_G11_SR2_SR.
* To use register names with standard convension, please use SRC_VADC_G11_SR2_SR.
*/
#define SRC_VADCG11SR2 (SRC_VADC_G11_SR2_SR)

/** \brief 72C, EVADC Group 11 Service Request 3 */
#define SRC_VADC_G11_SR3_SR /*lint --e(923, 9078)*/ (*(volatile Ifx_SRC_SRCR*)0xF003872Cu)
/** Alias (User Manual Name) for SRC_VADC_G11_SR3_SR.
* To use register names with standard convension, please use SRC_VADC_G11_SR3_SR.
*/
#define SRC_VADCG11SR3 (SRC_VADC_G11_SR3_SR)
