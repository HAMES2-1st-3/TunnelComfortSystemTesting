...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit29:1;            /* 0 = [29] = 0x20000000 */
      unsigned int DMAPRIO:2;           /*  = [30..31] = 0xc0000000 */
   } bits;
   unsigned long reg;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) DMA_MEnAENRm_t_nonv;

typedef volatile DMA_MEnAENRm_t_nonv DMA_MEnAENRm_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) DMA_MEnARRm_t_nonv;

typedef volatile DMA_MEnARRm_t_nonv DMA_MEnARRm_t;
