...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int FEN0:1;              /*  = [8] = 0x00000100 */
      unsigned int REN0:1;              /*  = [9] = 0x00000200 */
      unsigned int LDEN0:1;             /*  = [10] = 0x00000400 */
      unsigned int EIEN0:1;             /*  = [11] = 0x00000800 */
      ...
      unsigned int FEN1:1;              /*  = [24] = 0x01000000 */
      unsigned int REN1:1;              /*  = [25] = 0x02000000 */
      unsigned int LDEN1:1;             /*  = [26] = 0x04000000 */
      unsigned int EIEN1:1;             /*  = [27] = 0x08000000 */
      unsigned int INP1:3;              /*  = [28..30] = 0x70000000 */
      unsigned int _bit31:1;            /* 0 = [31] = 0x80000000 */
   } bits;
   unsigned long reg;
} __attribute__((aligned(4))) SCU_EICRm_t_nonv;

typedef volatile SCU_EICRm_t_nonv SCU_EICRm_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit2:1;             /* 0 = [2] = 0x00000004 */
      unsigned int _bit3:1;             /* 0 = [3] = 0x00000008 */
      unsigned int DFEN:1;              /*  = [4] = 0x00000010 */
      unsigned int _bit5:1;             /* 0 = [5] = 0x00000020 */
      unsigned int _bit6:1;             /* 0 = [6] = 0x00000040 */
      unsigned int EDCON:2;             /*  = [7..8] = 0x00000180 */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) SCU_ESRCFGm_t_nonv;

typedef volatile SCU_ESRCFGm_t_nonv SCU_ESRCFGm_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) SCU_SRCm_t_nonv;

typedef volatile SCU_SRCm_t_nonv SCU_SRCm_t;
