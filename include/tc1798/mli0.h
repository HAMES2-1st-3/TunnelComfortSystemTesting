...
#include <tc1798/mli0/addr.h>

#include <tc1798/mli0/masks.h>
#include <tc1798/mli0-1/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1798/mli0/types.h>
#include <tc1798/mli0-1/sharetypes.h>
...
SFR_NOABS (MLI0_AER0, MLIn_AERm_t, MLI0_AER0_ADDR); /* "Access Enable Register 0" */
SFR_NOABS (MLI0_AER1, MLIn_AERm_t, MLI0_AER1_ADDR); /* "Access Enable Register 1" */
SFR_NOABS (MLI0_ARR0, MLIn_ARRm_t, MLI0_ARR0_ADDR); /* "Access Range Register 0" */
SFR_NOABS (MLI0_ARR1, MLIn_ARRm_t, MLI0_ARR1_ADDR); /* "Access Range Register 1" */
SFR_NOABS (MLI0_FDR, MLIn_FDR_t, MLI0_FDR_ADDR);  /* "Fractional Divider Register" */
SFR_NOABS (MLI0_GINTR, MLIn_GINTR_t, MLI0_GINTR_ADDR); /* "Global Interrupt Set Register" */
SFR_NOABS (MLI0_ID, MLIn_ID_t, MLI0_ID_ADDR);     /* "Module Identification Register" */
...
SFR_NOABS (MLI0_TRSTATR, MLIn_TRSTATR_t, MLI0_TRSTATR_ADDR); /* "Transmitter Receiver Status Register" */
