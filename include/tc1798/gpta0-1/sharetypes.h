...
#ifndef _HAVE_TRICORE_GPTA0_1_SHARETYPES_H_
#define _HAVE_TRICORE_GPTA0_1_SHARETYPES_H_
...
typedef union { /* 32 bits */
   struct {
      unsigned int RCA:1;               /*  = [0] = 0x00000001 */
      unsigned int OCA:1;               /*  = [1] = 0x00000002 */
      unsigned int RZE:1;               /*  = [2] = 0x00000004 */
      unsigned int FZE:1;               /*  = [3] = 0x00000008 */
      unsigned int RCK:1;               /*  = [4] = 0x00000010 */
      unsigned int FCK:1;               /*  = [5] = 0x00000020 */
      unsigned int QCK:1;               /*  = [6] = 0x00000040 */
      unsigned int RRE:1;               /*  = [7] = 0x00000080 */
      unsigned int FRE:1;               /*  = [8] = 0x00000100 */
      unsigned int CRE:1;               /*  = [9] = 0x00000200 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int RTG:1;               /*  = [24] = 0x01000000 */
      unsigned int _bit25:1;            /* 0 = [25] = 0x02000000 */
      unsigned int _bit26:1;            /* 0 = [26] = 0x04000000 */
      unsigned int _bit27:1;            /* 0 = [27] = 0x08000000 */
      unsigned int _bit28:1;            /* 0 = [28] = 0x10000000 */
...
typedef union { /* 32 bits */
   struct { /* GPTA0 Global Timer Cell Control Register 00 [Capture Mode] */
      ...
      unsigned int NE:1;                /*  = [6] = 0x00000040 */
      unsigned int BYP:1;               /*  = [7] = 0x00000080 */
      unsigned int EOA:1;               /*  = [8] = 0x00000100 */
   ...
   struct { /* GPTA0 Global Timer Cell Control Register 00 [Compare Mode] */
      unsigned int MOD:2;               /*  = [0..1] = 0x00000003 */
      unsigned int OSM:1;               /*  = [2] = 0x00000004 */
      unsigned int REN:1;               /*  = [3] = 0x00000008 */
      unsigned int GES:1;               /*  = [4] = 0x00000010 */
      unsigned int CAC:1;               /*  = [5] = 0x00000020 */
      unsigned int CAT:1;               /*  = [6] = 0x00000040 */
      unsigned int BYP:1;               /*  = [7] = 0x00000080 */
      unsigned int EOA:1;               /*  = [8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9] = 0x00000200 */
      unsigned int CEN:1;               /*  = [10] = 0x00000400 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int REN:1;               /*  = [7] = 0x00000080 */
...
typedef union { /* 32 bits */
   struct { /* GPTA0 Local Timer Cell Control Register 00 [Capture Mode] */
      unsigned int MOD:2;               /*  = [0..1] = 0x00000003 */
      unsigned int OSM:1;               /*  = [2] = 0x00000004 */
      unsigned int REN:1;               /*  = [3] = 0x00000008 */
      unsigned int RED:1;               /*  = [4] = 0x00000010 */
   ...
   struct { /* GPTA0 Local Timer Cell Control Register 00 [Compare Mode] */
      unsigned int MOD:2;               /*  = [0..1] = 0x00000003 */
      unsigned int OSM:1;               /*  = [2] = 0x00000004 */
      unsigned int REN:1;               /*  = [3] = 0x00000008 */
   ...
   struct { /* GPTA0 Local Timer Cell Control Register 00 [Timer Mode ILM=0] */
      unsigned int MOD:2;               /*  = [0..1] = 0x00000003 */
      unsigned int OSM:1;               /*  = [2] = 0x00000004 */
      unsigned int REN:1;               /*  = [3] = 0x00000008 */
      unsigned int RED:1;               /*  = [4] = 0x00000010 */
   ...
   struct { /* GPTA0 Local Timer Cell Control Register 00 [Timer Mode ILM=1] */
      unsigned int MOD:2;               /*  = [0..1] = 0x00000003 */
      unsigned int OSM:1;               /*  = [2] = 0x00000004 */
      unsigned int REN:1;               /*  = [3] = 0x00000008 */
      unsigned int PEN:1;               /*  = [4] = 0x00000010 */
      unsigned int AIL:1;               /*  = [5] = 0x00000020 */
      unsigned int SLO:1;               /*  = [6] = 0x00000040 */
      unsigned int CUDCLR:1;            /*  = [7] = 0x00000080 */
      unsigned int ILM:1;               /*  = [8] = 0x00000100 */
      unsigned int CUD:1;               /*  = [9] = 0x00000200 */
...
#endif /* _HAVE_TRICORE_GPTA0_1_SHARETYPES_H_ */
