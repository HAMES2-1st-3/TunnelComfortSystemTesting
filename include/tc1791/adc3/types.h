...
#ifndef _HAVE_TRICORE_ADC3_TYPES_H_
#define _HAVE_TRICORE_ADC3_TYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) ADC3_Q0R0_t_nonv;

typedef volatile ADC3_Q0R0_t_nonv ADC3_Q0R0_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) ADC3_Q0R2_t_nonv;

typedef volatile ADC3_Q0R2_t_nonv ADC3_Q0R2_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) ADC3_Q0R4_t_nonv;

typedef volatile ADC3_Q0R4_t_nonv ADC3_Q0R4_t;


#endif /* _HAVE_TRICORE_ADC3_TYPES_H_ */
