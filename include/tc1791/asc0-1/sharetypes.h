...
#ifndef _HAVE_TRICORE_ASC0_1_SHARETYPES_H_
#define _HAVE_TRICORE_ASC0_1_SHARETYPES_H_
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int STP:1;               /*  = [3] = 0x00000008 */
      unsigned int REN:1;               /*  = [4] = 0x00000010 */
      unsigned int PEN:1;               /*  = [5] = 0x00000020 */
      unsigned int FEN:1;               /*  = [6] = 0x00000040 */
      unsigned int OEN:1;               /*  = [7] = 0x00000080 */
      unsigned int PE:1;                /*  = [8] = 0x00000100 */
      unsigned int FE:1;                /*  = [9] = 0x00000200 */
      unsigned int OE:1;                /*  = [10] = 0x00000400 */
      unsigned int FDE:1;               /*  = [11] = 0x00000800 */
      unsigned int ODD:1;               /*  = [12] = 0x00001000 */
      unsigned int BRS:1;               /*  = [13] = 0x00002000 */
      unsigned int LB:1;                /*  = [14] = 0x00004000 */
      unsigned int R:1;                 /*  = [15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19] = 0x00080000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int RIS:1;               /*  = [0] = 0x00000001 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit2:1;             /* 0 = [2] = 0x00000004 */
      unsigned int _bit3:1;             /* 0 = [3] = 0x00000008 */
      unsigned int CLRREN:1;            /*  = [4] = 0x00000010 */
      unsigned int SETREN:1;            /*  = [5] = 0x00000020 */
      unsigned int _bit6:1;             /* 0 = [6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7] = 0x00000080 */
      unsigned int CLRPE:1;             /*  = [8] = 0x00000100 */
      unsigned int CLRFE:1;             /*  = [9] = 0x00000200 */
      unsigned int CLROE:1;             /*  = [10] = 0x00000400 */
      unsigned int SETPE:1;             /*  = [11] = 0x00000800 */
      unsigned int SETFE:1;             /*  = [12] = 0x00001000 */
      unsigned int SETOE:1;             /*  = [13] = 0x00002000 */
      unsigned int _bit14:1;            /* 0 = [14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17] = 0x00020000 */
...
#endif /* _HAVE_TRICORE_ASC0_1_SHARETYPES_H_ */
