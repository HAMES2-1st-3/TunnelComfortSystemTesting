...
#ifndef _TC1791_CAN_STRUCTS_H_
#define _TC1791_CAN_STRUCTS_H_
/*
   TriCore TC1791
...
typedef struct
{
    ...
    unsigned int    reserved81[0x39];   /* 0x41c */
    CAN_NODE_t      NODE3;              /* 0x500 */
    unsigned int    reserved83[0x2b9];  /* 0x51c */
    CAN_MO_t        MO[0x80];           /* 0x1000 */
    unsigned int    reserved85[0x7ff];  /* 0x2000 */
    CAN_STPTR0_t    STPTR0;             /* 0x3ffc */
} CAN_t;

#endif /* _TC1791_CAN_STRUCTS_H_ */
