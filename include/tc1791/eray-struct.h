...
#ifndef _TC1791_ERAY_STRUCTS_H_
#define _TC1791_ERAY_STRUCTS_H_
/*
   TriCore TC1791
...
typedef struct
{
    ...
    unsigned int    reserved272[0x3a];  /* 0x718 */
    ERAY_SECCON_t   SECCON;             /* 0x800 */
    ERAY_SEDCON_t   SEDCON;             /* 0x804 */
    ERAY_DEDCON_t   DEDCON;             /* 0x808 */
    ERAY_ECCR_t     ECCR;               /* 0x80c */
    ERAY_ECCW_t     ECCW;               /* 0x810 */
} ERAY_t;

#endif /* _TC1791_ERAY_STRUCTS_H_ */
