...
#ifndef _TC1764_CAN_STRUCTS_H_
#define _TC1764_CAN_STRUCTS_H_
/*
   TriCore TC1764
   Some struct definitions for conveniance
*/

#include <tc1764/can.h>
#ifndef CAN_BASE
...
typedef struct
{
    ...
    CAN_ID_t        ID;                 /* 0x8 */
    CAN_FDR_t       FDR;                /* 0xc */
    unsigned int    reserved4[0x36];    /* 0x10 */
