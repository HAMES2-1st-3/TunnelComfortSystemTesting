...
#ifndef _HAVE_TRICORE_PMI_TYPES_H_
#define _HAVE_TRICORE_PMI_TYPES_H_
...
typedef union { /* 32 bits */
   struct {
      unsigned int CC2SPR:1;            /*  = [0..0] = 0x00000001 */
      unsigned int CCBYP:1;             /*  = [1..1] = 0x00000002 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int CCINV:1;             /*  = [0..0] = 0x00000001 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int PCSZ:2;              /*  = [0..1] = 0x00000003 */
      unsigned int _bit2:1;             /* 0 = [2..2] = 0x00000004 */
      unsigned int _bit3:1;             /* 0 = [3..3] = 0x00000008 */
      unsigned int PMEMSZ:3;            /*  = [4..6] = 0x00000070 */
      unsigned int _bit7:1;             /* 0 = [7..7] = 0x00000080 */
      unsigned int _bit8:1;             /* 0 = [8..8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
...
#endif /* _HAVE_TRICORE_PMI_TYPES_H_ */
