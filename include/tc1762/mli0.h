...
#include <tc1762/mli0/addr.h>

#include <tc1762/mli0/masks.h>
#include <tc1762/mli0/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1762/mli0/types.h>
#include <tc1762/mli0/sharetypes.h>
...
SFR_NOABS (MLI0_FDR, MLI0_FDR_t, MLI0_FDR_ADDR);  /* "MLI Fractional Divider Register" */
SFR_NOABS (MLI0_GINTR, MLI0_GINTR_t, MLI0_GINTR_ADDR); /* "MLI Global Interrupt Set Register" */
SFR_NOABS (MLI0_ID, MLI0_ID_t, MLI0_ID_ADDR);     /* "MLI Module Identification Register" */
...
SFR_NOABS (MLI0_TRSTATR, MLI0_TRSTATR_t, MLI0_TRSTATR_ADDR); /* "Transmitter Registers Status Register" */
