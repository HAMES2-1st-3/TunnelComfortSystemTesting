...
#ifndef _HAVE_TRICORE_CERBERUS_SHARETYPES_H_
#define _HAVE_TRICORE_CERBERUS_SHARETYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) CBS_SRCm_t_nonv;

typedef volatile CBS_SRCm_t_nonv CBS_SRCm_t;


#endif /* _HAVE_TRICORE_CERBERUS_SHARETYPES_H_ */
