...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) P1_PDR0_t_nonv;

typedef volatile P1_PDR0_t_nonv P1_PDR0_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) P1_PDR1_t_nonv;

typedef volatile P1_PDR1_t_nonv P1_PDR1_t;
