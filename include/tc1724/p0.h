...
/* block "P0" of TriCore TC1724 (10 SFRs) */

#include <tc1724/p0/addr.h>

#include <tc1724/p0/masks.h>
#include <tc1724/p0-6_8-12/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1724/p0/types.h>
...
SFR_ABS (P0_PDR0, P0_PDR0_t, P0_PDR0_ADDR);       /* "Port 0 Pad Driver Mode 0 Register" */
SFR_ABS (P0_PDR1, P0_PDR1_t, P0_PDR1_ADDR);       /* "Port 0 Pad Driver Mode 1 Register" */
