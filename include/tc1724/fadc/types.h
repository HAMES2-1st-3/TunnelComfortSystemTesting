...
typedef union { /* 32 bits */
   struct {
      unsigned int ALIAS0:1;            /*  = [0] = 0x00000001 */
      unsigned int _bit1:1;             /* 0 = [1] = 0x00000002 */
      unsigned int ALIAS1:1;            /*  = [2] = 0x00000004 */
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) FADC_FRR1_t_nonv;

typedef volatile FADC_FRR1_t_nonv FADC_FRR1_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int CALCH:1;             /*  = [26] = 0x04000000 */
      unsigned int _bit27:1;            /* 0 = [27] = 0x08000000 */
      unsigned int _bit28:1;            /* 0 = [28] = 0x10000000 */
      unsigned int _bit29:1;            /* 0 = [29] = 0x20000000 */
      unsigned int _bit30:1;            /* 0 = [30] = 0x40000000 */
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) FADC_IRR11_t_nonv;

typedef volatile FADC_IRR11_t_nonv FADC_IRR11_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) FADC_SFRR1_t_nonv;

typedef volatile FADC_SFRR1_t_nonv FADC_SFRR1_t;
