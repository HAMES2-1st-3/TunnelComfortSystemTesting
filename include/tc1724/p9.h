...
#include <tc1724/p9/addr.h>

#include <tc1724/p9/masks.h>
#include <tc1724/p0-6_8-12/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1724/p9/types.h>
...
SFR_ABS (P9_PDR0, P9_PDR0_t, P9_PDR0_ADDR);       /* "Port 9 Pad Driver Mode 0 Register" */
SFR_ABS (P9_PDR1, Pn_PDRm_t, P9_PDR1_ADDR);       /* "Port 9 Pad Driver Mode 1 Register" */
