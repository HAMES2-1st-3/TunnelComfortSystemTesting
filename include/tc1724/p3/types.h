...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) P3_PDR0_t_nonv;

typedef volatile P3_PDR0_t_nonv P3_PDR0_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) P3_PDR1_t_nonv;

typedef volatile P3_PDR1_t_nonv P3_PDR1_t;
