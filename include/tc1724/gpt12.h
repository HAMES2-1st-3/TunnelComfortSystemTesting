...
/* block "GPT12" of TriCore TC1724 (40 SFRs) */

#include <tc1724/gpt12/addr.h>

#include <tc1724/gpt12/masks.h>
#include <tc1724/gpt12/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1724/gpt12/types.h>
#include <tc1724/gpt12/sharetypes.h>
...
SFR_ABS (GPT120_T2, GPT120_T2_t, GPT120_T2_ADDR); /* "Timer T2 Register" */
SFR_ABS (GPT120_T2CON, GPTn_T2CON_t, GPT120_T2CON_ADDR); /* "Timer T2 Control Register" */
SFR_ABS (GPT120_T3, GPT120_T3_t, GPT120_T3_ADDR); /* "Timer T3 Register" */
SFR_ABS (GPT120_T3CON, GPTn_T3CON_t, GPT120_T3CON_ADDR); /* "Timer T3 Control Register" */
SFR_ABS (GPT120_T4, GPT120_T4_t, GPT120_T4_ADDR); /* "Timer T4 Register" */
SFR_ABS (GPT120_T4CON, GPTn_T4CON_t, GPT120_T4CON_ADDR); /* "Timer T4 Control Register" */
SFR_ABS (GPT120_T5, GPTn_Tm_t, GPT120_T5_ADDR);   /* "Timer T5 Register" */
SFR_ABS (GPT120_T5CON, GPTn_T5CON_t, GPT120_T5CON_ADDR); /* "Timer T5 Control Register" */
SFR_ABS (GPT120_T6, GPTn_Tm_t, GPT120_T6_ADDR);   /* "Timer T6 Register" */
SFR_ABS (GPT120_T6CON, GPTn_T6CON_t, GPT120_T6CON_ADDR); /* "Timer T6 Control Register" */
...
SFR_ABS (GPT121_T2, GPT121_T2_t, GPT121_T2_ADDR); /* "Timer T2 Register" */
SFR_ABS (GPT121_T2CON, GPTn_T2CON_t, GPT121_T2CON_ADDR); /* "Timer T2 Control Register" */
SFR_ABS (GPT121_T3, GPT121_T3_t, GPT121_T3_ADDR); /* "Timer T3 Register" */
SFR_ABS (GPT121_T3CON, GPTn_T3CON_t, GPT121_T3CON_ADDR); /* "Timer T3 Control Register" */
SFR_ABS (GPT121_T4, GPT121_T4_t, GPT121_T4_ADDR); /* "Timer T4 Register" */
SFR_ABS (GPT121_T4CON, GPTn_T4CON_t, GPT121_T4CON_ADDR); /* "Timer T4 Control Register" */
SFR_ABS (GPT121_T5, GPTn_Tm_t, GPT121_T5_ADDR);   /* "Timer T5 Register" */
SFR_ABS (GPT121_T5CON, GPTn_T5CON_t, GPT121_T5CON_ADDR); /* "Timer T5 Control Register" */
SFR_ABS (GPT121_T6, GPTn_Tm_t, GPT121_T6_ADDR);   /* "Timer T6 Register" */
SFR_ABS (GPT121_T6CON, GPTn_T6CON_t, GPT121_T6CON_ADDR); /* "Timer T6 Control Register" */
