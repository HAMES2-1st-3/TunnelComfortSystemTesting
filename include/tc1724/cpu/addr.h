...
#define ADEDCTL_ADDR          0xF87FFC30     /* "Address Error Detection Control Register" */
#define WREDCTL_ADDR          0xF87FFC38     /* "Write Data Error Detection Control Register" */
#define RDEDCTL_ADDR          0xF87FFC40     /* "Read Data Error Detection Control Register" */
#define REEDCTL_ADDR          0xF87FFC48     /* "Response Error Detection Control Register" */
