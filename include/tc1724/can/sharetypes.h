...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int EMPTY:1;             /*  = [24] = 0x01000000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int MIDE:1;              /*  = [29] = 0x20000000 */
      unsigned int _bit30:1;            /* 0 = [30] = 0x40000000 */
      unsigned int _bit31:1;            /* 0 = [31] = 0x80000000 */
   } bits;
   unsigned long reg;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int IDE:1;               /*  = [29] = 0x20000000 */
...
typedef union { /* 32 bits */
   struct { /* Message Object 0 Control Register */
      unsigned int RESRXPND:1;          /*  = [0] = 0x00000001 */
      unsigned int RESTXPND:1;          /*  = [1] = 0x00000002 */
      unsigned int RESRXUPD:1;          /*  = [2] = 0x00000004 */
      unsigned int RESNEWDAT:1;         /*  = [3] = 0x00000008 */
      unsigned int RESMSGLST:1;         /*  = [4] = 0x00000010 */
      unsigned int RESMSGVAL:1;         /*  = [5] = 0x00000020 */
      unsigned int RESRTSEL:1;          /*  = [6] = 0x00000040 */
      unsigned int RESRXEN:1;           /*  = [7] = 0x00000080 */
      unsigned int RESTXRQ:1;           /*  = [8] = 0x00000100 */
      unsigned int RESTXEN0:1;          /*  = [9] = 0x00000200 */
      unsigned int RESTXEN1:1;          /*  = [10] = 0x00000400 */
      unsigned int RESDIR:1;            /*  = [11] = 0x00000800 */
      ...
      unsigned int SETRXPND:1;          /*  = [16] = 0x00010000 */
      unsigned int SETTXPND:1;          /*  = [17] = 0x00020000 */
      unsigned int SETRXUPD:1;          /*  = [18] = 0x00040000 */
      unsigned int SETNEWDAT:1;         /*  = [19] = 0x00080000 */
      unsigned int SETMSGLST:1;         /*  = [20] = 0x00100000 */
      unsigned int SETMSGVAL:1;         /*  = [21] = 0x00200000 */
      unsigned int SETRTSEL:1;          /*  = [22] = 0x00400000 */
      unsigned int SETRXEN:1;           /*  = [23] = 0x00800000 */
      unsigned int SETTXRQ:1;           /*  = [24] = 0x01000000 */
      unsigned int SETTXEN0:1;          /*  = [25] = 0x02000000 */
      unsigned int SETTXEN1:1;          /*  = [26] = 0x04000000 */
      unsigned int SETDIR:1;            /*  = [27] = 0x08000000 */
      unsigned int _bit28:1;            /* 0 = [28] = 0x10000000 */
      unsigned int _bit29:1;            /* 0 = [29] = 0x20000000 */
      unsigned int _bit30:1;            /* 0 = [30] = 0x40000000 */
      unsigned int _bit31:1;            /* 0 = [31] = 0x80000000 */
   ...
   struct { /* Message Object 0 Status Register */
      unsigned int RXPND:1;             /*  = [0] = 0x00000001 */
      unsigned int TXPND:1;             /*  = [1] = 0x00000002 */
      unsigned int RXUPD:1;             /*  = [2] = 0x00000004 */
      unsigned int NEWDAT:1;            /*  = [3] = 0x00000008 */
      unsigned int MSGLST:1;            /*  = [4] = 0x00000010 */
      unsigned int MSGVAL:1;            /*  = [5] = 0x00000020 */
      unsigned int RTSEL:1;             /*  = [6] = 0x00000040 */
      unsigned int RXEN:1;              /*  = [7] = 0x00000080 */
      unsigned int TXRQ:1;              /*  = [8] = 0x00000100 */
      unsigned int TXEN0:1;             /*  = [9] = 0x00000200 */
      unsigned int TXEN1:1;             /*  = [10] = 0x00000400 */
      unsigned int DIR:1;               /*  = [11] = 0x00000800 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int GDFS:1;              /*  = [8] = 0x00000100 */
      unsigned int IDC:1;               /*  = [9] = 0x00000200 */
      unsigned int DLCC:1;              /*  = [10] = 0x00000400 */
      unsigned int DATC:1;              /*  = [11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12] = 0x00001000 */
      unsigned int _bit13:1;            /* 0 = [13] = 0x00002000 */
      unsigned int _bit14:1;            /* 0 = [14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15] = 0x00008000 */
      unsigned int RXIE:1;              /*  = [16] = 0x00010000 */
      unsigned int TXIE:1;              /*  = [17] = 0x00020000 */
      unsigned int OVIE:1;              /*  = [18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19] = 0x00080000 */
      unsigned int FRREN:1;             /*  = [20] = 0x00100000 */
      unsigned int RMM:1;               /*  = [21] = 0x00200000 */
      unsigned int SDT:1;               /*  = [22] = 0x00400000 */
      unsigned int STT:1;               /*  = [23] = 0x00800000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int DIV8:1;              /*  = [15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19] = 0x00080000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int INIT:1;              /*  = [0] = 0x00000001 */
      unsigned int TRIE:1;              /*  = [1] = 0x00000002 */
      unsigned int LECIE:1;             /*  = [2] = 0x00000004 */
      unsigned int ALIE:1;              /*  = [3] = 0x00000008 */
      unsigned int CANDIS:1;            /*  = [4] = 0x00000010 */
      unsigned int _bit5:1;             /* 0 = [5] = 0x00000020 */
      unsigned int CCE:1;               /*  = [6] = 0x00000040 */
      unsigned int CALM:1;              /*  = [7] = 0x00000080 */
      unsigned int SUSEN:1;             /*  = [8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12] = 0x00001000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int LETD:1;              /*  = [24] = 0x01000000 */
      unsigned int LEINC:1;             /*  = [25] = 0x02000000 */
      unsigned int _bit26:1;            /* 0 = [26] = 0x04000000 */
      unsigned int _bit27:1;            /* 0 = [27] = 0x08000000 */
      unsigned int _bit28:1;            /* 0 = [28] = 0x10000000 */
      unsigned int _bit29:1;            /* 0 = [29] = 0x20000000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit21:1;            /* 0 = [21] = 0x00200000 */
      unsigned int CFCIE:1;             /*  = [22] = 0x00400000 */
      unsigned int CFCOV:1;             /*  = [23] = 0x00800000 */
      unsigned int _bit24:1;            /* 0 = [24] = 0x01000000 */
      unsigned int _bit25:1;            /* 0 = [25] = 0x02000000 */
      unsigned int _bit26:1;            /* 0 = [26] = 0x04000000 */
      unsigned int _bit27:1;            /* 0 = [27] = 0x08000000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit6:1;             /* 0 = [6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7] = 0x00000080 */
      unsigned int LBM:1;               /*  = [8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12] = 0x00001000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int TXOK:1;              /*  = [3] = 0x00000008 */
      unsigned int RXOK:1;              /*  = [4] = 0x00000010 */
      unsigned int ALERT:1;             /*  = [5] = 0x00000020 */
      unsigned int EWRN:1;              /*  = [6] = 0x00000040 */
      unsigned int BOFF:1;              /*  = [7] = 0x00000080 */
      unsigned int LLE:1;               /*  = [8] = 0x00000100 */
      unsigned int LOE:1;               /*  = [9] = 0x00000200 */
      unsigned int SUSACK:1;            /*  = [10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12] = 0x00001000 */
      unsigned int _bit13:1;            /* 0 = [13] = 0x00002000 */
      unsigned int _bit14:1;            /* 0 = [14] = 0x00004000 */
