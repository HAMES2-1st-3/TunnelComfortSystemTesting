...
/* block "P1" of TriCore TC1724 (10 SFRs) */

#include <tc1724/p1/addr.h>

#include <tc1724/p1/masks.h>
#include <tc1724/p0-6_8-12/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1724/p1/types.h>
...
SFR_ABS (P1_PDR0, P1_PDR0_t, P1_PDR0_ADDR);       /* "Port 1 Pad Driver Mode 0 Register" */
SFR_ABS (P1_PDR1, P1_PDR1_t, P1_PDR1_ADDR);       /* "Port 1 Pad Driver Mode 1 Register" */
