...
/* block "ADC1" of TriCore TC1724 (128 SFRs) */

#include <tc1724/adc1/addr.h>

#include <tc1724/adc1/masks.h>
#include <tc1724/adc0-1/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1724/adc1/types.h>
#include <tc1724/adc0-1/sharetypes.h>
...
SFR_NOABS (ADC1_BWDCFGR, ADCn_BWDCFGR_t, ADC1_BWDCFGR_ADDR); /* "Broken Wire Detection Configuration Register" */
SFR_NOABS (ADC1_BWDENR, ADCn_BWDENR_t, ADC1_BWDENR_ADDR); /* "Broken Wire Detection Enable Register" */
...
SFR_NOABS (ADC1_CHCTR16, ADCn_CHCTRm_t, ADC1_CHCTR16_ADDR); /* "Channel 16 Control Register" */
SFR_NOABS (ADC1_CHCTR17, ADCn_CHCTRm_t, ADC1_CHCTR17_ADDR); /* "Channel 17 Control Register" */
SFR_NOABS (ADC1_CHCTR18, ADCn_CHCTRm_t, ADC1_CHCTR18_ADDR); /* "Channel 18 Control Register" */
SFR_NOABS (ADC1_CHCTR19, ADCn_CHCTRm_t, ADC1_CHCTR19_ADDR); /* "Channel 19 Control Register" */
SFR_NOABS (ADC1_CHCTR2, ADCn_CHCTRm_t, ADC1_CHCTR2_ADDR); /* "Channel 2 Control Register" */
SFR_NOABS (ADC1_CHCTR20, ADCn_CHCTRm_t, ADC1_CHCTR20_ADDR); /* "Channel 20 Control Register" */
SFR_NOABS (ADC1_CHCTR21, ADCn_CHCTRm_t, ADC1_CHCTR21_ADDR); /* "Channel 21 Control Register" */
SFR_NOABS (ADC1_CHCTR22, ADCn_CHCTRm_t, ADC1_CHCTR22_ADDR); /* "Channel 22 Control Register" */
SFR_NOABS (ADC1_CHCTR23, ADCn_CHCTRm_t, ADC1_CHCTR23_ADDR); /* "Channel 23 Control Register" */
...
SFR_NOABS (ADC1_CHENPR16, ADCn_CHENPRm_t, ADC1_CHENPR16_ADDR); /* "Channel Event Node Pointer Register 16" */
...
SFR_NOABS (ADC1_ID, ADCn_ID_t, ADC1_ID_ADDR);     /* "Module Identification Register" */
...
SFR_NOABS (ADC1_RSIR1, ADCn_RSIRm_t, ADC1_RSIR1_ADDR); /* "Request Source 1 Input Register" */
SFR_NOABS (ADC1_RSIR2, ADCn_RSIRm_t, ADC1_RSIR2_ADDR); /* "Request Source 2 Input Register" */
SFR_NOABS (ADC1_RSIR3, ADCn_RSIRm_t, ADC1_RSIR3_ADDR); /* "Request Source 3 Input Register" */
SFR_NOABS (ADC1_RSIR4, ADCn_RSIRm_t, ADC1_RSIR4_ADDR); /* "Request Source 4 Input Register" */
