...
/** \\brief  Basic Configuration Register 1 */
typedef struct _Ifx_QSPI_BACONPWM_Bits
{
    unsigned int reserved_0:1;              /**< \brief \internal Reserved */
    unsigned int IPRE:3;                    /**< \brief [3:1] Prescaler for the Idle Delay (rw) */
    unsigned int IDLE:3;                    /**< \brief [6:4] Idle Delay Length (rw) */
    unsigned int LPRE:3;                    /**< \brief [9:7] Prescaler for the Leading Delay (rw) */
    unsigned int LEAD:3;                    /**< \brief [12:10] Leading Delay Length (rw) */
    unsigned int TPRE:3;                    /**< \brief [15:13] Prescaler for the Trailing Delay (rw) */
...
/** \\brief  Inject Register */
typedef struct _Ifx_QSPI_INJECT_Bits
{
...
/** \\brief  Mask Register */
typedef struct _Ifx_QSPI_MASK_Bits
{
...
typedef volatile struct _Ifx_QSPI
{
    ...
    unsigned char reserved_94[84];          /**< \brief 94, \internal Reserved */
