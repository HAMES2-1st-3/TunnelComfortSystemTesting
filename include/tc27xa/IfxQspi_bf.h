...
/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.CS */
#define IFX_QSPI_BACONPWM_CS_LEN (4)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.CS */
#define IFX_QSPI_BACONPWM_CS_MSK (0xf)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.CS */
#define IFX_QSPI_BACONPWM_CS_OFF (28)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.DL */
#define IFX_QSPI_BACONPWM_DL_LEN (5)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.DL */
#define IFX_QSPI_BACONPWM_DL_MSK (0x1f)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.DL */
#define IFX_QSPI_BACONPWM_DL_OFF (23)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.IDLE */
#define IFX_QSPI_BACONPWM_IDLE_LEN (3)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.IDLE */
#define IFX_QSPI_BACONPWM_IDLE_MSK (0x7)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.IDLE */
#define IFX_QSPI_BACONPWM_IDLE_OFF (4)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.IPRE */
#define IFX_QSPI_BACONPWM_IPRE_LEN (3)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.IPRE */
#define IFX_QSPI_BACONPWM_IPRE_MSK (0x7)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.IPRE */
#define IFX_QSPI_BACONPWM_IPRE_OFF (1)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.LEAD */
#define IFX_QSPI_BACONPWM_LEAD_LEN (3)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.LEAD */
#define IFX_QSPI_BACONPWM_LEAD_MSK (0x7)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.LEAD */
#define IFX_QSPI_BACONPWM_LEAD_OFF (10)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.LPRE */
#define IFX_QSPI_BACONPWM_LPRE_LEN (3)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.LPRE */
#define IFX_QSPI_BACONPWM_LPRE_MSK (0x7)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.LPRE */
#define IFX_QSPI_BACONPWM_LPRE_OFF (7)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.MSB */
#define IFX_QSPI_BACONPWM_MSB_LEN (1)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.MSB */
#define IFX_QSPI_BACONPWM_MSB_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.MSB */
#define IFX_QSPI_BACONPWM_MSB_OFF (21)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.PARTYP */
#define IFX_QSPI_BACONPWM_PARTYP_LEN (1)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.PARTYP */
#define IFX_QSPI_BACONPWM_PARTYP_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.PARTYP */
#define IFX_QSPI_BACONPWM_PARTYP_OFF (19)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.TPRE */
#define IFX_QSPI_BACONPWM_TPRE_LEN (3)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.TPRE */
#define IFX_QSPI_BACONPWM_TPRE_MSK (0x7)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.TPRE */
#define IFX_QSPI_BACONPWM_TPRE_OFF (13)

/** \\brief  Length for Ifx_QSPI_BACONPWM_Bits.TRAIL */
#define IFX_QSPI_BACONPWM_TRAIL_LEN (3)

/** \\brief  Mask for Ifx_QSPI_BACONPWM_Bits.TRAIL */
#define IFX_QSPI_BACONPWM_TRAIL_MSK (0x7)

/** \\brief  Offset for Ifx_QSPI_BACONPWM_Bits.TRAIL */
#define IFX_QSPI_BACONPWM_TRAIL_OFF (16)
...
/** \\brief  Length for Ifx_QSPI_GLOBALCON1_Bits.HC1EN */
#define IFX_QSPI_GLOBALCON1_HC1EN_LEN (1)

/** \\brief  Mask for Ifx_QSPI_GLOBALCON1_Bits.HC1EN */
#define IFX_QSPI_GLOBALCON1_HC1EN_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_GLOBALCON1_Bits.HC1EN */
#define IFX_QSPI_GLOBALCON1_HC1EN_OFF (13)

/** \\brief  Length for Ifx_QSPI_GLOBALCON1_Bits.HC2EN */
#define IFX_QSPI_GLOBALCON1_HC2EN_LEN (1)

/** \\brief  Mask for Ifx_QSPI_GLOBALCON1_Bits.HC2EN */
#define IFX_QSPI_GLOBALCON1_HC2EN_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_GLOBALCON1_Bits.HC2EN */
#define IFX_QSPI_GLOBALCON1_HC2EN_OFF (14)
...
/** \\brief  Length for Ifx_QSPI_GLOBALCON1_Bits.PWMVIOEN */
#define IFX_QSPI_GLOBALCON1_PWMVIOEN_LEN (1)

/** \\brief  Mask for Ifx_QSPI_GLOBALCON1_Bits.PWMVIOEN */
#define IFX_QSPI_GLOBALCON1_PWMVIOEN_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_GLOBALCON1_Bits.PWMVIOEN */
#define IFX_QSPI_GLOBALCON1_PWMVIOEN_OFF (30)
...
/** \\brief  Length for Ifx_QSPI_GLOBALCON1_Bits.TVIOEN */
#define IFX_QSPI_GLOBALCON1_TVIOEN_LEN (1)

/** \\brief  Mask for Ifx_QSPI_GLOBALCON1_Bits.TVIOEN */
#define IFX_QSPI_GLOBALCON1_TVIOEN_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_GLOBALCON1_Bits.TVIOEN */
#define IFX_QSPI_GLOBALCON1_TVIOEN_OFF (31)
...
/** \\brief  Length for Ifx_QSPI_INJECT_Bits.INJECT */
#define IFX_QSPI_INJECT_INJECT_LEN (32)

/** \\brief  Mask for Ifx_QSPI_INJECT_Bits.INJECT */
#define IFX_QSPI_INJECT_INJECT_MSK (0xffffffff)

/** \\brief  Offset for Ifx_QSPI_INJECT_Bits.INJECT */
#define IFX_QSPI_INJECT_INJECT_OFF (0)
...
/** \\brief  Length for Ifx_QSPI_MASK_Bits.MASK */
#define IFX_QSPI_MASK_MASK_LEN (32)

/** \\brief  Mask for Ifx_QSPI_MASK_Bits.MASK */
#define IFX_QSPI_MASK_MASK_MSK (0xffffffff)

/** \\brief  Offset for Ifx_QSPI_MASK_Bits.MASK */
#define IFX_QSPI_MASK_MASK_OFF (0)
...
/** \\brief  Length for Ifx_QSPI_STATUS1_Bits.MPWMVIO */
#define IFX_QSPI_STATUS1_MPWMVIO_LEN (2)

/** \\brief  Mask for Ifx_QSPI_STATUS1_Bits.MPWMVIO */
#define IFX_QSPI_STATUS1_MPWMVIO_MSK (0x3)

/** \\brief  Offset for Ifx_QSPI_STATUS1_Bits.MPWMVIO */
#define IFX_QSPI_STATUS1_MPWMVIO_OFF (9)

/** \\brief  Length for Ifx_QSPI_STATUS1_Bits.MTVIO */
#define IFX_QSPI_STATUS1_MTVIO_LEN (2)

/** \\brief  Mask for Ifx_QSPI_STATUS1_Bits.MTVIO */
#define IFX_QSPI_STATUS1_MTVIO_MSK (0x3)

/** \\brief  Offset for Ifx_QSPI_STATUS1_Bits.MTVIO */
#define IFX_QSPI_STATUS1_MTVIO_OFF (12)

/** \\brief  Length for Ifx_QSPI_STATUS1_Bits.PWMVIO */
#define IFX_QSPI_STATUS1_PWMVIO_LEN (1)

/** \\brief  Mask for Ifx_QSPI_STATUS1_Bits.PWMVIO */
#define IFX_QSPI_STATUS1_PWMVIO_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_STATUS1_Bits.PWMVIO */
#define IFX_QSPI_STATUS1_PWMVIO_OFF (8)

/** \\brief  Length for Ifx_QSPI_STATUS1_Bits.TVIO */
#define IFX_QSPI_STATUS1_TVIO_LEN (1)

/** \\brief  Mask for Ifx_QSPI_STATUS1_Bits.TVIO */
#define IFX_QSPI_STATUS1_TVIO_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_STATUS1_Bits.TVIO */
#define IFX_QSPI_STATUS1_TVIO_OFF (11)
...
/** \\brief  Length for Ifx_QSPI_STATUS_Bits.HC1F */
#define IFX_QSPI_STATUS_HC1F_LEN (1)

/** \\brief  Mask for Ifx_QSPI_STATUS_Bits.HC1F */
#define IFX_QSPI_STATUS_HC1F_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_STATUS_Bits.HC1F */
#define IFX_QSPI_STATUS_HC1F_OFF (13)

/** \\brief  Length for Ifx_QSPI_STATUS_Bits.HC2F */
#define IFX_QSPI_STATUS_HC2F_LEN (1)

/** \\brief  Mask for Ifx_QSPI_STATUS_Bits.HC2F */
#define IFX_QSPI_STATUS_HC2F_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_STATUS_Bits.HC2F */
#define IFX_QSPI_STATUS_HC2F_OFF (14)
