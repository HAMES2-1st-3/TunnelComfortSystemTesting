...
typedef struct _Ifx_XBAR_ARBITER0_DBADD_Bits
{
    ...
    unsigned int ADDRESS_2:19;              /**< \brief [20:2] Debug Address Boundary (rw) */
...
typedef struct _Ifx_XBAR_ARBITER1_DBADD_Bits
{
    ...
    unsigned int ADDRESS_27:2;              /**< \brief [28:27] Debug Address Boundary (rw) */
...
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS_2:18;              /**< \brief [19:2] Debug Address Boundary (rw) */
...
/** \\brief  Debug Address Register */
typedef struct _Ifx_XBAR_ARBITER3_DBADD_Bits
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS_2:19;              /**< \brief [20:2] Debug Address Boundary (rw) */
    unsigned int reserved_21:11;            /**< \brief \internal Reserved */
...
/** \\brief  Debug Mask Address Register */
typedef struct _Ifx_XBAR_ARBITER3_DBMADD_Bits
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS_2:19;              /**< \brief [20:2] Debug Address Boundary (rw) */
    unsigned int reserved_21:11;            /**< \brief \internal Reserved */
...
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS_2:25;              /**< \brief [26:2] Debug Address Boundary (rw) */
...
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS_2:29;              /**< \brief [30:2] Debug Address Boundary (rw) */
...
typedef struct _Ifx_XBAR_ARBITER7_DBADD_Bits
{
    ...
    unsigned int ADDRESS_28:3;              /**< \brief [30:28] Debug Address Boundary (rw) */
    unsigned int reserved_31:1;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_XBAR_ARBITER8_DBADD_Bits
{
    ...
    unsigned int ADDRESS_29:1;              /**< \brief [29:29] Debug Address Boundary (rw) */
...
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS_2:30;              /**< \brief [31:2] Debug Address Boundary (rw) */
} Ifx_XBAR_ARBITERD_DBADD_Bits;

/** \\brief  Debug Mask Address Register */
typedef struct _Ifx_XBAR_ARBITERD_DBMADD_Bits
{
    unsigned int ADDRESS_0:32;              /**< \brief [31:0] Debug Address Boundary (rw) */
...
/** \\brief  External Control Register 5 */
typedef struct _Ifx_XBAR_EXTCON5_Bits
{
    ...
    unsigned int MAX_WS:4;                  /**< \brief [15:12] FPI-Bus Wait State Retry Ratio (rw) */
...
typedef struct _Ifx_XBAR_IDINTEN_Bits
{
    ...
    unsigned int ENSCI2:1;                  /**< \brief [2:2] Enable ID Error from SCIn (rw) */
    ...
    unsigned int reserved_17:2;             /**< \brief \internal Reserved */
    unsigned int ENMCI3:1;                  /**< \brief [19:19] Enable ID Error from MCIn (rw) */
    ...
    unsigned int ENMCI6:1;                  /**< \brief [22:22] Enable ID Error from MCIn (rw) */
    unsigned int ENMCI7:1;                  /**< \brief [23:23] Enable ID Error from MCIn (rw) */
    ...
    unsigned int ENMCI10:1;                 /**< \brief [26:26] Enable ID Error from MCIn (rw) */
    unsigned int ENMCI11:1;                 /**< \brief [27:27] Enable ID Error from MCIn (rw) */
...
typedef struct _Ifx_XBAR_IDINTSAT_Bits
{
    ...
    unsigned int IDSCI9:1;                  /**< \brief [9:9] Transaction ID Error from SCIn Status (rwh) */
    unsigned int reserved_10:5;             /**< \brief \internal Reserved */
    ...
    unsigned int reserved_17:2;             /**< \brief \internal Reserved */
    unsigned int IDMCI3:1;                  /**< \brief [19:19] Transaction ID Error from MCIn Status (rwh) */
    ...
    unsigned int IDMCI6:1;                  /**< \brief [22:22] Transaction ID Error from MCIn Status (rwh) */
    unsigned int IDMCI7:1;                  /**< \brief [23:23] Transaction ID Error from MCIn Status (rwh) */
    ...
    unsigned int IDMCI10:1;                 /**< \brief [26:26] Transaction ID Error from MCIn Status (rwh) */
    unsigned int IDMCI11:1;                 /**< \brief [27:27] Transaction ID Error from MCIn Status (rwh) */
...
typedef struct _Ifx_XBAR_INTSAT_Bits
{
    ...
    unsigned int SCSCI9:1;                  /**< \brief [9:9] Starvation Error from SCIn Status (rwh) */
    unsigned int reserved_10:5;             /**< \brief \internal Reserved */
    ...
    unsigned int PRSCI2:1;                  /**< \brief [18:18] Protocol Error from SCIn Status (rwh) */
    unsigned int PRSCI3:1;                  /**< \brief [19:19] Protocol Error from SCIn Status (rwh) */
    unsigned int PRSCI4:1;                  /**< \brief [20:20] Protocol Error from SCIn Status (rwh) */
    unsigned int PRSCI5:1;                  /**< \brief [21:21] Protocol Error from SCIn Status (rwh) */
    ...
    unsigned int PRSCI9:1;                  /**< \brief [25:25] Protocol Error from SCIn Status (rwh) */
...
{
    Ifx_XBAR_ARBCON ARBCON;                 /**< \brief 0, Arbiter Control Register */
    unsigned char reserved_[12];            /**< \brief 4, \internal Reserved */
    Ifx_XBAR_ERR ERR;                       /**< \brief 10, Error/Debug Capture Register */
    Ifx_XBAR_DBCON DBCON;                   /**< \brief 14, Debug Control Register */
...
/** \\brief  Arbiter objects */
typedef volatile struct _Ifx_XBAR_ARBITER3
{
    Ifx_XBAR_ARBCON ARBCON;                 /**< \brief 0, Arbiter Control Register */
    Ifx_XBAR_PRIOH PRIOH;                   /**< \brief 4, Arbiter Priority Register */
    Ifx_XBAR_PRIOL PRIOL;                   /**< \brief 8, Arbiter Priority Register */
...
{
    unsigned char reserved_0[4];            /**< \brief 0, \internal Reserved */
    ...
    unsigned char reserved_E4[32];          /**< \brief E4, \internal Reserved */
    Ifx_XBAR_ARBITER3 ARBITER3;             /**< \brief 104, Arbiter objects */
    unsigned char reserved_124[32];         /**< \brief 124, \internal Reserved */
    ...
    unsigned char reserved_2A4[356];        /**< \brief 2A4, \internal Reserved */
