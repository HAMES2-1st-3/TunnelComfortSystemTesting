...
typedef struct _Ifx_SCU_CCUCON0_Bits
{
    ...
    unsigned int CPU0FDR:4;                 /**< \brief [7:4] CPU0 Fractional Divider Reload Value (rw) */
    unsigned int SRIDIV:4;                  /**< \brief [11:8] SRI Divider Reload Value (rw) */
    unsigned int SRIFDR:4;                  /**< \brief [15:12] SRI Fractional Divider Reload Value (rw) */
    unsigned int SPBDIV:4;                  /**< \brief [19:16] SPB Divider Reload Value (rw) */
    unsigned int FSI2DIV:4;                 /**< \brief [23:20] FSI2 Divider Reload Value (rw) */
...
typedef struct _Ifx_SCU_CCUCON2_Bits
{
    ...
    unsigned int MCDSDIV:4;                 /**< \brief [11:8] MCDS Divider Reload Value (rw) */
    unsigned int reserved_12:18;            /**< \brief \internal Reserved */
    unsigned int UP:1;                      /**< \brief [30:30] Update Request (rw) */
    unsigned int LCK:1;                     /**< \brief [31:31] Lock Status (rh) */
...
typedef struct _Ifx_SCU_CCUCON4_Bits
{
    ...
    unsigned int CPU0DIV:6;                 /**< \brief [13:8] CPU0 Divider Value (rw) */
    unsigned int CPU0SEL:2;                 /**< \brief [15:14] CPU0 Target Monitoring Frequency Selection (rw) */
...
{
    unsigned int OSC1REL:4;                 /**< \brief [3:0] OSC1 Counter Divider Reload Value (rw) */
    unsigned int reserved_4:4;              /**< \brief \internal Reserved */
    unsigned int SPBREL:4;                  /**< \brief [11:8] SPB Counter Divider Reload Value (rw) */
...
typedef struct _Ifx_SCU_CHIPID_Bits
{
    ...
    unsigned int UCODE:7;                   /**< \brief [23:17] Code Version (rw) */
...
typedef struct _Ifx_SCU_DTSCON_Bits
{
    ...
    unsigned int OFFSET:8;                  /**< \brief [11:4] Offset Calibration Value (rw) */
    unsigned int GAIN:6;                    /**< \brief [17:12] Gain Calibration Value (rw) */
    unsigned int REFTRIM:3;                 /**< \brief [20:18] Reference Trim Calibration Value (rw) */
    unsigned int BGTRIM:4;                  /**< \brief [24:21] Bandgap Trim Calibration Value (rw) */
...
typedef struct _Ifx_SCU_ESRCFG_Bits
{
    ...
    unsigned int reserved_9:22;             /**< \brief \internal Reserved */
    unsigned int LCK:1;                     /**< \brief [31:31] Lock Status (rh) */
} Ifx_SCU_ESRCFG_Bits;
...
{
    unsigned int KP:4;                      /**< \brief [3:0] KP Value (rw) */
    unsigned int KI:4;                      /**< \brief [7:4] KI Value (rw) */
    unsigned int KD:4;                      /**< \brief [11:8] KD Value (rw) */
    unsigned int CTRL:4;                    /**< \brief [15:12] Reserved (rw) */
    unsigned int KPE:4;                     /**< \brief [19:16] KP Value (rw) */
    unsigned int KIE:4;                     /**< \brief [23:20] KI Value (rw) */
    unsigned int KDE:4;                     /**< \brief [27:24] KD Value (rw) */
...
{
    unsigned int ADC13V:8;                  /**< \brief [7:0] ADC 13V Conversion Result (rh) */
    unsigned int ADC33V:8;                  /**< \brief [15:8] ADC 33V Conversion Result (rh) */
...
{
    unsigned int EVR13OVMOD:2;              /**< \brief [1:0] 13V Regulator Over-voltage monitoring mode (rw) */
    unsigned int reserved_2:2;              /**< \brief \internal Reserved */
    unsigned int EVR13UVMOD:2;              /**< \brief [5:4] 13V Regulator Under-voltage monitoring mode (rw) */
    unsigned int reserved_6:2;              /**< \brief \internal Reserved */
    unsigned int EVR33OVMOD:2;              /**< \brief [9:8] 33V Regulator Over-voltage monitoring mode (rw) */
    unsigned int reserved_10:2;             /**< \brief \internal Reserved */
    unsigned int EVR33UVMOD:2;              /**< \brief [13:12] 33V Regulator Under-voltage monitoring mode (rw) */
...
{
    unsigned int EVR13OVVAL:8;              /**< \brief [7:0] 13V Regulator Over-voltage threshold (rw) */
    unsigned int EVR33OVVAL:8;              /**< \brief [15:8] 33V Regulator Over-voltage threshold (rw) */
...
{
    unsigned int RST13TRIM:8;               /**< \brief [7:0] 13V Regulator Reset Trim Value (rw) */
    unsigned int RST33TRIM:8;               /**< \brief [15:8] 33V Regulator Reset Trim Value (rw) */
    unsigned int RSTSWDTRIM:8;              /**< \brief [23:16] 50V/33V External Supply Reset Trim Value (rw) */
    unsigned int RST13OFF:1;                /**< \brief [24:24] Hard Reset EVR13 Enable (rw) */
...
{
    unsigned int EVR13UVVAL:8;              /**< \brief [7:0] 13V Regulator Under-voltage threshold (rw) */
    unsigned int EVR33UVVAL:8;              /**< \brief [15:8] 33V Regulator Under-voltage threshold (rw) */
...
typedef struct _Ifx_SCU_LBISTCTRL0_Bits
{
    ...
    unsigned int SEED:15;                   /**< \brief [30:16] LBIST Seed (rw) */
    unsigned int BODY:1;                    /**< \brief [31:31] BODY Application Mode (rw) */
...
typedef struct _Ifx_SCU_LBISTCTRL1_Bits
{
    ...
    unsigned int LBISTDONE:1;               /**< \brief [27:27] LBIST Execution Indicator (rh) */
    unsigned int LBISTFREQ:4;               /**< \brief [31:28] LBIST Frequency Select (rw) */
...
typedef struct _Ifx_SCU_OVCCON_Bits
{
    ...
    unsigned int PEND0:1;                   /**< \brief [8:8] CPU Pending x (w) */
    unsigned int PEND1:1;                   /**< \brief [9:9] CPU Pending x (w) */
    unsigned int PEND2:1;                   /**< \brief [10:10] CPU Pending x (w) */
...
typedef struct _Ifx_SCU_PLLCON0_Bits
{
    ...
    unsigned int SETFINDIS:1;               /**< \brief [4:4] Set Status Bit PLLSTATFINDIS (w) */
    unsigned int CLRFINDIS:1;               /**< \brief [5:5] Clear Status Bit PLLSTATFINDIS (w) */
...
typedef struct _Ifx_SCU_PLLERAYCON0_Bits
{
    ...
    unsigned int VCOPWD:1;                  /**< \brief [1:1] VCO Power Saving Mode (rw) */
    unsigned int reserved_2:2;              /**< \brief \internal Reserved */
    unsigned int SETFINDIS:1;               /**< \brief [4:4] Set Status Bit PLLERAYSTATFINDIS (w) */
    unsigned int CLRFINDIS:1;               /**< \brief [5:5] Clear Status Bit PLLERAYSTATFINDIS (w) */
    unsigned int OSCDISCDIS:1;              /**< \brief [6:6] Oscillator Disconnect Disable (rw) */
    unsigned int reserved_7:2;              /**< \brief \internal Reserved */
...
{
    unsigned int VCOBYST:1;                 /**< \brief [0:0] VCO Bypass Status (rh) */
    unsigned int PWDSTAT:1;                 /**< \brief [1:1] PLL Power-saving Mode Status (rh) */
    unsigned int VCOLOCK:1;                 /**< \brief [2:2] PLL VCO Lock Status (rh) */
    unsigned int FINDIS:1;                  /**< \brief [3:3] Input Clock Disconnect Select Status (rh) */
    unsigned int K1RDY:1;                   /**< \brief [4:4] K1 Divider Ready Status (rh) */
    unsigned int K2RDY:1;                   /**< \brief [5:5] K2 Divider Ready Status (rh) */
...
{
    unsigned int ESR0WKEN:1;                /**< \brief [0:0] ESR0 Wake-up enable from Standby (rw) */
    ...
    unsigned int TRISTEN:1;                 /**< \brief [21:21] Bit protection for Tristate request bit TRISTREQ (rw) */
    unsigned int TRISTREQ:1;                /**< \brief [22:22] Tristate enable (rw) */
    unsigned int PORSTDF:1;                 /**< \brief [23:23] PORST Digital Filter enable (rw) */
    unsigned int PORSTWKP:1;                /**< \brief [24:24] Standby - Wakeup transition on PORST edges (rw) */
...
typedef struct _Ifx_SCU_PMSWCR1_Bits
{
    ...
    unsigned int CPU0IDLE:1;                /**< \brief [8:8] CPU0 IDLE request (w) */
    unsigned int CPU1IDLE:1;                /**< \brief [9:9] CPU1 IDLE request (w) */
    unsigned int CPU2IDLE:1;                /**< \brief [10:10] CPU2 IDLE request (w) */
    unsigned int reserved_11:13;            /**< \brief \internal Reserved */
...
{
    unsigned int ESR0WKP:1;                 /**< \brief [0:0] ESR0 Wake-up flag (rh) */
    unsigned int ESR0OVRUN:1;               /**< \brief [1:1] ESR0 Overrun status flag (rh) */
    ...
    unsigned int PORSTWKP:1;                /**< \brief [8:8] Standby-Wakeup transition on PORST edges (rh) */
    ...
    unsigned int SPARE0:5;                  /**< \brief [23:19] Spare bits (rh) */
    unsigned int reserved_24:8;             /**< \brief \internal Reserved */
...
{
    unsigned int ESR0WKPCLR:1;              /**< \brief [0:0] ESR0 Wake-up indication flag clear (w) */
    unsigned int ESR0OVRUNCLR:1;            /**< \brief [1:1] ESR0 Overrun status indication flag clear (w) */
    ...
    unsigned int reserved_8:11;             /**< \brief \internal Reserved */
    unsigned int SPARECLR:5;                /**< \brief [23:19] SPARE flag clear (w) */
    unsigned int reserved_24:8;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_SCU_RSTCON2_Bits
{
    ...
    unsigned int reserved_2:8;              /**< \brief \internal Reserved */
    unsigned int FLSS:2;                    /**< \brief [11:10] Flash Safe State Reached (rh) */
    unsigned int CSS:3;                     /**< \brief [14:12] CPU Safe State Reached (rh) */
    unsigned int MCDSSS:1;                  /**< \brief [15:15] MCDS Safe State Reached (rh) */
...
typedef struct _Ifx_SCU_WDTCPU_CON1_Bits
{
    ...
    unsigned int TCTR:7;                    /**< \brief [15:9] Timer Check Tolerance Request (rh) */
    unsigned int reserved_16:16;            /**< \brief \internal Reserved */
...
typedef volatile struct _Ifx_SCU
{
    ...
    unsigned char reserved_80[32];          /**< \brief 80, \internal Reserved */
    ...
    unsigned char reserved_13C[4];          /**< \brief 13C, \internal Reserved */
    ...
    unsigned char reserved_148[28];         /**< \brief 148, \internal Reserved */
    ...
    unsigned char reserved_16C[32];         /**< \brief 16C, \internal Reserved */
    Ifx_SCU_PDISC PDISC;                    /**< \brief 18C, Pad Disable Control Register */
    Ifx_SCU_CCUCON5 CCUCON5;                /**< \brief 190, CCU Clock Control Register 5 */
    ...
    unsigned char reserved_1B4[44];         /**< \brief 1B4, \internal Reserved */
