...
/** \\brief  104, Arbiter Control Register */
#define XBAR_ARBITER3_ARBCON /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBCON*)0xF8700104u)

/** Alias (User Manual Name) for XBAR_ARBITER3_ARBCON.
* To use register names with standard convension, please use XBAR_ARBITER3_ARBCON.
*/
#define	XBAR_ARBCON3	(XBAR_ARBITER3_ARBCON)

/** \\brief  11C, Debug Address Register */
#define XBAR_ARBITER3_DBADD /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBITER3_DBADD*)0xF870011Cu)

/** Alias (User Manual Name) for XBAR_ARBITER3_DBADD.
* To use register names with standard convension, please use XBAR_ARBITER3_DBADD.
*/
#define	XBAR_DBADD3	(XBAR_ARBITER3_DBADD)

/** \\brief  118, Debug Control Register */
#define XBAR_ARBITER3_DBCON /*lint --e(923)*/ (*(volatile Ifx_XBAR_DBCON*)0xF8700118u)

/** Alias (User Manual Name) for XBAR_ARBITER3_DBCON.
* To use register names with standard convension, please use XBAR_ARBITER3_DBCON.
*/
#define	XBAR_DBCON3	(XBAR_ARBITER3_DBCON)

/** \\brief  120, Debug Mask Address Register */
#define XBAR_ARBITER3_DBMADD /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBITER3_DBMADD*)0xF8700120u)

/** Alias (User Manual Name) for XBAR_ARBITER3_DBMADD.
* To use register names with standard convension, please use XBAR_ARBITER3_DBMADD.
*/
#define	XBAR_DBMADD3	(XBAR_ARBITER3_DBMADD)

/** \\brief  114, Error/Debug Capture Register */
#define XBAR_ARBITER3_ERR /*lint --e(923)*/ (*(volatile Ifx_XBAR_ERR*)0xF8700114u)

/** Alias (User Manual Name) for XBAR_ARBITER3_ERR.
* To use register names with standard convension, please use XBAR_ARBITER3_ERR.
*/
#define	XBAR_ERR3	(XBAR_ARBITER3_ERR)

/** \\brief  110, Error/Debug Address Capture Register */
#define XBAR_ARBITER3_ERRADDR /*lint --e(923)*/ (*(volatile Ifx_XBAR_ERRADDR*)0xF8700110u)

/** Alias (User Manual Name) for XBAR_ARBITER3_ERRADDR.
* To use register names with standard convension, please use XBAR_ARBITER3_ERRADDR.
*/
#define	XBAR_ERRADDR3	(XBAR_ARBITER3_ERRADDR)

/** \\brief  108, Arbiter Priority Register */
#define XBAR_ARBITER3_PRIOH /*lint --e(923)*/ (*(volatile Ifx_XBAR_PRIOH*)0xF8700108u)

/** Alias (User Manual Name) for XBAR_ARBITER3_PRIOH.
* To use register names with standard convension, please use XBAR_ARBITER3_PRIOH.
*/
#define	XBAR_PRIOH3	(XBAR_ARBITER3_PRIOH)

/** \\brief  10C, Arbiter Priority Register */
#define XBAR_ARBITER3_PRIOL /*lint --e(923)*/ (*(volatile Ifx_XBAR_PRIOL*)0xF870010Cu)

/** Alias (User Manual Name) for XBAR_ARBITER3_PRIOL.
* To use register names with standard convension, please use XBAR_ARBITER3_PRIOL.
*/
...
/** \\brief  180, External Control Register 5 */
#define XBAR_EXTCON5 /*lint --e(923)*/ (*(volatile Ifx_XBAR_EXTCON5*)0xF8700180u)
