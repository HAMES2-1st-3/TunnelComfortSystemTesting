...
/** \\brief  BMU Service requests */
typedef volatile struct _Ifx_SRC_BMU
{
    Ifx_SRC_SRCR SR;                        /**< \brief 0, Bus Monitor Unit Service Request */
} Ifx_SRC_BMU;
...
/** \\brief  SDMA Service requests */
typedef volatile struct _Ifx_SRC_DMA_ME
{
    Ifx_SRC_SRCR CH[24];                    /**< \brief 0, Channel Service Request */
    unsigned char reserved_60[160];         /**< \brief 60, \internal Reserved */
} Ifx_SRC_DMA_ME;
...
typedef volatile struct _Ifx_SRC_GTM
{
    ...
    unsigned char reserved_44[96];          /**< \brief 44, \internal Reserved */
    Ifx_SRC_SRCR DPLL[27];                  /**< \brief A4, GTM DPLL Service Request */
    unsigned char reserved_110[112];        /**< \brief 110, \internal Reserved */
    ...
    Ifx_SRC_SRCR MCSW0[2];                  /**< \brief 900, GTM Multi Channel Sequencer 0 Service Request */
    Ifx_SRC_SRCR MCSW1[2];                  /**< \brief 908, GTM Multi Channel Sequencer 1 Service Request */
    Ifx_SRC_SRCR MCSW2[2];                  /**< \brief 910, GTM Multi Channel Sequencer 2 Service Request */
    Ifx_SRC_SRCR MCSW3[2];                  /**< \brief 918, GTM Multi Channel Sequencer 2 Service Request */
} Ifx_SRC_GTM;
...
/** \\brief  SDMA Service requests */
typedef volatile struct _Ifx_SRC_SDMA_ME
{
    Ifx_SRC_SRCR CH[8];                     /**< \brief 0, Channel Service Request */
...
/** \\brief  BMU Service requests */
typedef volatile struct _Ifx_SRC_GBMU
{
    Ifx_SRC_BMU BMU[1];                     /**< \brief 0, BMU Service requests */
} Ifx_SRC_GBMU;
...
{
    Ifx_SRC_CCU6 CCU6[4];                   /**< \brief 0, CCU6 Service requests */
} Ifx_SRC_GCCU6;
...
{
    Ifx_SRC_SRCR SDMA_ME_SR[2];             /**< \brief 0, SDMA Move Engine Service Request */
    Ifx_SRC_SRCR DMA_ME_SR[2];              /**< \brief 8, DMA Move Engine Service Request */
    unsigned char reserved_10[16];          /**< \brief 10, \internal Reserved */
    Ifx_SRC_SDMA_ME SDMA_ME[2];             /**< \brief 20, SDMA Service requests */
    Ifx_SRC_DMA_ME DMA_ME[2];               /**< \brief 220, SDMA Service requests */
} Ifx_SRC_GDMA;
...
{
    Ifx_SRC_GPT12 GPT12[2];                 /**< \brief 0, GPT12 Service requests */
} Ifx_SRC_GGPT12;
...
{
    Ifx_SRC_QSPI QSPI[5];                   /**< \brief 0, QSPI Service requests */
} Ifx_SRC_GQSPI;
...
typedef volatile struct _Ifx_SRC
{
    ...
    unsigned char reserved_208[136];        /**< \brief 208, \internal Reserved */
    ...
    unsigned char reserved_400[32];         /**< \brief 400, \internal Reserved */
    ...
    unsigned char reserved_4B4[28];         /**< \brief 4B4, \internal Reserved */
    Ifx_SRC_GDMA DMA;                       /**< \brief 4D0, DMA Service requests */
    ...
    unsigned char reserved_AC0[208];        /**< \brief AC0, \internal Reserved */
    Ifx_SRC_GDSADC DSADC;                   /**< \brief B90, DSADC Service requests */
    unsigned char reserved_BC0[32];         /**< \brief BC0, \internal Reserved */
    Ifx_SRC_GERAY ERAY;                     /**< \brief BE0, ERAY Service requests */
    Ifx_SRC_GPMU PMU;                       /**< \brief C30, PMU Service requests */
    unsigned char reserved_C38[72];         /**< \brief C38, \internal Reserved */
    Ifx_SRC_GBMU BMU;                       /**< \brief C80, BMU Service requests */
    unsigned char reserved_C84[60];         /**< \brief C84, \internal Reserved */
    ...
    unsigned char reserved_DE4[540];        /**< \brief DE4, \internal Reserved */
    ...
    unsigned char reserved_1F20[224];       /**< \brief 1F20, \internal Reserved */
} Ifx_SRC;
/** \}  */
/******************************************************************************/
/** \}  */
