...
/** \\brief  Length for Ifx_CPU_PMA0_Bits.DAC_0 */
#define IFX_CPU_PMA0_DAC_0_LEN (10)

/** \\brief  Mask for Ifx_CPU_PMA0_Bits.DAC_0 */
#define IFX_CPU_PMA0_DAC_0_MSK (0x3ff)

/** \\brief  Offset for Ifx_CPU_PMA0_Bits.DAC_0 */
#define IFX_CPU_PMA0_DAC_0_OFF (0)

/** \\brief  Length for Ifx_CPU_PMA0_Bits.DAC_A */
#define IFX_CPU_PMA0_DAC_A_LEN (1)

/** \\brief  Mask for Ifx_CPU_PMA0_Bits.DAC_A */
#define IFX_CPU_PMA0_DAC_A_MSK (0x1)

/** \\brief  Offset for Ifx_CPU_PMA0_Bits.DAC_A */
#define IFX_CPU_PMA0_DAC_A_OFF (10)

/** \\brief  Length for Ifx_CPU_PMA0_Bits.DAC_B */
#define IFX_CPU_PMA0_DAC_B_LEN (2)

/** \\brief  Mask for Ifx_CPU_PMA0_Bits.DAC_B */
#define IFX_CPU_PMA0_DAC_B_MSK (0x3)

/** \\brief  Offset for Ifx_CPU_PMA0_Bits.DAC_B */
#define IFX_CPU_PMA0_DAC_B_OFF (11)

/** \\brief  Length for Ifx_CPU_PMA0_Bits.DAC_D */
#define IFX_CPU_PMA0_DAC_D_LEN (3)

/** \\brief  Mask for Ifx_CPU_PMA0_Bits.DAC_D */
#define IFX_CPU_PMA0_DAC_D_MSK (0x7)

/** \\brief  Offset for Ifx_CPU_PMA0_Bits.DAC_D */
#define IFX_CPU_PMA0_DAC_D_OFF (13)

/** \\brief  Length for Ifx_CPU_PMA1_Bits.CAC_0 */
#define IFX_CPU_PMA1_CAC_0_LEN (10)

/** \\brief  Mask for Ifx_CPU_PMA1_Bits.CAC_0 */
#define IFX_CPU_PMA1_CAC_0_MSK (0x3ff)

/** \\brief  Offset for Ifx_CPU_PMA1_Bits.CAC_0 */
#define IFX_CPU_PMA1_CAC_0_OFF (0)

/** \\brief  Length for Ifx_CPU_PMA1_Bits.CAC_A */
#define IFX_CPU_PMA1_CAC_A_LEN (1)

/** \\brief  Mask for Ifx_CPU_PMA1_Bits.CAC_A */
#define IFX_CPU_PMA1_CAC_A_MSK (0x1)

/** \\brief  Offset for Ifx_CPU_PMA1_Bits.CAC_A */
#define IFX_CPU_PMA1_CAC_A_OFF (10)

/** \\brief  Length for Ifx_CPU_PMA1_Bits.CAC_B */
#define IFX_CPU_PMA1_CAC_B_LEN (1)

/** \\brief  Mask for Ifx_CPU_PMA1_Bits.CAC_B */
#define IFX_CPU_PMA1_CAC_B_MSK (0x1)

/** \\brief  Offset for Ifx_CPU_PMA1_Bits.CAC_B */
#define IFX_CPU_PMA1_CAC_B_OFF (11)

/** \\brief  Length for Ifx_CPU_PMA1_Bits.CAC_C */
#define IFX_CPU_PMA1_CAC_C_LEN (1)

/** \\brief  Mask for Ifx_CPU_PMA1_Bits.CAC_C */
#define IFX_CPU_PMA1_CAC_C_MSK (0x1)

/** \\brief  Offset for Ifx_CPU_PMA1_Bits.CAC_C */
#define IFX_CPU_PMA1_CAC_C_OFF (12)

/** \\brief  Length for Ifx_CPU_PMA1_Bits.CAC_D */
#define IFX_CPU_PMA1_CAC_D_LEN (1)

/** \\brief  Mask for Ifx_CPU_PMA1_Bits.CAC_D */
#define IFX_CPU_PMA1_CAC_D_MSK (0x1)

/** \\brief  Offset for Ifx_CPU_PMA1_Bits.CAC_D */
#define IFX_CPU_PMA1_CAC_D_OFF (13)

/** \\brief  Length for Ifx_CPU_PMA1_Bits.CAC_E */
#define IFX_CPU_PMA1_CAC_E_LEN (2)

/** \\brief  Mask for Ifx_CPU_PMA1_Bits.CAC_E */
#define IFX_CPU_PMA1_CAC_E_MSK (0x3)

/** \\brief  Offset for Ifx_CPU_PMA1_Bits.CAC_E */
#define IFX_CPU_PMA1_CAC_E_OFF (14)
...
/** \\brief  Length for Ifx_CPU_PSTR_Bits.FGAE */
#define IFX_CPU_PSTR_FGAE_LEN (1)

/** \\brief  Mask for Ifx_CPU_PSTR_Bits.FGAE */
#define IFX_CPU_PSTR_FGAE_MSK (0x1)

/** \\brief  Offset for Ifx_CPU_PSTR_Bits.FGAE */
#define IFX_CPU_PSTR_FGAE_OFF (1)
