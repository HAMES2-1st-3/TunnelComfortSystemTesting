...
typedef struct _Ifx_HSSL_MFLAGS_Bits
{
    ...
    unsigned int SRIE:1;                    /**< \brief [22:22] SRI Bus Access Error (rh) */
    unsigned int PIE1:1;                    /**< \brief [23:23] PHY Inconsistency Error 1 (Channel Number Code Error) (rh) */
    unsigned int PIE2:1;                    /**< \brief [24:24] PHY Inconsistency Error 2 (Data Length Error) (rh) */
...
typedef struct _Ifx_HSSL_MFLAGSCL_Bits
{
    ...
    unsigned int SRIEC:1;                   /**< \brief [22:22] SRI Bus Access Error Flag Clear (w) */
...
typedef struct _Ifx_HSSL_MFLAGSEN_Bits
{
    ...
    unsigned int SRIEEN:1;                  /**< \brief [22:22] SRI Bus Access Error Enable Bit (rw) */
...
typedef struct _Ifx_HSSL_MFLAGSSET_Bits
{
    ...
    unsigned int SRIES:1;                   /**< \brief [22:22] SRI Bus Access Error Flag Set (w) */
...
typedef volatile struct _Ifx_HSSL
{
    ...
    unsigned char reserved_C0[40];          /**< \brief C0, \internal Reserved */
