...
{
    unsigned int PHYPD:1;                   /**< \brief [0:0] Physical layer Power Down (rw) */
...
typedef struct _Ifx_HSCT_DISABLE_Bits
{
    ...
    unsigned int TX_PWDPD:1;                /**< \brief [3:3] Disable TX Power down pull down. (rw) */
    unsigned int reserved_4:28;             /**< \brief \internal Reserved */
...
{
    unsigned int TERM:1;                    /**< \brief [0:0] Select Receiver Termination Mode of HSCT Interface (rw) */
