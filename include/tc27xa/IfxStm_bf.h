...
/** \\brief  Length for Ifx_STM_CAP_Bits.STMCAP */
#define IFX_STM_CAP_STMCAP_LEN (32)

/** \\brief  Mask for Ifx_STM_CAP_Bits.STMCAP */
#define IFX_STM_CAP_STMCAP_MSK (0xffffffff)

/** \\brief  Offset for Ifx_STM_CAP_Bits.STMCAP */
#define IFX_STM_CAP_STMCAP_OFF (0)
...
/** \\brief  Length for Ifx_STM_TIM0_Bits.STM */
#define IFX_STM_TIM0_STM_LEN (32)

/** \\brief  Mask for Ifx_STM_TIM0_Bits.STM */
#define IFX_STM_TIM0_STM_MSK (0xffffffff)

/** \\brief  Offset for Ifx_STM_TIM0_Bits.STM */
#define IFX_STM_TIM0_STM_OFF (0)

/** \\brief  Length for Ifx_STM_TIM1_Bits.STM */
#define IFX_STM_TIM1_STM_LEN (32)

/** \\brief  Mask for Ifx_STM_TIM1_Bits.STM */
#define IFX_STM_TIM1_STM_MSK (0xffffffff)

/** \\brief  Offset for Ifx_STM_TIM1_Bits.STM */
#define IFX_STM_TIM1_STM_OFF (0)

/** \\brief  Length for Ifx_STM_TIM2_Bits.STM */
#define IFX_STM_TIM2_STM_LEN (32)

/** \\brief  Mask for Ifx_STM_TIM2_Bits.STM */
#define IFX_STM_TIM2_STM_MSK (0xffffffff)

/** \\brief  Offset for Ifx_STM_TIM2_Bits.STM */
#define IFX_STM_TIM2_STM_OFF (0)

/** \\brief  Length for Ifx_STM_TIM3_Bits.STM */
#define IFX_STM_TIM3_STM_LEN (32)

/** \\brief  Mask for Ifx_STM_TIM3_Bits.STM */
#define IFX_STM_TIM3_STM_MSK (0xffffffff)

/** \\brief  Offset for Ifx_STM_TIM3_Bits.STM */
#define IFX_STM_TIM3_STM_OFF (0)

/** \\brief  Length for Ifx_STM_TIM4_Bits.STM */
#define IFX_STM_TIM4_STM_LEN (32)

/** \\brief  Mask for Ifx_STM_TIM4_Bits.STM */
#define IFX_STM_TIM4_STM_MSK (0xffffffff)

/** \\brief  Offset for Ifx_STM_TIM4_Bits.STM */
#define IFX_STM_TIM4_STM_OFF (0)

/** \\brief  Length for Ifx_STM_TIM5_Bits.STM */
#define IFX_STM_TIM5_STM_LEN (32)

/** \\brief  Mask for Ifx_STM_TIM5_Bits.STM */
#define IFX_STM_TIM5_STM_MSK (0xffffffff)

/** \\brief  Offset for Ifx_STM_TIM5_Bits.STM */
#define IFX_STM_TIM5_STM_OFF (0)

/** \\brief  Length for Ifx_STM_TIM6_Bits.STM */
#define IFX_STM_TIM6_STM_LEN (32)

/** \\brief  Mask for Ifx_STM_TIM6_Bits.STM */
#define IFX_STM_TIM6_STM_MSK (0xffffffff)

/** \\brief  Offset for Ifx_STM_TIM6_Bits.STM */
#define IFX_STM_TIM6_STM_OFF (0)
/** \}  */
/******************************************************************************/
/******************************************************************************/
#endif /* IFXSTM_BF_H */
