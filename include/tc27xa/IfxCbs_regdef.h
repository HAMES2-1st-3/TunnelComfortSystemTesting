...
typedef struct _Ifx_CBS_OIFM_Bits
{
    ...
    unsigned int PADCTL:4;                  /**< \brief [15:12] Pad Control for Debug Interface Pins (padctl_o) (rw) */
...
typedef struct _Ifx_CBS_TL1ST_Bits
{
    ...
    unsigned int M0123:4;                   /**< \brief [27:24] Master X as Suspend Target (rw) */
...
typedef volatile struct _Ifx_CBS
{
    ...
    unsigned char reserved_2C[16];          /**< \brief 2C, \internal Reserved */
