...
/** \\brief  Length for Ifx_ETH_BUS_MODE_Bits.HEIGHTxPBL */
#define IFX_ETH_BUS_MODE_HEIGHTXPBL_LEN (1)

/** \\brief  Mask for Ifx_ETH_BUS_MODE_Bits.HEIGHTxPBL */
#define IFX_ETH_BUS_MODE_HEIGHTXPBL_MSK (0x1)

/** \\brief  Offset for Ifx_ETH_BUS_MODE_Bits.HEIGHTxPBL */
#define IFX_ETH_BUS_MODE_HEIGHTXPBL_OFF (24)
