...
/** \\brief  Length for Ifx_SRC_SRCR_Bits.BUSY */
#define IFX_SRC_SRCR_BUSY_LEN (1)

/** \\brief  Mask for Ifx_SRC_SRCR_Bits.BUSY */
#define IFX_SRC_SRCR_BUSY_MSK (0x1)

/** \\brief  Offset for Ifx_SRC_SRCR_Bits.BUSY */
#define IFX_SRC_SRCR_BUSY_OFF (31)
...
#define IFX_SRC_SRCR_TOS_LEN (3)

/** \\brief  Mask for Ifx_SRC_SRCR_Bits.TOS */
#define IFX_SRC_SRCR_TOS_MSK (0x7)
