...
typedef struct _Ifx_FLASH_HSMFSR_Bits
{
    ...
    unsigned int D1BUSY:1;                  /**< \brief [2:2] Data Flash Bank1 BusyCleared with application reset (rh) */
    unsigned int reserved_3:4;              /**< \brief \internal Reserved */
    unsigned int PROG:1;                    /**< \brief [7:7] Programming State Cleared with command "Clear Status"Cleared with power-on reset (PORST) (rwh) */
    unsigned int ERASE:1;                   /**< \brief [8:8] Erase State (rwh) */
    unsigned int reserved_9:1;              /**< \brief \internal Reserved */
    unsigned int DFPAGE:1;                  /**< \brief [10:10] Data Flash in Page ModeCleared with command "Reset to Read" (rh) */
    unsigned int OPER:1;                    /**< \brief [11:11] Flash Operation Error (rwh) */
    unsigned int SQER:1;                    /**< \brief [12:12] Command Sequence Error (rwh) */
...
{
    unsigned char reserved_0[4104];         /**< \brief 0, \internal Reserved */
