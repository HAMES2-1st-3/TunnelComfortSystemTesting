...
typedef union { /* 32 bits */
   struct {
      unsigned int REGENAB:1;           /*  = [0] = 0x00000001 */
      unsigned int ALTENAB:1;           /*  = [1] = 0x00000002 */
      unsigned int WPROT:1;             /*  = [2] = 0x00000004 */
      unsigned int GLOBALCS:1;          /*  = [3] = 0x00000008 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int CMDDELAY:4;          /*  = [20..23] = 0x00f00000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int FBBMSEL:1;           /*  = [3] = 0x00000008 */
      unsigned int _bit4:1;             /* 0 = [4] = 0x00000010 */
      unsigned int FDBKEN:1;            /*  = [5] = 0x00000020 */
      unsigned int BFCMSEL:1;           /*  = [6] = 0x00000040 */
      unsigned int NAA:1;               /*  = [7] = 0x00000080 */
      ...
      unsigned int ECSE:1;              /*  = [16] = 0x00010000 */
      unsigned int EBSE:1;              /*  = [17] = 0x00020000 */
      unsigned int DBA:1;               /*  = [18] = 0x00040000 */
      unsigned int WAITINV:1;           /*  = [19] = 0x00080000 */
      unsigned int BCGEN:2;             /*  = [20..21] = 0x00300000 */
      unsigned int PORTW:2;             /*  = [22..23] = 0x00c00000 */
      unsigned int WAIT:2;              /*  = [24..25] = 0x03000000 */
      unsigned int AAP:1;               /*  = [26] = 0x04000000 */
      unsigned int RES0:1;              /*  = [27] = 0x08000000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int ECSE:1;              /*  = [16] = 0x00010000 */
      unsigned int EBSE:1;              /*  = [17] = 0x00020000 */
      unsigned int RES1:1;              /*  = [18] = 0x00040000 */
      unsigned int WAITINV:1;           /*  = [19] = 0x00080000 */
      unsigned int BCGEN:2;             /*  = [20..21] = 0x00300000 */
      unsigned int PORTW:2;             /*  = [22..23] = 0x00c00000 */
      unsigned int WAIT:2;              /*  = [24..25] = 0x03000000 */
      unsigned int AAP:1;               /*  = [26] = 0x04000000 */
      unsigned int LOCKCS:1;            /*  = [27] = 0x08000000 */
      unsigned int AGEN:4;              /*  = [28..31] = 0xf0000000 */
   } bits;
   unsigned long reg;
...
typedef union { /* 32 bits */
   struct {
      unsigned int TAG:31;              /*  = [0..30] = 0x7fffffff */
      unsigned int ACTIVE:1;            /*  = [31] = 0x80000000 */
   } bits;
   unsigned long reg;
} __attribute__((aligned(4))) EBU_DDRNTAGm_t_nonv;

typedef volatile EBU_DDRNTAGm_t_nonv EBU_DDRNTAGm_t;
