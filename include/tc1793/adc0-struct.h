...
#ifndef _TC1793_ADC0_STRUCTS_H_
#define _TC1793_ADC0_STRUCTS_H_
/*
   TriCore TC1793
...
typedef struct
{
    ...
    unsigned int    reserved94[0x1];    /* 0x214 */
    ADCn_APR_t      APR;                /* 0x218 */
    unsigned int    reserved96[0x1];    /* 0x21c */
    ADCn_EMCTR_t    EMCTR;              /* 0x220 */
    ADCn_BWDENR_t   BWDENR;             /* 0x224 */
    ADCn_BWDCFGR_t  BWDCFGR;            /* 0x228 */
    unsigned int    reserved100[0x6c];  /* 0x22c */
    ADC0_SRCm_t     SRC8;               /* 0x3dc */
    ADC0_SRCm_t     SRC7;               /* 0x3e0 */
    ADC0_SRCm_t     SRC6;               /* 0x3e4 */
    ADC0_SRCm_t     SRC5;               /* 0x3e8 */
    ADC0_SRCm_t     SRC4;               /* 0x3ec */
    ADC0_SRCm_t     SRC3;               /* 0x3f0 */
    ADC0_SRCm_t     SRC2;               /* 0x3f4 */
    ADC0_SRCm_t     SRC1;               /* 0x3f8 */
    ADC0_SRCm_t     SRC0;               /* 0x3fc */
} ADC0_t;

#endif /* _TC1793_ADC0_STRUCTS_H_ */
