...
#ifndef _HAVE_TRICORE_MSC0_1_SHARETYPES_H_
#define _HAVE_TRICORE_MSC0_1_SHARETYPES_H_
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit14:1;            /* 0 = [14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15] = 0x00008000 */
      unsigned int V:1;                 /*  = [16] = 0x00010000 */
      unsigned int P:1;                 /*  = [17] = 0x00020000 */
      unsigned int C:1;                 /*  = [18] = 0x00040000 */
      unsigned int LABF:2;              /*  = [19..20] = 0x00180000 */
      unsigned int IPF:1;               /*  = [21] = 0x00200000 */
      unsigned int PERR:1;              /*  = [22] = 0x00400000 */
      unsigned int _bit23:1;            /* 0 = [23] = 0x00800000 */
      unsigned int _bit24:1;            /* 0 = [24] = 0x01000000 */
      unsigned int _bit25:1;            /* 0 = [25] = 0x02000000 */
      unsigned int _bit26:1;            /* 0 = [26] = 0x04000000 */
...
#endif /* _HAVE_TRICORE_MSC0_1_SHARETYPES_H_ */
