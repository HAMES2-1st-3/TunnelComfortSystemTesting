...
#ifndef _HAVE_TRICORE_SENT_TYPES_H_
#define _HAVE_TRICORE_SENT_TYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) SENT_CLC_t_nonv;

typedef volatile SENT_CLC_t_nonv SENT_CLC_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) SENT_FDR_t_nonv;

typedef volatile SENT_FDR_t_nonv SENT_FDR_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) SENT_ID_t_nonv;

typedef volatile SENT_ID_t_nonv SENT_ID_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int IPC0:1;              /*  = [0] = 0x00000001 */
      unsigned int IPC1:1;              /*  = [1] = 0x00000002 */
      unsigned int IPC2:1;              /*  = [2] = 0x00000004 */
      unsigned int IPC3:1;              /*  = [3] = 0x00000008 */
      unsigned int IPC4:1;              /*  = [4] = 0x00000010 */
      unsigned int IPC5:1;              /*  = [5] = 0x00000020 */
      unsigned int IPC6:1;              /*  = [6] = 0x00000040 */
      unsigned int IPC7:1;              /*  = [7] = 0x00000080 */
      unsigned int _bit8:1;             /* 0 = [8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11] = 0x00000800 */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) SENT_INTOV_t_nonv;

typedef volatile SENT_INTOV_t_nonv SENT_INTOV_t;


#endif /* _HAVE_TRICORE_SENT_TYPES_H_ */
