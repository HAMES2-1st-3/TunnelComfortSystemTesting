...
#define BMU_FMCTL_MASK                  0x00000007
#define BMU_FMCTL_FHT_INT_MASK          0x00000001
#define BMU_FMCTL_FHT_INT_SHIFT         0
#define BMU_FMCTL_OVF_INT_MASK          0x00000002
#define BMU_FMCTL_OVF_INT_SHIFT         1
