...
#ifndef _HAVE_TRICORE_MLI0_1_SHARETYPES_H_
#define _HAVE_TRICORE_MLI0_1_SHARETYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) MLIn_AERm_t_nonv;

typedef volatile MLIn_AERm_t_nonv MLIn_AERm_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) MLIn_ARRm_t_nonv;

typedef volatile MLIn_ARRm_t_nonv MLIn_ARRm_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int AP:10;               /*  = [6..15] = 0x0000ffc0 */
      unsigned int OP:1;                /*  = [16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19] = 0x00080000 */
      unsigned int _bit20:1;            /* 0 = [20] = 0x00100000 */
...
#endif /* _HAVE_TRICORE_MLI0_1_SHARETYPES_H_ */
