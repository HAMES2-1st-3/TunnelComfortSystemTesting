...
typedef union { /* 32 bits */
   struct {
      unsigned int CR:13;               /*  = [0..12] = 0x00001fff */
      unsigned int _bit13:1;            /* 0 = [13..13] = 0x00002000 */
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_CRR0_t_nonv;

typedef volatile FADC_CRR0_t_nonv FADC_CRR0_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_CRR1_t_nonv;

typedef volatile FADC_CRR1_t_nonv FADC_CRR1_t;
...
/********************** FADC_NCTR_t *************************/
/*
   FADC_NCTR             "Neighbour Channel Trigger Register"
*/
/**********************************************************/
