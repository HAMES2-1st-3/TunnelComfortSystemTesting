...
/* block "STM" of TriCore TC1162 (17 SFRs) */

#include <tc1162/stm/addr.h>

#include <tc1162/stm/masks.h>
#include <tc1162/stm/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1162/stm/types.h>
#include <tc1162/stm/sharetypes.h>
...
SFR_ABS (STM_CAP, STM_CAP_t, STM_CAP_ADDR);       /* "Timer Capture Register" */
...
SFR_ABS (STM_TIM0, STM_TIM0_t, STM_TIM0_ADDR);    /* "Timer Register 0" */
SFR_ABS (STM_TIM1, STM_TIM1_t, STM_TIM1_ADDR);    /* "Timer Register 1" */
SFR_ABS (STM_TIM2, STM_TIM2_t, STM_TIM2_ADDR);    /* "Timer Register 2" */
SFR_ABS (STM_TIM3, STM_TIM3_t, STM_TIM3_ADDR);    /* "Timer Register 3" */
SFR_ABS (STM_TIM4, STM_TIM4_t, STM_TIM4_ADDR);    /* "Timer Register 4" */
SFR_ABS (STM_TIM5, STM_TIM5_t, STM_TIM5_ADDR);    /* "Timer Register 5" */
SFR_ABS (STM_TIM6, STM_TIM6_t, STM_TIM6_ADDR);    /* "Timer Register 6" */
