...
/** \brief Length for Ifx_SPULCKSTP_CLC_Bits.RES */
#define IFX_SPULCKSTP_CLC_RES_LEN (1u)

/** \brief Mask for Ifx_SPULCKSTP_CLC_Bits.RES */
#define IFX_SPULCKSTP_CLC_RES_MSK (0x1u)

/** \brief Offset for Ifx_SPULCKSTP_CLC_Bits.RES */
#define IFX_SPULCKSTP_CLC_RES_OFF (2u)
