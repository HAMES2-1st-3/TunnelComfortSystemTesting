 ...
 *
 * \defgroup IfxLld_Cbs_Registers_Cfg Cbs address
 * \ingroup IfxLld_Cbs_Registers
 * 
 * \defgroup IfxLld_Cbs_Registers_Cfg_BaseAddress Base address
 * \ingroup IfxLld_Cbs_Registers_Cfg
 *
 * \defgroup IfxLld_Cbs_Registers_Cfg_Cbs 2-CBS
 * \ingroup IfxLld_Cbs_Registers_Cfg
 *
 *
 */
...
/** \brief 20, TG Routing for CPU${x} */
#define CBS_TRC0 /*lint --e(923)*/ (*(volatile Ifx_CBS_TRC*)0xF0000420u)

/** \brief 24, TG Routing for CPU${x} */
#define CBS_TRC1 /*lint --e(923)*/ (*(volatile Ifx_CBS_TRC*)0xF0000424u)

/** \brief 28, TG Routing for CPU${x} */
#define CBS_TRC2 /*lint --e(923)*/ (*(volatile Ifx_CBS_TRC*)0xF0000428u)

/** \brief 2C, TG Routing for CPU${x} */
#define CBS_TRC3 /*lint --e(923)*/ (*(volatile Ifx_CBS_TRC*)0xF000042Cu)

/** \brief 30, TG Routing for CPU${x} */
#define CBS_TRC4 /*lint --e(923)*/ (*(volatile Ifx_CBS_TRC*)0xF0000430u)

/** \brief 34, TG Routing for CPU${x} */
#define CBS_TRC5 /*lint --e(923)*/ (*(volatile Ifx_CBS_TRC*)0xF0000434u)

/** \brief 38, TG Routing for${CBS_hsm_name}Control */
...
/** \brief 64, ${CBS_jtag_name}Device Identification Register */
...
/** \brief 6C, ${CBS_ioclient_name}Status and Control Register */
...
/** \brief 7C, ${OSCU_Name}Control Register */
#define CBS_OCNTRL /*lint --e(923)*/ (*(volatile Ifx_CBS_OCNTRL*)0xF000047Cu)

/** \brief 80, ${OSCU_Name}Status Register */
...
/** \brief C0, TG Routing Events of CPU${x} */
#define CBS_TREC0 /*lint --e(923)*/ (*(volatile Ifx_CBS_TREC*)0xF00004C0u)

/** \brief C4, TG Routing Events of CPU${x} */
#define CBS_TREC1 /*lint --e(923)*/ (*(volatile Ifx_CBS_TREC*)0xF00004C4u)

/** \brief C8, TG Routing Events of CPU${x} */
#define CBS_TREC2 /*lint --e(923)*/ (*(volatile Ifx_CBS_TREC*)0xF00004C8u)

/** \brief CC, TG Routing Events of CPU${x} */
#define CBS_TREC3 /*lint --e(923)*/ (*(volatile Ifx_CBS_TREC*)0xF00004CCu)

/** \brief D0, TG Routing Events of CPU${x} */
#define CBS_TREC4 /*lint --e(923)*/ (*(volatile Ifx_CBS_TREC*)0xF00004D0u)

/** \brief D4, TG Routing Events of CPU${x} */
#define CBS_TREC5 /*lint --e(923)*/ (*(volatile Ifx_CBS_TREC*)0xF00004D4u)

/** \brief DC, TG Routing for MCDS Triggers */
#define CBS_TRMT /*lint --e(923)*/ (*(volatile Ifx_CBS_TRMT*)0xF00004DCu)

/** \brief E0, TG Routing for OTGB0 Bits [7:0] */
...
/** \brief E4, TG Routing for OTGB0 Bits [15:8] */
...
/** \brief E8, TG Routing for OTGB0 Bits [7:0] */
...
/** \brief EC, TG Routing for OTGB0 Bits [15:8] */
