...
#include <tc1165/mli1/addr.h>

#include <tc1165/mli1/masks.h>
#include <tc1165/mli0_mli1/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1165/mli1/types.h>
#include <tc1165/mli0_mli1/sharetypes.h>
...
SFR_NOABS (MLI1_AER, MLIn_AER_t, MLI1_AER_ADDR);  /* "Access Enable Register" */
SFR_NOABS (MLI1_ARR, MLIn_ARR_t, MLI1_ARR_ADDR);  /* "Access Range Register" */
SFR_NOABS (MLI1_FDR, MLIn_FDR_t, MLI1_FDR_ADDR);  /* "MLI Fractional Divider Register" */
SFR_NOABS (MLI1_GINTR, MLIn_GINTR_t, MLI1_GINTR_ADDR); /* "MLI Global Interrupt Set Register" */
SFR_NOABS (MLI1_ID, MLIn_ID_t, MLI1_ID_ADDR);     /* "MLI Module Identification Register" */
...
SFR_NOABS (MLI1_TRSTATR, MLIn_TRSTATR_t, MLI1_TRSTATR_ADDR); /* "Transmitter Registers Status Register" */
SFR_NOABS (MLI1_TSTATR, MLIn_TSTATR_t, MLI1_TSTATR_ADDR); /* "Transmitter Status Register" */


#endif /* /NO_TRICORE_SFRTYPEDEFS */
#endif /* _HAVE_TRICORE_MLI1_H_ (block "MLI LL1") */
