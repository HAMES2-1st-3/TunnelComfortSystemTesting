...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P1_ESR_t_nonv;

typedef volatile P1_ESR_t_nonv P1_ESR_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P1_IN_t_nonv;

typedef volatile P1_IN_t_nonv P1_IN_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P1_IOCR12_t_nonv;

typedef volatile P1_IOCR12_t_nonv P1_IOCR12_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P1_OMR_t_nonv;

typedef volatile P1_OMR_t_nonv P1_OMR_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P1_OUT_t_nonv;

typedef volatile P1_OUT_t_nonv P1_OUT_t;
