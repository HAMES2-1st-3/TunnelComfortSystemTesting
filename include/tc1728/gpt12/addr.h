...
#define GPT120_T2CON_ADDR     0xF0003410     /* "Timer T2 Control Register" */
#define GPT120_T3CON_ADDR     0xF0003414     /* "Timer T3 Control Register" */
#define GPT120_T4CON_ADDR     0xF0003418     /* "Timer T4 Control Register" */
#define GPT120_T5CON_ADDR     0xF000341C     /* "Timer T5 Control Register" */
#define GPT120_T6CON_ADDR     0xF0003420     /* "Timer T6 Control Register" */
#define GPT120_CAPREL_ADDR    0xF0003430     /* "Capture and Reload Register" */
#define GPT120_T2_ADDR        0xF0003434     /* "Timer T2 Register" */
#define GPT120_T3_ADDR        0xF0003438     /* "Timer T3 Register" */
#define GPT120_T4_ADDR        0xF000343C     /* "Timer T4 Register" */
#define GPT120_T5_ADDR        0xF0003440     /* "Timer T5 Register" */
#define GPT120_T6_ADDR        0xF0003444     /* "Timer T6 Register" */
...
#define GPT121_T2CON_ADDR     0xF0003510     /* "Timer T2 Control Register" */
#define GPT121_T3CON_ADDR     0xF0003514     /* "Timer T3 Control Register" */
#define GPT121_T4CON_ADDR     0xF0003518     /* "Timer T4 Control Register" */
#define GPT121_T5CON_ADDR     0xF000351C     /* "Timer T5 Control Register" */
#define GPT121_T6CON_ADDR     0xF0003520     /* "Timer T6 Control Register" */
#define GPT121_CAPREL_ADDR    0xF0003530     /* "Capture and Reload Register" */
#define GPT121_T2_ADDR        0xF0003534     /* "Timer T2 Register" */
#define GPT121_T3_ADDR        0xF0003538     /* "Timer T3 Register" */
#define GPT121_T4_ADDR        0xF000353C     /* "Timer T4 Register" */
#define GPT121_T5_ADDR        0xF0003540     /* "Timer T5 Register" */
#define GPT121_T6_ADDR        0xF0003544     /* "Timer T6 Register" */
