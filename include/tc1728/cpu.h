...
/* block "CPU" of TriCore TC1728 (152 SFRs) */

#include <tc1728/cpu/addr.h>

#include <tc1728/cpu/masks.h>
#include <tc1728/cpu/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1728/cpu/types.h>
#include <tc1728/cpu/sharetypes.h>
...
SFR_NOABS (ADEDCTL, ADEDCTL_t, ADEDCTL_ADDR);     /* "Address Error Detection Control Register" */
...
SFR_NOABS (CPR3_0U, CPRn_mU_t, CPR3_0U_ADDR);     /* "Code Segment Protection Register Set 3, Range 0, Upper Boundary" */
SFR_NOABS (CPR3_1L, CPRn_mL_t, CPR3_1L_ADDR);     /* "Code Segment Protection Register Set 3, Range 1, Lower Boundary" */
SFR_NOABS (CPR3_1U, CPRn_mU_t, CPR3_1U_ADDR);     /* "Code Segment Protection Register Set 3, Range 1, Upper Boundary" */
...
SFR_NOABS (RDEDCTL, RDEDCTL_t, RDEDCTL_ADDR);     /* "Read Data Error Detection Control Register" */
SFR_NOABS (REEDCTL, REEDCTL_t, REEDCTL_ADDR);     /* "Response Error Detection Control Register" */
...
SFR_NOABS (WREDCTL, WREDCTL_t, WREDCTL_ADDR);     /* "Write Data Error Detection Control Register" */
