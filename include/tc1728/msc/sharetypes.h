...
#ifndef _HAVE_TRICORE_MSC_SHARETYPES_H_
#define _HAVE_TRICORE_MSC_SHARETYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) MSC0_SRCm_t_nonv;

typedef volatile MSC0_SRCm_t_nonv MSC0_SRCm_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) MSC0_UDm_t_nonv;

typedef volatile MSC0_UDm_t_nonv MSC0_UDm_t;


#endif /* _HAVE_TRICORE_MSC_SHARETYPES_H_ */
