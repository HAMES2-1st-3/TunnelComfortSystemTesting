...
#ifndef _TC1728_ADC0_STRUCTS_H_
#define _TC1728_ADC0_STRUCTS_H_
/*
   TriCore TC1728
   Some struct definitions for conveniance
*/

#include <tc1728/adc0.h>
#ifndef ADC0_BASE
...
typedef struct
{
    ...
    unsigned int    reserved100[0x19];  /* 0x22c */
    ADC0_SLCON_t    SLCON;              /* 0x290 */
    unsigned int    reserved102[0x55];  /* 0x294 */
