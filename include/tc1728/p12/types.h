...
#ifndef _HAVE_TRICORE_P12_TYPES_H_
#define _HAVE_TRICORE_P12_TYPES_H_


/********************** P12_PDISC_t *************************/
/*
   P12_PDISC             "Port 12 Pin Function Decision Control Register"
*/
/**********************************************************/
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) P12_PDISC_t_nonv;

typedef volatile P12_PDISC_t_nonv P12_PDISC_t;


#endif /* _HAVE_TRICORE_P12_TYPES_H_ */
