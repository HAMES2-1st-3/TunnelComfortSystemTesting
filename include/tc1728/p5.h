...
#include <tc1728/p5/addr.h>

#include <tc1728/p5/masks.h>
#include <tc1728/p0-6_8-12/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1728/p5/types.h>
...
SFR_ABS (P5_PDR0, P5_PDR0_t, P5_PDR0_ADDR);       /* "Port 5 Pad Driver Mode 0 Register" */
SFR_ABS (P5_PDR1, P5_PDR1_t, P5_PDR1_ADDR);       /* "Port 5 Pad Driver Mode 1 Register" */
