...
/* block "Buses" of TriCore TC1728 (31 SFRs) */

#include <tc1728/buses/addr.h>

#include <tc1728/buses/masks.h>
#include <tc1728/buses/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1728/buses/types.h>
#include <tc1728/buses/sharetypes.h>
...
SFR_NOABS (LBCU_LEADDED, LBCU_LEADDED_t, LBCU_LEADDED_ADDR); /* "LMB Error Address Error Detection Register" */
...
SFR_NOABS (LBCU_LEDATED, LBCU_LEDATED_t, LBCU_LEDATED_ADDR); /* "LMB Error Data Error Detection Register" */
...
SFR_NOABS (LBCU_LERESED, LBCU_LERESED_t, LBCU_LERESED_ADDR); /* "LMB Error Response Error Detection Register" */
SFR_NOABS (LBCU_LSEABS, LBCU_LSEABS_t, LBCU_LSEABS_ADDR); /* "LMB Soft Error Abort Source Register" */
SFR_NOABS (LBCU_LSEADS, LBCU_LSEADS_t, LBCU_LSEADS_ADDR); /* "LMB Soft Error Address Source Register" */
SFR_NOABS (LBCU_LSERDS, LBCU_LSERDS_t, LBCU_LSERDS_ADDR); /* "LMB Soft Error Read Source Register" */
SFR_NOABS (LBCU_LSERES, LBCU_LSERES_t, LBCU_LSERES_ADDR); /* "LMB Soft Error Response Register" */
SFR_NOABS (LBCU_LSEWRS, LBCU_LSEWRS_t, LBCU_LSEWRS_ADDR); /* "LMB Soft Error Write Source Register" */
