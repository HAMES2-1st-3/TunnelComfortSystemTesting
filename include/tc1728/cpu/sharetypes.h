...
typedef union { /* 32 bits */
   struct {
      unsigned int RBU0:1;              /*  = [0] = 0x00000001 */
      unsigned int WBU0:1;              /*  = [1] = 0x00000002 */
      unsigned int RBL0:1;              /*  = [2] = 0x00000004 */
      unsigned int WBL0:1;              /*  = [3] = 0x00000008 */
      unsigned int RS0:1;               /*  = [4] = 0x00000010 */
      unsigned int WS0:1;               /*  = [5] = 0x00000020 */
      unsigned int RE0:1;               /*  = [6] = 0x00000040 */
      unsigned int WE0:1;               /*  = [7] = 0x00000080 */
      unsigned int RBU1:1;              /*  = [8] = 0x00000100 */
      unsigned int WBU1:1;              /*  = [9] = 0x00000200 */
      unsigned int RBL1:1;              /*  = [10] = 0x00000400 */
      unsigned int WBL1:1;              /*  = [11] = 0x00000800 */
      unsigned int RS1:1;               /*  = [12] = 0x00001000 */
      unsigned int WS1:1;               /*  = [13] = 0x00002000 */
      unsigned int RE1:1;               /*  = [14] = 0x00004000 */
      unsigned int WE1:1;               /*  = [15] = 0x00008000 */
      unsigned int RBU2:1;              /*  = [16] = 0x00010000 */
      unsigned int WBU2:1;              /*  = [17] = 0x00020000 */
      unsigned int RBL2:1;              /*  = [18] = 0x00040000 */
      unsigned int WBL2:1;              /*  = [19] = 0x00080000 */
      unsigned int RS2:1;               /*  = [20] = 0x00100000 */
      unsigned int WS2:1;               /*  = [21] = 0x00200000 */
      unsigned int RE2:1;               /*  = [22] = 0x00400000 */
      unsigned int WE2:1;               /*  = [23] = 0x00800000 */
      unsigned int RBU3:1;              /*  = [24] = 0x01000000 */
      unsigned int WBU3:1;              /*  = [25] = 0x02000000 */
      unsigned int RBL3:1;              /*  = [26] = 0x04000000 */
      unsigned int WBL3:1;              /*  = [27] = 0x08000000 */
      unsigned int RS3:1;               /*  = [28] = 0x10000000 */
      unsigned int WS3:1;               /*  = [29] = 0x20000000 */
      unsigned int RE3:1;               /*  = [30] = 0x40000000 */
      unsigned int WE3:1;               /*  = [31] = 0x80000000 */
   } bits;
   unsigned long reg;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int DLR_LR:1;            /*  = [8] = 0x00000100 */
      unsigned int DLR_U:1;             /*  = [9] = 0x00000200 */
      unsigned int DU_LR:1;             /*  = [10] = 0x00000400 */
      unsigned int DU_U:1;              /*  = [11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12] = 0x00001000 */
