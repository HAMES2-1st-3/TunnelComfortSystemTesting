...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) P8_PDR0_t_nonv;

typedef volatile P8_PDR0_t_nonv P8_PDR0_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg;
} __attribute__((aligned(4))) P8_PDR1_t_nonv;

typedef volatile P8_PDR1_t_nonv P8_PDR1_t;
