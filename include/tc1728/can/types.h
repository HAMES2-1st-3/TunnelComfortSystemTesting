...
typedef union { /* 32 bits */
   struct {
      unsigned int NEWDISC:1;           /*  = [0] = 0x00000001 */
      unsigned int DISC:1;              /*  = [1] = 0x00000002 */
      unsigned int _bit2:1;             /* 0 = [2] = 0x00000004 */
      unsigned int _bit3:1;             /* 0 = [3] = 0x00000008 */
      unsigned int _bit4:1;             /* 0 = [4] = 0x00000010 */
      unsigned int _bit5:1;             /* 0 = [5] = 0x00000020 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int CLKSEL:4;            /*  = [0..3] = 0x0000000f */
      unsigned int _bit4:1;             /* 0 = [4] = 0x00000010 */
      unsigned int _bit5:1;             /* 0 = [5] = 0x00000020 */
      unsigned int _bit6:1;             /* 0 = [6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7] = 0x00000080 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int BUSY:1;              /*  = [8] = 0x00000100 */
      unsigned int RBUSY:1;             /*  = [9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12] = 0x00001000 */
      unsigned int _bit13:1;            /* 0 = [13] = 0x00002000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int IENTRAF0:1;          /*  = [4] = 0x00000010 */
      unsigned int IENTRAF1:1;          /*  = [5] = 0x00000020 */
      unsigned int IENRECF0:1;          /*  = [6] = 0x00000040 */
      unsigned int IENRECF1:1;          /*  = [7] = 0x00000080 */
      unsigned int CHEN:1;              /*  = [8] = 0x00000100 */
      unsigned int TREN:1;              /*  = [9] = 0x00000200 */
      unsigned int ALTMSG:2;            /*  = [10..11] = 0x00000c00 */
      unsigned int ARBM:2;              /*  = [12..13] = 0x00003000 */
      unsigned int GM:1;                /*  = [14] = 0x00004000 */
      unsigned int ICF:1;               /*  = [15] = 0x00008000 */
      unsigned int RCEV:1;              /*  = [16] = 0x00010000 */
      unsigned int TCEV:1;              /*  = [17] = 0x00020000 */
      unsigned int ICEV:1;              /*  = [18] = 0x00040000 */
      unsigned int ARBV:1;              /*  = [19] = 0x00080000 */
      unsigned int TMEV:1;              /*  = [20] = 0x00100000 */
      unsigned int RMEV:1;              /*  = [21] = 0x00200000 */
      unsigned int BCEV:1;              /*  = [22] = 0x00400000 */
      unsigned int _bit23:1;            /* 0 = [23] = 0x00800000 */
      unsigned int _bit24:1;            /* 0 = [24] = 0x01000000 */
      unsigned int _bit25:1;            /* 0 = [25] = 0x02000000 */
      unsigned int _bit26:1;            /* 0 = [26] = 0x04000000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int ETM:1;               /*  = [7] = 0x00000080 */
      unsigned int TTLVL:1;             /*  = [8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11] = 0x00000800 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int STE:1;               /*  = [4] = 0x00000010 */
      unsigned int ETREVR:1;            /*  = [5] = 0x00000020 */
      unsigned int _bit6:1;             /* 0 = [6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7] = 0x00000080 */
      unsigned int _bit8:1;             /* 0 = [8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9] = 0x00000200 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int TENWERIE:1;          /*  = [2] = 0x00000004 */
      unsigned int TTERIE:1;            /*  = [3] = 0x00000008 */
      unsigned int _bit4:1;             /* 0 = [4] = 0x00000010 */
      unsigned int _bit5:1;             /* 0 = [5] = 0x00000020 */
      unsigned int WTEIE:1;             /*  = [6] = 0x00000040 */
      unsigned int AWDIE:1;             /*  = [7] = 0x00000080 */
      unsigned int ERRSCIE:1;           /*  = [8] = 0x00000100 */
      unsigned int MSRCIE:1;            /*  = [9] = 0x00000200 */
      unsigned int SYNCSCIE:1;          /*  = [10] = 0x00000400 */
      unsigned int SEIE:1;              /*  = [11] = 0x00000800 */
      unsigned int NOTIFIE:1;           /*  = [12] = 0x00001000 */
      unsigned int _bit13:1;            /* 0 = [13] = 0x00002000 */
      unsigned int _bit14:1;            /* 0 = [14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16] = 0x00010000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int NMC:1;               /*  = [0] = 0x00000001 */
      unsigned int NBC:1;               /*  = [1] = 0x00000002 */
      unsigned int TENWER:1;            /*  = [2] = 0x00000004 */
      unsigned int TTUF:1;              /*  = [3] = 0x00000008 */
      unsigned int TTOF:1;              /*  = [4] = 0x00000010 */
      unsigned int WTE:1;               /*  = [5] = 0x00000020 */
      unsigned int IWTE:1;              /*  = [6] = 0x00000040 */
      unsigned int AWDERR:1;            /*  = [7] = 0x00000080 */
      unsigned int ERRSC:1;             /*  = [8] = 0x00000100 */
      unsigned int MSRC:1;              /*  = [9] = 0x00000200 */
      unsigned int SYNCSC:1;            /*  = [10] = 0x00000400 */
      unsigned int EOS:1;               /*  = [11] = 0x00000800 */
      unsigned int WFE:1;               /*  = [12] = 0x00001000 */
      unsigned int DISC:1;              /*  = [13] = 0x00002000 */
      unsigned int SERR1:1;             /*  = [14] = 0x00004000 */
      unsigned int SERR2:1;             /*  = [15] = 0x00008000 */
      unsigned int CFGERR:1;            /*  = [16] = 0x00010000 */
      unsigned int TURERR:1;            /*  = [17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19] = 0x00080000 */
      unsigned int _bit20:1;            /* 0 = [20] = 0x00100000 */
      unsigned int _bit21:1;            /* 0 = [21] = 0x00200000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit6:1;             /* 0 = [6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7] = 0x00000080 */
      unsigned int EFI:1;               /*  = [8] = 0x00000100 */
      unsigned int EFF:1;               /*  = [9] = 0x00000200 */
      unsigned int REFTRG:1;            /*  = [10] = 0x00000400 */
      unsigned int ARB:1;               /*  = [11] = 0x00000800 */
      unsigned int CFGM:1;              /*  = [12] = 0x00001000 */
      unsigned int TMPC:1;              /*  = [13] = 0x00002000 */
      unsigned int TRAF:1;              /*  = [14] = 0x00004000 */
      unsigned int RECF:1;              /*  = [15] = 0x00008000 */
      unsigned int MSCMIN:3;            /*  = [16..18] = 0x00070000 */
      unsigned int _bit19:1;            /* 0 = [19] = 0x00080000 */
      unsigned int MSCMAX:3;            /*  = [20..22] = 0x00700000 */
      unsigned int _bit23:1;            /* 0 = [23] = 0x00800000 */
      unsigned int NIG:1;               /*  = [24] = 0x01000000 */
      unsigned int ETR:1;               /*  = [25] = 0x02000000 */
      unsigned int ETREV:1;             /*  = [26] = 0x04000000 */
      unsigned int _bit27:1;            /* 0 = [27] = 0x08000000 */
      unsigned int _bit28:1;            /* 0 = [28] = 0x10000000 */
      unsigned int _bit29:1;            /* 0 = [29] = 0x20000000 */
      unsigned int _bit30:1;            /* 0 = [30] = 0x40000000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int ADJEN:1;             /*  = [0] = 0x00000001 */
      unsigned int _bit1:1;             /* 0 = [1] = 0x00000002 */
      unsigned int _bit2:1;             /* 0 = [2] = 0x00000004 */
      unsigned int _bit3:1;             /* 0 = [3] = 0x00000008 */
      unsigned int _bit4:1;             /* 0 = [4] = 0x00000010 */
      ...
      unsigned int VAL:1;               /*  = [16] = 0x00010000 */
      unsigned int LTCS:1;              /*  = [17] = 0x00020000 */
