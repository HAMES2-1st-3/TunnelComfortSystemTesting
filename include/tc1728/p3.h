...
#include <tc1728/p3/addr.h>

#include <tc1728/p3/masks.h>
#include <tc1728/p0-6_8-12/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1728/p3/types.h>
...
SFR_ABS (P3_PDR0, P3_PDR0_t, P3_PDR0_ADDR);       /* "Port 3 Pad Driver Mode 0 Register" */
SFR_ABS (P3_PDR1, P3_PDR1_t, P3_PDR1_ADDR);       /* "Port 3 Pad Driver Mode 1 Register" */
