...
#define LBCU_LEADDED_ADDR     0xF87FFE34     /* "LMB Error Address Error Detection Register" */
#define LBCU_LEDATED_ADDR     0xF87FFE38     /* "LMB Error Data Error Detection Register" */
#define LBCU_LERESED_ADDR     0xF87FFE3C     /* "LMB Error Response Error Detection Register" */
#define LBCU_LSEADS_ADDR      0xF87FFE40     /* "LMB Soft Error Address Source Register" */
#define LBCU_LSEABS_ADDR      0xF87FFE44     /* "LMB Soft Error Abort Source Register" */
#define LBCU_LSERDS_ADDR      0xF87FFE48     /* "LMB Soft Error Read Source Register" */
#define LBCU_LSEWRS_ADDR      0xF87FFE4C     /* "LMB Soft Error Write Source Register" */
#define LBCU_LSERES_ADDR      0xF87FFE50     /* "LMB Soft Error Response Register" */
