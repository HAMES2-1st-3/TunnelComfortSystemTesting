...
#include <tc1766b/dma/addr.h>

#include <tc1766b/dma/masks.h>
#include <tc1766b/dma/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1766b/dma/types.h>
#include <tc1766b/dma/sharetypes.h>
...
SFR_ABS (DMA_CHRSTR, DMA_CHRSTR_t, DMA_CHRSTR_ADDR); /* "Channel Reset Request Register" */
SFR_ABS (DMA_CHSR00, DMA_CHSRm_t, DMA_CHSR00_ADDR); /* "Channel 00 Status Register" */
...
SFR_ABS (DMA_CLRE, DMA_CLRE_t, DMA_CLRE_ADDR);    /* "Clear Error Register" */
...
SFR_ABS (DMA_EER, DMA_EER_t, DMA_EER_ADDR);       /* "Enable Error Register" */
SFR_ABS (DMA_ERRSR, DMA_ERRSR_t, DMA_ERRSR_ADDR); /* "Error Status Register" */
SFR_ABS (DMA_GINTR, DMA_GINTR_t, DMA_GINTR_ADDR); /* "DMA Global Interrupt Set Register" */
SFR_ABS (DMA_HTREQ, DMA_HTREQ_t, DMA_HTREQ_ADDR); /* "Hardware Transaction Request Register" */
SFR_ABS (DMA_ID, DMA_ID_t, DMA_ID_ADDR);          /* "DMA Module Identification Register" */
SFR_ABS (DMA_INTCR, DMA_INTCR_t, DMA_INTCR_ADDR); /* "Interrupt Clear Register" */
SFR_ABS (DMA_INTSR, DMA_INTSR_t, DMA_INTSR_ADDR); /* "Interrupt Status Register" */
SFR_ABS (DMA_ME0AENR, DMA_ME0AENR_t, DMA_ME0AENR_ADDR); /* "Move Engine 0 Access Enable Register" */
SFR_ABS (DMA_ME0ARR, DMA_ME0ARR_t, DMA_ME0ARR_ADDR); /* "Move Engine 0 Access Range Register" */
SFR_ABS (DMA_ME0PR, DMA_ME0PR_t, DMA_ME0PR_ADDR); /* "Move Engine 0 Pattern Register" */
SFR_ABS (DMA_ME0R, DMA_ME0R_t, DMA_ME0R_ADDR);    /* "Move Engine 0 Read Register" */
SFR_ABS (DMA_MESR, DMA_MESR_t, DMA_MESR_ADDR);    /* "Move Engine Status Register" */
SFR_ABS (DMA_MLI0SRC0, DMA_MLInSRCm_t, DMA_MLI0SRC0_ADDR); /* "MLI 0 Service Request Control Register 0" */
SFR_ABS (DMA_MLI0SRC1, DMA_MLInSRCm_t, DMA_MLI0SRC1_ADDR); /* "MLI 0 Service Request Control Register 1" */
SFR_ABS (DMA_MLI0SRC2, DMA_MLInSRCm_t, DMA_MLI0SRC2_ADDR); /* "MLI 0 Service Request Control Register 2" */
SFR_ABS (DMA_MLI0SRC3, DMA_MLInSRCm_t, DMA_MLI0SRC3_ADDR); /* "MLI 0 Service Request Control Register 3" */
SFR_ABS (DMA_MLI1SRC0, DMA_MLInSRCm_t, DMA_MLI1SRC0_ADDR); /* "MLI 1 Service Request Control Register 0" */
SFR_ABS (DMA_MLI1SRC1, DMA_MLInSRCm_t, DMA_MLI1SRC1_ADDR); /* "MLI 1 Service Request Control Register 1" */
SFR_ABS (DMA_OCDSR, DMA_OCDSR_t, DMA_OCDSR_ADDR); /* "OCDS Register" */
...
SFR_ABS (DMA_SHADR00, DMA_SHADRm_t, DMA_SHADR00_ADDR); /* "Channel 00 Shadowed Address Register" */
SFR_ABS (DMA_SHADR01, DMA_SHADRm_t, DMA_SHADR01_ADDR); /* "DMA Channel 01 Shadowed Address Register" */
SFR_ABS (DMA_SHADR02, DMA_SHADRm_t, DMA_SHADR02_ADDR); /* "DMA Channel 02 Shadowed Address Register" */
SFR_ABS (DMA_SHADR03, DMA_SHADRm_t, DMA_SHADR03_ADDR); /* "DMA Channel 03 Shadowed Address Register" */
SFR_ABS (DMA_SHADR04, DMA_SHADRm_t, DMA_SHADR04_ADDR); /* "DMA Channel 04 Shadowed Address Register" */
SFR_ABS (DMA_SHADR05, DMA_SHADRm_t, DMA_SHADR05_ADDR); /* "DMA Channel 05 Shadowed Address Register" */
SFR_ABS (DMA_SHADR06, DMA_SHADRm_t, DMA_SHADR06_ADDR); /* "DMA Channel 06 Shadowed Address Register" */
SFR_ABS (DMA_SHADR07, DMA_SHADRm_t, DMA_SHADR07_ADDR); /* "DMA Channel 07 Shadowed Address Register" */
...
SFR_ABS (DMA_STREQ, DMA_STREQ_t, DMA_STREQ_ADDR); /* "Software Transaction Request Register" */
SFR_ABS (DMA_SUSPMR, DMA_SUSPMR_t, DMA_SUSPMR_ADDR); /* "Suspend Mode Register" */
SFR_ABS (DMA_SYSSRC0, DMA_SYSSRCm_t, DMA_SYSSRC0_ADDR); /* "System Interrupt Service Request Control Register 0" */
SFR_ABS (DMA_SYSSRC1, DMA_SYSSRCm_t, DMA_SYSSRC1_ADDR); /* "System Interrupt Service Request Control Register 1" */
SFR_ABS (DMA_SYSSRC2, DMA_SYSSRCm_t, DMA_SYSSRC2_ADDR); /* "System Interrupt Service Request Control Register 2" */
SFR_ABS (DMA_SYSSRC3, DMA_SYSSRCm_t, DMA_SYSSRC3_ADDR); /* "System Interrupt Service Request Control Register 3" */
SFR_ABS (DMA_SYSSRC4, DMA_SYSSRCm_t, DMA_SYSSRC4_ADDR); /* "System Interrupt Service Request Control Register 4" */
SFR_ABS (DMA_TOCTR, DMA_TOCTR_t, DMA_TOCTR_ADDR); /* "DMA Bus Time-Out Control Register" */
SFR_ABS (DMA_TRSR, DMA_TRSR_t, DMA_TRSR_ADDR);    /* "Transaction Request State Register" */
SFR_ABS (DMA_WRPSR, DMA_WRPSR_t, DMA_WRPSR_ADDR); /* "Wrap Status Register" */
