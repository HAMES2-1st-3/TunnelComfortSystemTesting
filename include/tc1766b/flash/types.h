...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int TM:1;                /*  = [1..1] = 0x00000002 */
      unsigned int ECENCDIS:1;          /*  = [2..2] = 0x00000004 */
      unsigned int ECDECDIS:1;          /*  = [3..3] = 0x00000008 */
      unsigned int CONFSE:1;            /*  = [4..4] = 0x00000010 */
      unsigned int EPS:1;               /*  = [5..5] = 0x00000020 */
      unsigned int FSRAMEN:1;           /*  = [6..6] = 0x00000040 */
      unsigned int EEAS:1;              /*  = [7..7] = 0x00000080 */
      unsigned int WRFINIT:1;           /*  = [8..8] = 0x00000100 */
      unsigned int RSRAME:1;            /*  = [9..9] = 0x00000200 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH_CFTEST_t_nonv;

typedef volatile FLASH_CFTEST_t_nonv FLASH_CFTEST_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int ECC_RCode:8;         /*  = [0..7] = 0x000000ff */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH_ECCR_t_nonv;

typedef volatile FLASH_ECCR_t_nonv FLASH_ECCR_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int ECC_WCode:8;         /*  = [0..7] = 0x000000ff */
      unsigned int _bit8:1;             /* 0 = [8..8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH_ECCW_t_nonv;

typedef volatile FLASH_ECCW_t_nonv FLASH_ECCW_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int SLEEPFSD:1;          /*  = [15..15] = 0x00008000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int OVER:1;              /*  = [31..31] = 0x80000000 */
   } bits;
   unsigned long reg; 
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH_PROCON1_t_nonv;

typedef volatile FLASH_PROCON1_t_nonv FLASH_PROCON1_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int S10ROM:1;            /*  = [10..10] = 0x00000400 */
      unsigned int S11ROM:1;            /*  = [11..11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12..12] = 0x00001000 */
      unsigned int _bit13:1;            /* 0 = [13..13] = 0x00002000 */
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FLASH_PROCON2_t_nonv;

typedef volatile FLASH_PROCON2_t_nonv FLASH_PROCON2_t;
