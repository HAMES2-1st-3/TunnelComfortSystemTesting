...
#ifndef _HAVE_TRICORE_FADC_SHARETYPES_H_
#define _HAVE_TRICORE_FADC_SHARETYPES_H_
...
typedef union { /* 32 bits */
   struct {
      unsigned int GAIN:2;              /*  = [0..1] = 0x00000003 */
      unsigned int ENP:1;               /*  = [2..2] = 0x00000004 */
      unsigned int ENN:1;               /*  = [3..3] = 0x00000008 */
      ...
      unsigned int CALOFF_2_0:3;        /*  = [8..10] = 0x00000700 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int CALOFF3:1;           /*  = [12..12] = 0x00001000 */
      unsigned int CALGAIN:2;           /*  = [13..14] = 0x00006000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_ACRm_t_nonv;

typedef volatile FADC_ACRm_t_nonv FADC_ACRm_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int GSEL:3;              /*  = [0..2] = 0x00000007 */
      unsigned int TSEL:3;              /*  = [3..5] = 0x00000038 */
      unsigned int GM:2;                /*  = [6..7] = 0x000000c0 */
      unsigned int TM:2;                /*  = [8..9] = 0x00000300 */
      unsigned int CTM:2;               /*  = [10..11] = 0x00000c00 */
      unsigned int CTF:3;               /*  = [12..14] = 0x00007000 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
      unsigned int CTREL:8;             /*  = [16..23] = 0x00ff0000 */
      unsigned int _bit24:1;            /* 0 = [24..24] = 0x01000000 */
      unsigned int _bit25:1;            /* 0 = [25..25] = 0x02000000 */
      unsigned int _bit26:1;            /* 0 = [26..26] = 0x04000000 */
      unsigned int _bit27:1;            /* 0 = [27..27] = 0x08000000 */
      unsigned int INP:2;               /*  = [28..29] = 0x30000000 */
      unsigned int _bit30:1;            /* 0 = [30..30] = 0x40000000 */
      unsigned int IEN:1;               /*  = [31..31] = 0x80000000 */
   } bits;
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_CFGRm_t_nonv;

typedef volatile FADC_CFGRm_t_nonv FADC_CFGRm_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int CR:19;               /*  = [0..18] = 0x0007ffff */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
      unsigned int _bit20:1;            /* 0 = [20..20] = 0x00100000 */
      unsigned int _bit21:1;            /* 0 = [21..21] = 0x00200000 */
      unsigned int _bit22:1;            /* 0 = [22..22] = 0x00400000 */
      unsigned int _bit23:1;            /* 0 = [23..23] = 0x00800000 */
      unsigned int AC:3;                /*  = [24..26] = 0x07000000 */
      unsigned int _bit27:1;            /* 0 = [27..27] = 0x08000000 */
      unsigned int MAVS:2;              /*  = [28..29] = 0x30000000 */
      unsigned int _bit30:1;            /* 0 = [30..30] = 0x40000000 */
      unsigned int _bit31:1;            /* 0 = [31..31] = 0x80000000 */
   } bits;
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_CRRm_t_nonv;

typedef volatile FADC_CRRm_t_nonv FADC_CRRm_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int ADDL:3;              /*  = [0..2] = 0x00000007 */
      unsigned int _bit3:1;             /* 0 = [3..3] = 0x00000008 */
      unsigned int MAVL:2;              /*  = [4..5] = 0x00000030 */
      unsigned int _bit6:1;             /* 0 = [6..6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7..7] = 0x00000080 */
      unsigned int INSEL:3;             /*  = [8..10] = 0x00000700 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int INP:2;               /*  = [12..13] = 0x00003000 */
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
      unsigned int IEN:1;               /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_FCRm_t_nonv;

typedef volatile FADC_FCRm_t_nonv FADC_FCRm_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int FR:20;               /*  = [0..19] = 0x000fffff */
      unsigned int _bit20:1;            /* 0 = [20..20] = 0x00100000 */
      unsigned int _bit21:1;            /* 0 = [21..21] = 0x00200000 */
      unsigned int _bit22:1;            /* 0 = [22..22] = 0x00400000 */
      unsigned int _bit23:1;            /* 0 = [23..23] = 0x00800000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_FRRm_t_nonv;

typedef volatile FADC_FRRm_t_nonv FADC_FRRm_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int IR:18;               /*  = [0..17] = 0x0003ffff */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
      unsigned int _bit20:1;            /* 0 = [20..20] = 0x00100000 */
      unsigned int _bit21:1;            /* 0 = [21..21] = 0x00200000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_IRRm_t_nonv;

typedef volatile FADC_IRRm_t_nonv FADC_IRRm_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int ADRES:10;            /*  = [0..9] = 0x000003ff */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_RCHm_t_nonv;

typedef volatile FADC_RCHm_t_nonv FADC_RCHm_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_SFRRm_t_nonv;

typedef volatile FADC_SFRRm_t_nonv FADC_SFRRm_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) FADC_SRCm_t_nonv;

typedef volatile FADC_SRCm_t_nonv FADC_SRCm_t;


#endif /* _HAVE_TRICORE_FADC_SHARETYPES_H_ */
