...
#ifndef _TC1784_CAN_STRUCTS_H_
#define _TC1784_CAN_STRUCTS_H_
/*
   TriCore TC1784
   Some struct definitions for conveniance
*/

#include <tc1784/can.h>
#ifndef CAN_BASE
...
typedef struct
{
    ...
    unsigned int    reserved22[0x8];    /* 0x120 */
    CAN_MSPNDm_t    MSPND[0x8];         /* 0x140 */
    unsigned int    reserved24[0x8];    /* 0x160 */
    CAN_MSIDm_t     MSID[0x8];          /* 0x180 */
    unsigned int    reserved26[0x8];    /* 0x1a0 */
    CAN_MSIMASK_t   MSIMASK;            /* 0x1c0 */
    CAN_PANCTR_t    PANCTR;             /* 0x1c4 */
    CAN_MCR_t       MCR;                /* 0x1c8 */
    CAN_MITR_t      MITR;               /* 0x1cc */
    unsigned int    reserved31[0xc];    /* 0x1d0 */
    CAN_NODE_t      NODE[0x3];          /* 0x200 */
    unsigned int    reserved33[0x2c0];  /* 0x500 */
    CAN_MO_t        MO[0x40];           /* 0x1000 */
} CAN_t;

#endif /* _TC1784_CAN_STRUCTS_H_ */
