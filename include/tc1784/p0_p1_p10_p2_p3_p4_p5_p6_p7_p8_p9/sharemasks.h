...
#ifndef _HAVE_TRICORE_P0_P1_P10_P2_P3_P4_P5_P6_P7_P8_P9_SHAREMASKS_H_
#define _HAVE_TRICORE_P0_P1_P10_P2_P3_P4_P5_P6_P7_P8_P9_SHAREMASKS_H_


/****************** Masks for Pn_ESR_t **********************/
/*
   P0_ESR                "Port 0 Emergency Stop Register"
   P10_ESR               "Port 10 Emergency Stop Register"
   ...
   P7_ESR                "Port 7 Emergency Stop Register"
...
/*
   ...
   P10_IOCR8             "Port 10 Input/Output Control Register 8"
   ...
   P5_IOCR4              "Port n Input/Output Control Register 4"
   P5_IOCR8              "Port n Input/Output Control Register 8"
   P6_IOCR0              "Port 6 Input/Output Control Register 0"
   P7_IOCR0              "Port 7 Input/Output Control Register 0"
   P7_IOCR12             "Port 7 Input/Output Control Register 12"
   P7_IOCR4              "Port 7 Input/Output Control Register 4"
   P7_IOCR8              "Port 7 Input/Output Control Register 8"
...
/****************** Masks for Pn_PDR_t **********************/
/*
   P10_PDR               "Port 10 Pad Driver Mode Register"
   P7_PDR                "Port 7 Pad Driver Mode Register"
   P8_PDR                "Port 8 Pad Driver Mode Register"
*/
/**********************************************************/

#define Pn_PDR_MASK                     0x00007777
#define Pn_PDR_PD0_MASK                 0x00000007
#define Pn_PDR_PD0_SHIFT                0
#define Pn_PDR_PD1_MASK                 0x00000070
#define Pn_PDR_PD1_SHIFT                4
#define Pn_PDR_PD2_MASK                 0x00000700
#define Pn_PDR_PD2_SHIFT                8
#define Pn_PDR_PD3_MASK                 0x00007000
#define Pn_PDR_PD3_SHIFT                12




#endif /* _HAVE_TRICORE_P0_P1_P10_P2_P3_P4_P5_P6_P7_P8_P9_SHAREMASKS_H_ */
