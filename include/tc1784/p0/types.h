...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int PDERAYA:3;           /*  = [8..10] = 0x00000700 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int PDERAYB:3;           /*  = [12..14] = 0x00007000 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
      unsigned int PD2:3;               /*  = [16..18] = 0x00070000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P0_PDR_t_nonv;

typedef volatile P0_PDR_t_nonv P0_PDR_t;
