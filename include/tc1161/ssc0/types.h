...
#ifndef _HAVE_TRICORE_SSC0_TYPES_H_
#define _HAVE_TRICORE_SSC0_TYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_BR_t_nonv;

typedef volatile SSC0_BR_t_nonv SSC0_BR_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_CLC_t_nonv;

typedef volatile SSC0_CLC_t_nonv SSC0_CLC_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_CON_t_nonv;

typedef volatile SSC0_CON_t_nonv SSC0_CON_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_EFM_t_nonv;

typedef volatile SSC0_EFM_t_nonv SSC0_EFM_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_ESRC_t_nonv;

typedef volatile SSC0_ESRC_t_nonv SSC0_ESRC_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_FDR_t_nonv;

typedef volatile SSC0_FDR_t_nonv SSC0_FDR_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_ID_t_nonv;

typedef volatile SSC0_ID_t_nonv SSC0_ID_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_PISEL_t_nonv;

typedef volatile SSC0_PISEL_t_nonv SSC0_PISEL_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_RB_t_nonv;

typedef volatile SSC0_RB_t_nonv SSC0_RB_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_RSRC_t_nonv;

typedef volatile SSC0_RSRC_t_nonv SSC0_RSRC_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_SSOC_t_nonv;

typedef volatile SSC0_SSOC_t_nonv SSC0_SSOC_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_SSOTC_t_nonv;

typedef volatile SSC0_SSOTC_t_nonv SSC0_SSOTC_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_STAT_t_nonv;

typedef volatile SSC0_STAT_t_nonv SSC0_STAT_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_TB_t_nonv;

typedef volatile SSC0_TB_t_nonv SSC0_TB_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_TSRC_t_nonv;

typedef volatile SSC0_TSRC_t_nonv SSC0_TSRC_t;


#endif /* _HAVE_TRICORE_SSC0_TYPES_H_ */
