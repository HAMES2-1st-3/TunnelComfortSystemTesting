...
/* block "ADC0" of TriCore TC1797 (127 SFRs) */

#include <tc1797/adc0/addr.h>

#include <tc1797/adc0/masks.h>
#include <tc1797/adc0_adc1_adc2/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1797/adc0/types.h>
#include <tc1797/adc0_adc1_adc2/sharetypes.h>
...
SFR_NOABS (ADC0_RSIR1, ADCn_RSIRm_t, ADC0_RSIR1_ADDR); /* "Request Source 0 Input Register" */
SFR_NOABS (ADC0_RSIR2, ADCn_RSIRm_t, ADC0_RSIR2_ADDR); /* "Request Source 0 Input Register" */
SFR_NOABS (ADC0_RSIR3, ADCn_RSIRm_t, ADC0_RSIR3_ADDR); /* "Request Source 0 Input Register" */
SFR_NOABS (ADC0_RSIR4, ADCn_RSIRm_t, ADC0_RSIR4_ADDR); /* "Request Source 0 Input Register" */
...
SFR_NOABS (ADC0_SRC6, ADC0_SRCm_t, ADC0_SRC6_ADDR); /* "ADC Service Request Control Register 6" */
SFR_NOABS (ADC0_SRC7, ADC0_SRCm_t, ADC0_SRC7_ADDR); /* "ADC Service Request Control Register 7" */
SFR_NOABS (ADC0_SRC8, ADC0_SRCm_t, ADC0_SRC8_ADDR); /* "ADC Service Request Control Register 8" */
