...
/* block "SCU" of TriCore TC1797 (54 SFRs) */

#include <tc1797/scu/addr.h>

#include <tc1797/scu/masks.h>
#include <tc1797/scu/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1797/scu/types.h>
#include <tc1797/scu/sharetypes.h>
...
SFR_ABS (SCU_ESRCFG2, SCU_ESRCFGm_t, SCU_ESRCFG2_ADDR); /* "ESR2 Configuration Register" */
...
SFR_ABS (SCU_IGCR0, SCU_IGCRm_t, SCU_IGCR0_ADDR); /* "Interrupt Gating Register 0" */
SFR_ABS (SCU_IGCR1, SCU_IGCRm_t, SCU_IGCR1_ADDR); /* "Interrupt Gating Register 1" */
...
SFR_ABS (SCU_PETSR, SCU_PETSR_t, SCU_PETSR_ADDR); /* "Parity Error Trap Status Register" */
...
SFR_ABS (SCU_PLLERAYCTR, SCU_PLLERAYCTR_t, SCU_PLLERAYCTR_ADDR); /* "PLL_ERAY Control and Status Register" */
