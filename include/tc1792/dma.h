...
/* block "DMA" of TriCore TC1792 (155 SFRs) */

#include <tc1792/dma/addr.h>

#include <tc1792/dma/masks.h>
#include <tc1792/dma/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1792/dma/types.h>
#include <tc1792/dma/sharetypes.h>
...
SFR_ABS (DMA_ME0AENR, DMA_MEmAENR_t, DMA_ME0AENR_ADDR); /* "DMA Move Engine 0 Access Enable Register" */
SFR_ABS (DMA_ME0ARR, DMA_MEmARR_t, DMA_ME0ARR_ADDR); /* "DMA Move Engine 0 Access Range Register" */
...
SFR_ABS (DMA_ME1AENR, DMA_MEmAENR_t, DMA_ME1AENR_ADDR); /* "DMA Move Engine 1 Access Enable Register" */
SFR_ABS (DMA_ME1ARR, DMA_MEmARR_t, DMA_ME1ARR_ADDR); /* "DMA Move Engine 1 Access Range Register" */
SFR_ABS (DMA_ME1PR, DMA_MEmPR_t, DMA_ME1PR_ADDR); /* "DMA Move Engine 1 Pattern Register" */
...
SFR_ABS (DMA_SYSSRC0, DMA_SYSSRCm_t, DMA_SYSSRC0_ADDR); /* "DMA System Interrupt Service Request Control Register 0" */
SFR_ABS (DMA_SYSSRC1, DMA_SYSSRCm_t, DMA_SYSSRC1_ADDR); /* "DMA System Interrupt Service Request Control Register 1" */
SFR_ABS (DMA_SYSSRC2, DMA_SYSSRCm_t, DMA_SYSSRC2_ADDR); /* "DMA System Interrupt Service Request Control Register 2" */
SFR_ABS (DMA_SYSSRC3, DMA_SYSSRCm_t, DMA_SYSSRC3_ADDR); /* "DMA System Interrupt Service Request Control Register 3" */
SFR_ABS (DMA_SYSSRC4, DMA_SYSSRCm_t, DMA_SYSSRC4_ADDR); /* "DMA System Interrupt Service Request Control Register 4" */
