...
/*
   FADC_ACR0             "FADC Channel 0 Analog Control Register"
   FADC_ACR1             "FADC Channel 1 Analog Control Register"
   FADC_ACR2             "FADC Channel 2 Analog Control Register"
   FADC_ACR3             "FADC Channel 3 Analog Control Register"
*/
/**********************************************************/
...
#define FADC_ACRm_CALGAIN_MASK          0x00006000
#define FADC_ACRm_CALGAIN_SHIFT         13



/****************** Masks for FADC_CFGRm_t **********************/
/*
   FADC_CFGR0            "FADC Channel 0 Configuration Register"
   FADC_CFGR1            "FADC Channel 1 Configuration Register"
   FADC_CFGR2            "FADC Channel 2 Configuration Register"
   FADC_CFGR3            "FADC Channel 3 Configuration Register"
*/
/**********************************************************/
...
/*
   FADC_FCR0             "FADC Filter 0 Control Register"
   FADC_FCR1             "FADC Filter 1 Control Register"
*/
/**********************************************************/
...
/*
   FADC_IRR10            "FADC Filter 0 Intermediate Result Register 1"
   FADC_IRR20            "FADC Filter 0 Intermediate Result Register 2"
   FADC_IRR30            "FADC Filter 0 Intermediate Result Register 3"
*/
/**********************************************************/
...
/*
   FADC_RCH0             "FADC Channel 0 Conversion Result Register"
   FADC_RCH1             "FADC Channel 1 Conversion Result Register"
   FADC_RCH2             "FADC Channel 2 Conversion Result Register"
   FADC_RCH3             "FADC Channel 3 Conversion Result Register"
*/
/**********************************************************/
...
/*
   ...
   FADC_SRC2             "FADC Service Request Control Register 2"
   FADC_SRC3             "FADC Service Request Control Register 3"
*/
/**********************************************************/
