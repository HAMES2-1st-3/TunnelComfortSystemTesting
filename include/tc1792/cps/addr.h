...
/* block "CPS" of TriCore TC1792 (6 SFRs) */

#ifndef _HAVE_TRICORE_CPS_ADDRESSES_H_
#define _HAVE_TRICORE_CPS_ADDRESSES_H_

#define CPS_ID_ADDR           0xF7E0FF08     /* "CPS Module Identification Register" */
#define CPU_SBSRC0_ADDR       0xF7E0FFBC     /* "CPU Software Break Service Request Control Register" */
...
#endif /* _HAVE_TRICORE_CPS_ADDRESSES_H_ (block "CPS") */
