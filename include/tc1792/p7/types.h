...
#ifndef _HAVE_TRICORE_P7_TYPES_H_
#define _HAVE_TRICORE_P7_TYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P7_OMR_t_nonv;

typedef volatile P7_OMR_t_nonv P7_OMR_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P7_PDR_t_nonv;

typedef volatile P7_PDR_t_nonv P7_PDR_t;


#endif /* _HAVE_TRICORE_P7_TYPES_H_ */
