...
#ifndef _HAVE_TRICORE_DMU_TYPES_H_
#define _HAVE_TRICORE_DMU_TYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) DMU_ID_t_nonv;

typedef volatile DMU_ID_t_nonv DMU_ID_t;
...
typedef union { /* 32 bits */
   struct {
      unsigned int STBLOCK:1;           /*  = [0..0] = 0x00000001 */
      unsigned int STBULK:3;            /*  = [1..3] = 0x0000000e */
      unsigned int STBSLK:4;            /*  = [4..7] = 0x000000f0 */
      unsigned int _bit8:1;             /* 0 = [8..8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) DMU_SBRCTR_t_nonv;

typedef volatile DMU_SBRCTR_t_nonv DMU_SBRCTR_t;


#endif /* _HAVE_TRICORE_DMU_TYPES_H_ */
