...
typedef union { /* 32 bits */
   struct { /* LMB Error Detection Register [Address Error] */
   ...
   struct { /* LMB Error Detection Register [Response Error] */
...
typedef union { /* 32 bits */
   struct {
      unsigned int DMAH:1;              /*  = [0..0] = 0x00000001 */
      unsigned int ONES:2;              /*  = [1..2] = 0x00000006 */
      unsigned int PCP:1;               /*  = [3..3] = 0x00000008 */
      unsigned int DMAM:1;              /*  = [4..4] = 0x00000010 */
      unsigned int LFI:1;               /*  = [5..5] = 0x00000020 */
      unsigned int DMAL:1;              /*  = [6..6] = 0x00000040 */
      unsigned int ONE:9;               /*  = [7..15] = 0x0000ff80 */
