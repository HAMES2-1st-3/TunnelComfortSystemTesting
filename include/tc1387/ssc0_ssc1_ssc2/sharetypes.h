...
#ifndef _HAVE_TRICORE_SSC0_SSC1_SSC2_SHARETYPES_H_
#define _HAVE_TRICORE_SSC0_SSC1_SSC2_SHARETYPES_H_
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int PARTEN:1;            /*  = [16..16] = 0x00010000 */
      unsigned int PARREN:1;            /*  = [17..17] = 0x00020000 */
      unsigned int PARTYP:1;            /*  = [18..18] = 0x00040000 */
      unsigned int PAREEN:1;            /*  = [19..19] = 0x00080000 */
      unsigned int _bit20:1;            /* 0 = [20..20] = 0x00100000 */
      unsigned int _bit21:1;            /* 0 = [21..21] = 0x00200000 */
      unsigned int _bit22:1;            /* 0 = [22..22] = 0x00400000 */
      unsigned int _bit23:1;            /* 0 = [23..23] = 0x00800000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit12:1;            /* 0 = [12..12] = 0x00001000 */
      unsigned int _bit13:1;            /* 0 = [13..13] = 0x00002000 */
      unsigned int QSMEN:1;             /*  = [14..14] = 0x00004000 */
      unsigned int EN:1;                /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int PARE:1;              /*  = [4..4] = 0x00000010 */
      unsigned int PARTVAL:1;           /*  = [5..5] = 0x00000020 */
      unsigned int PARRVAL:1;           /*  = [6..6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7..7] = 0x00000080 */
...
#endif /* _HAVE_TRICORE_SSC0_SSC1_SSC2_SHARETYPES_H_ */
