...
#ifndef _HAVE_TRICORE_CCU60_CCU61_CCU62_CCU63_SHARETYPES_H_
#define _HAVE_TRICORE_CCU60_CCU61_CCU62_CCU63_SHARETYPES_H_
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int MCC63S:1;            /*  = [7..7] = 0x00000080 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int CCPOS60:1;           /*  = [3..3] = 0x00000008 */
      unsigned int CCPOS61:1;           /*  = [4..4] = 0x00000010 */
      unsigned int CCPOS62:1;           /*  = [5..5] = 0x00000020 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int LBE:1;               /*  = [0..0] = 0x00000001 */
      unsigned int CCPOS0I:1;           /*  = [1..1] = 0x00000002 */
      unsigned int CCPOS1I:1;           /*  = [2..2] = 0x00000004 */
      unsigned int CCPOS2I:1;           /*  = [3..3] = 0x00000008 */
      unsigned int CC60INI:1;           /*  = [4..4] = 0x00000010 */
      unsigned int CC61INI:1;           /*  = [5..5] = 0x00000020 */
      unsigned int CC62INI:1;           /*  = [6..6] = 0x00000040 */
      unsigned int CTRAPI:1;            /*  = [7..7] = 0x00000080 */
      unsigned int T12HRI:1;            /*  = [8..8] = 0x00000100 */
      unsigned int T13HRI:1;            /*  = [9..9] = 0x00000200 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int MODEN:1;             /*  = [0..0] = 0x00000001 */
      unsigned int BPMODEN:1;           /*  = [1..1] = 0x00000002 */
      unsigned int ACK:1;               /*  = [2..2] = 0x00000004 */
      unsigned int SUSREQ:1;            /*  = [3..3] = 0x00000008 */
      unsigned int NOMCFG:2;            /*  = [4..5] = 0x00000030 */
      unsigned int _bit6:1;             /* 0 = [6..6] = 0x00000040 */
      unsigned int BPNOM:1;             /*  = [7..7] = 0x00000080 */
      unsigned int SUMCFG:2;            /*  = [8..9] = 0x00000300 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int BPSUM:1;             /*  = [11..11] = 0x00000800 */
      unsigned int COMCFG:2;            /*  = [12..13] = 0x00003000 */
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
      unsigned int BPCOM:1;             /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int SB0:1;               /*  = [0..0] = 0x00000001 */
      unsigned int SB1:1;               /*  = [1..1] = 0x00000002 */
      unsigned int SB2:1;               /*  = [2..2] = 0x00000004 */
      unsigned int SB3:1;               /*  = [3..3] = 0x00000008 */
      unsigned int _bit4:1;             /* 0 = [4..4] = 0x00000010 */
      unsigned int _bit5:1;             /* 0 = [5..5] = 0x00000020 */
      unsigned int _bit6:1;             /* 0 = [6..6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7..7] = 0x00000080 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int CCPOS0EN:1;          /*  = [1..1] = 0x00000002 */
      unsigned int CCPOS1EN:1;          /*  = [2..2] = 0x00000004 */
      unsigned int CCPOS2EN:1;          /*  = [3..3] = 0x00000008 */
      unsigned int CC60INEN:1;          /*  = [4..4] = 0x00000010 */
      unsigned int CC61INEN:1;          /*  = [5..5] = 0x00000020 */
      unsigned int CC62INEN:1;          /*  = [6..6] = 0x00000040 */
      unsigned int CTRAPEN:1;           /*  = [7..7] = 0x00000080 */
      unsigned int T12HREN:1;           /*  = [8..8] = 0x00000100 */
      unsigned int T13HREN:1;           /*  = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12..12] = 0x00001000 */
      unsigned int LBEEN:1;             /*  = [13..13] = 0x00002000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int T12:1;               /*  = [0..0] = 0x00000001 */
      unsigned int T13:1;               /*  = [1..1] = 0x00000002 */
      unsigned int MCM:1;               /*  = [2..2] = 0x00000004 */
      unsigned int _bit3:1;             /* 0 = [3..3] = 0x00000008 */
      unsigned int _bit4:1;             /* 0 = [4..4] = 0x00000010 */
      unsigned int _bit5:1;             /* 0 = [5..5] = 0x00000020 */
      unsigned int _bit6:1;             /* 0 = [6..6] = 0x00000040 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit6:1;             /* 0 = [6..6] = 0x00000040 */
      unsigned int _bit7:1;             /* 0 = [7..7] = 0x00000080 */
      unsigned int STE12U:1;            /*  = [8..8] = 0x00000100 */
      unsigned int STE12D:1;            /*  = [9..9] = 0x00000200 */
      unsigned int STE13U:1;            /*  = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12..12] = 0x00001000 */
      unsigned int _bit13:1;            /* 0 = [13..13] = 0x00002000 */
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int TRIG0SEL:3;          /*  = [0..2] = 0x00000007 */
      unsigned int TRIG1SEL:3;          /*  = [3..5] = 0x00000038 */
      unsigned int TRIG2SEL:3;          /*  = [6..8] = 0x000001c0 */
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12..12] = 0x00001000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) CCUn_MOSEL_t_nonv;

typedef volatile CCUn_MOSEL_t_nonv CCUn_MOSEL_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int T12EXT:1;            /*  = [6..6] = 0x00000040 */
      unsigned int T13EXT:1;            /*  = [7..7] = 0x00000080 */
      unsigned int _bit8:1;             /* 0 = [8..8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit4:1;             /* 0 = [4..4] = 0x00000010 */
      unsigned int T12CNT:1;            /*  = [5..5] = 0x00000020 */
      ...
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12..12] = 0x00001000 */
      unsigned int T13CNT:1;            /*  = [13..13] = 0x00002000 */
...
#endif /* _HAVE_TRICORE_CCU60_CCU61_CCU62_CCU63_SHARETYPES_H_ */
