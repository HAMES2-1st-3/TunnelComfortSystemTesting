...
#ifndef _TC1387_CAN_STRUCTS_H_
#define _TC1387_CAN_STRUCTS_H_
/*
   TriCore TC1387
   Some struct definitions for conveniance
*/

#include <tc1387/can.h>
#ifndef CAN_BASE
...
#ifndef _CAN_MO127_T_
#define _CAN_MO127_T_
typedef struct 
{
    CAN_MOFCRm_t    FCR;                /* 0x0 */    
    CAN_MOFGPRm_t   FGPR;               /* 0x4 */    
...
typedef struct
{
    ...
    CAN_MO_t        MO[0x7f];           /* 0x1000 */
    CAN_MO127_t     MO127;              /* 0x1fe0 */
    unsigned int    reserved84[0x800];  /* 0x1ffc */
    CAN_STPTR0_t    STPTR0;             /* 0x3ffc */
} CAN_t;

#endif /* _TC1387_CAN_STRUCTS_H_ */
