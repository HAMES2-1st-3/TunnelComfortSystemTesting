...
typedef union { /* 32 bits */
   struct {
      unsigned int IST2IN:1;            /*  = [0..0] = 0x00000001 */
      unsigned int IST2EUD:1;           /*  = [1..1] = 0x00000002 */
      ...
      unsigned int IST5IN:1;            /*  = [10..10] = 0x00000400 */
      unsigned int IST5EUD:1;           /*  = [11..11] = 0x00000800 */
      unsigned int IST6IN:1;            /*  = [12..12] = 0x00001000 */
      unsigned int IST6EUD:1;           /*  = [13..13] = 0x00002000 */
...
/********************** GPTn_T2CON_t *************************/
/*
   GPT120_T2CON          "Timer 2 Control Register"
   GPT121_T2CON          "Timer 2 Control Register"
*/
/**********************************************************/
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int T2R:1;               /*  = [6..6] = 0x00000040 */
      unsigned int T2UD:1;              /*  = [7..7] = 0x00000080 */
      unsigned int T2UDE:1;             /*  = [8..8] = 0x00000100 */
      unsigned int T2RC:1;              /*  = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int T2IRDIS:1;           /*  = [12..12] = 0x00001000 */
      unsigned int T2EDGE:1;            /*  = [13..13] = 0x00002000 */
      unsigned int T2CHDIR:1;           /*  = [14..14] = 0x00004000 */
      unsigned int T2RDIR:1;            /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
...
/********************** GPTn_T3CON_t *************************/
/*
   GPT120_T3CON          "Timer 3 Control Register"
   GPT121_T3CON          "Timer 3 Control Register"
*/
/**********************************************************/
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int T3R:1;               /*  = [6..6] = 0x00000040 */
      unsigned int T3UD:1;              /*  = [7..7] = 0x00000080 */
      unsigned int T3UDE:1;             /*  = [8..8] = 0x00000100 */
      unsigned int T3OE:1;              /*  = [9..9] = 0x00000200 */
      unsigned int T3OTL:1;             /*  = [10..10] = 0x00000400 */
      unsigned int BPS1:2;              /*  = [11..12] = 0x00001800 */
      unsigned int T3EDGE:1;            /*  = [13..13] = 0x00002000 */
      unsigned int T3CHDIR:1;           /*  = [14..14] = 0x00004000 */
      unsigned int T3RDIR:1;            /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
...
/********************** GPTn_T4CON_t *************************/
/*
   GPT120_T4CON          "Timer 4 Control Register"
   GPT121_T4CON          "Timer 4 Control Register"
*/
/**********************************************************/
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int T4R:1;               /*  = [6..6] = 0x00000040 */
      unsigned int T4UD:1;              /*  = [7..7] = 0x00000080 */
      unsigned int T4UDE:1;             /*  = [8..8] = 0x00000100 */
      unsigned int T4RC:1;              /*  = [9..9] = 0x00000200 */
      unsigned int CLRT2EN:1;           /*  = [10..10] = 0x00000400 */
      unsigned int CLRT3EN:1;           /*  = [11..11] = 0x00000800 */
      unsigned int T4IRDIS:1;           /*  = [12..12] = 0x00001000 */
      unsigned int T4EDGE:1;            /*  = [13..13] = 0x00002000 */
      unsigned int T4CHDIR:1;           /*  = [14..14] = 0x00004000 */
      unsigned int T4RDIR:1;            /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
...
/********************** GPTn_T5CON_t *************************/
/*
   GPT120_T5CON          "Timer 5 Control Register"
   GPT121_T5CON          "Timer 5 Control Register"
*/
/**********************************************************/
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int T5M:2;               /*  = [3..4] = 0x00000018 */
      unsigned int _bit5:1;             /* 0 = [5..5] = 0x00000020 */
      unsigned int T5R:1;               /*  = [6..6] = 0x00000040 */
      unsigned int T5UD:1;              /*  = [7..7] = 0x00000080 */
      unsigned int T5UDE:1;             /*  = [8..8] = 0x00000100 */
      unsigned int T5RC:1;              /*  = [9..9] = 0x00000200 */
      unsigned int CT3:1;               /*  = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
      unsigned int CI:2;                /*  = [12..13] = 0x00003000 */
      unsigned int T5CLR:1;             /*  = [14..14] = 0x00004000 */
      unsigned int T5SC:1;              /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
...
/********************** GPTn_T6CON_t *************************/
/*
   GPT120_T6CON          "Timer 6 Control Register"
   GPT121_T6CON          "Timer 6 Control Register"
*/
/**********************************************************/
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int T6R:1;               /*  = [6..6] = 0x00000040 */
      unsigned int T6UD:1;              /*  = [7..7] = 0x00000080 */
      unsigned int T6UDE:1;             /*  = [8..8] = 0x00000100 */
      unsigned int T6OE:1;              /*  = [9..9] = 0x00000200 */
      unsigned int T6OTL:1;             /*  = [10..10] = 0x00000400 */
      unsigned int BPS2:2;              /*  = [11..12] = 0x00001800 */
      unsigned int _bit13:1;            /* 0 = [13..13] = 0x00002000 */
      unsigned int T6CLR:1;             /*  = [14..14] = 0x00004000 */
      unsigned int T6SR:1;              /*  = [15..15] = 0x00008000 */
      unsigned int _bit16:1;            /* 0 = [16..16] = 0x00010000 */
      unsigned int _bit17:1;            /* 0 = [17..17] = 0x00020000 */
      unsigned int _bit18:1;            /* 0 = [18..18] = 0x00040000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
...
/********************** GPTn_Tm_t *************************/
/*
   GPT120_T2             "Timer 2 Register"
   GPT120_T3             "Timer 3 Register"
   GPT120_T4             "Timer 4 Register"
   GPT120_T5             "Timer 5 Register"
   GPT120_T6             "Timer 6 Register"
   GPT121_T2             "Timer 2 Register"
   GPT121_T3             "Timer 3 Register"
   GPT121_T4             "Timer 4 Register"
   GPT121_T5             "Timer 5 Register"
   GPT121_T6             "Timer 6 Register"
*/
/**********************************************************/
