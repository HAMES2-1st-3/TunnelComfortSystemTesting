...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
      unsigned int PD00:1;              /*  = [16..16] = 0x00010000 */
      unsigned int PD01:1;              /*  = [17..17] = 0x00020000 */
      unsigned int PD02:1;              /*  = [18..18] = 0x00040000 */
      unsigned int PD03:1;              /*  = [19..19] = 0x00080000 */
      unsigned int PD04:1;              /*  = [20..20] = 0x00100000 */
      unsigned int PD05:1;              /*  = [21..21] = 0x00200000 */
      unsigned int PD06:1;              /*  = [22..22] = 0x00400000 */
      unsigned int PD07:1;              /*  = [23..23] = 0x00800000 */
      unsigned int _bit24:1;            /* 0 = [24..24] = 0x01000000 */
      unsigned int _bit25:1;            /* 0 = [25..25] = 0x02000000 */
      unsigned int _bit26:1;            /* 0 = [26..26] = 0x04000000 */
      unsigned int _bit27:1;            /* 0 = [27..27] = 0x08000000 */
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) DMA_SYSSRC4_t_nonv;

typedef volatile DMA_SYSSRC4_t_nonv DMA_SYSSRC4_t;
