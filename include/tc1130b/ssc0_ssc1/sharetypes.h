...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSCn_FSTAT_t_nonv;

typedef volatile SSCn_FSTAT_t_nonv SSCn_FSTAT_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSCn_RXFCON_t_nonv;

typedef volatile SSCn_RXFCON_t_nonv SSCn_RXFCON_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSCn_TXFCON_t_nonv;

typedef volatile SSCn_TXFCON_t_nonv SSCn_TXFCON_t;
