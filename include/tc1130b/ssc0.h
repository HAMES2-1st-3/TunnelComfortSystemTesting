...
#include <tc1130b/ssc0/addr.h>

#include <tc1130b/ssc0/masks.h>
#include <tc1130b/ssc0_ssc1/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1130b/ssc0/types.h>
...
SFR_NOABS (SSC0_FSTAT, SSCn_FSTAT_t, SSC0_FSTAT_ADDR); /* "SSC FIFO Status Register" */
...
SFR_NOABS (SSC0_RXFCON, SSCn_RXFCON_t, SSC0_RXFCON_ADDR); /* "SSC Receive FIFO Control Register" */
...
SFR_NOABS (SSC0_TXFCON, SSCn_TXFCON_t, SSC0_TXFCON_ADDR); /* "SSC Transmit FIFO Control Register" */


#endif /* /NO_TRICORE_SFRTYPEDEFS */
#endif /* _HAVE_TRICORE_SSC0_H_ (block "SSC00") */
