...
typedef union { /* 32 bits */
   struct {
      unsigned int DCXPTR_3_0:4;        /*  = [0..3] = 0x0000000f */
      unsigned int DCXPTR_9_4:6;        /*  = [4..9] = 0x000003f0 */
      unsigned int DCXPTR_15_10:6;      /*  = [10..15] = 0x0000fc00 */
      unsigned int DCXPTR_31_16:16;     /*  = [16..31] = 0xffff0000 */
   } bits;
   unsigned long reg; 
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int DMSADR:31;           /*  = [1..31] = 0xfffffffe */
   } bits;
   unsigned long reg; 
