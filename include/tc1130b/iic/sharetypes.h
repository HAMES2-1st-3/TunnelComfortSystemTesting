...
#ifndef _HAVE_TRICORE_IIC_SHARETYPES_H_
#define _HAVE_TRICORE_IIC_SHARETYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) IIC_XPmSRC_t_nonv;

typedef volatile IIC_XPmSRC_t_nonv IIC_XPmSRC_t;


#endif /* _HAVE_TRICORE_IIC_SHARETYPES_H_ */
