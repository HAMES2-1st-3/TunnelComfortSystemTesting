...
#ifndef _HAVE_TRICORE_GPTU_SHARETYPES_H_
#define _HAVE_TRICORE_GPTU_SHARETYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) GPTU_SRCm_t_nonv;

typedef volatile GPTU_SRCm_t_nonv GPTU_SRCm_t;


#endif /* _HAVE_TRICORE_GPTU_SHARETYPES_H_ */
