...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int EXTRECON:1;          /*  = [1..1] = 0x00000002 */
      unsigned int EXTSVM:1;            /*  = [2..2] = 0x00000004 */
      unsigned int EXTACC:1;            /*  = [3..3] = 0x00000008 */
      ...
      unsigned int GLOBALCS:8;          /*  = [16..23] = 0x00ff0000 */
      unsigned int BUSCLK:2;            /*  = [24..25] = 0x03000000 */
      unsigned int SDCMSEL:1;           /*  = [26..26] = 0x04000000 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int OVERLAY:8;           /*  = [0..7] = 0x000000ff */
      unsigned int _bit8:1;             /* 0 = [8..8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int _bit10:1;            /* 0 = [10..10] = 0x00000400 */
      unsigned int _bit11:1;            /* 0 = [11..11] = 0x00000800 */
