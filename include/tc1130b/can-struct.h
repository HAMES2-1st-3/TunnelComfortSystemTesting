...
#ifndef _TC1130B_CAN_STRUCTS_H_
#define _TC1130B_CAN_STRUCTS_H_
/*
   TriCore TC1130B
   Some struct definitions for conveniance
*/

#include <tc1130b/can.h>
#ifndef CAN_BASE
...
typedef struct
{
    ...
    unsigned int    reserved6[0xf];     /* 0x84 */
