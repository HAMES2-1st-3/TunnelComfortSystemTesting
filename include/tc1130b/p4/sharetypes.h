...
#ifndef _HAVE_TRICORE_P4_SHARETYPES_H_
#define _HAVE_TRICORE_P4_SHARETYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P4_ALTSELm_t_nonv;

typedef volatile P4_ALTSELm_t_nonv P4_ALTSELm_t;


#endif /* _HAVE_TRICORE_P4_SHARETYPES_H_ */
