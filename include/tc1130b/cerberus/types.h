...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit1:1;             /* 0 = [1..1] = 0x00000002 */
      unsigned int BSBM:1;              /*  = [2..2] = 0x00000004 */
      unsigned int BSM1:1;              /*  = [3..3] = 0x00000008 */
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit1:1;             /* 0 = [1..1] = 0x00000002 */
      unsigned int BSSBM:1;             /*  = [2..2] = 0x00000004 */
      unsigned int BSSM1:1;             /*  = [3..3] = 0x00000008 */
      unsigned int _bit4:1;             /* 0 = [4..4] = 0x00000010 */
      ...
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int BSCBM:1;             /*  = [10..10] = 0x00000400 */
      unsigned int BSCM1:1;             /*  = [11..11] = 0x00000800 */
      unsigned int _bit12:1;            /* 0 = [12..12] = 0x00001000 */
