...
#include <tc1130b/ssc1/addr.h>

#include <tc1130b/ssc1/masks.h>
#include <tc1130b/ssc0_ssc1/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1130b/ssc1/types.h>
#include <tc1130b/ssc0_ssc1/sharetypes.h>
...
SFR_NOABS (SSC1_FSTAT, SSCn_FSTAT_t, SSC1_FSTAT_ADDR); /* "SSC FIFO Status Register" */
SFR_NOABS (SSC1_ID, SSCn_ID_t, SSC1_ID_ADDR);     /* "SSC0 Module Identification Register" */
...
SFR_NOABS (SSC1_RXFCON, SSCn_RXFCON_t, SSC1_RXFCON_ADDR); /* "SSC Receive FIFO Control Register" */
...
SFR_NOABS (SSC1_TXFCON, SSCn_TXFCON_t, SSC1_TXFCON_ADDR); /* "SSC Transmit FIFO Control Register" */


#endif /* /NO_TRICORE_SFRTYPEDEFS */
#endif /* _HAVE_TRICORE_SSC1_H_ (block "SSC01") */
