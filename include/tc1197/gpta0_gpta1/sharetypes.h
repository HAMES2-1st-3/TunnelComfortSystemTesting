...
typedef union { /* 32 bits */
   ...
   struct { /* GPTA0 Global Timer Cell Control Register 00 [Compare Mode] */
      ...
      unsigned int OSM:1;               /*  = [2..2] = 0x00000004 */
      unsigned int REN:1;               /*  = [3..3] = 0x00000008 */
      unsigned int GES:1;               /*  = [4..4] = 0x00000010 */
      unsigned int CAC:1;               /*  = [5..5] = 0x00000020 */
      unsigned int CAT:1;               /*  = [6..6] = 0x00000040 */
      unsigned int BYP:1;               /*  = [7..7] = 0x00000080 */
      unsigned int EOA:1;               /*  = [8..8] = 0x00000100 */
      unsigned int _bit9:1;             /* 0 = [9..9] = 0x00000200 */
      unsigned int CEN:1;               /*  = [10..10] = 0x00000400 */
...
typedef union { /* 32 bits */
   ...
   struct { /* GPTA0 Local Timer Cell Control Register 00 [Timer Mode] */
      unsigned int MOD:2;               /*  = [0..1] = 0x00000003 */
      unsigned int OSM:1;               /*  = [2..2] = 0x00000004 */
      unsigned int REN:1;               /*  = [3..3] = 0x00000008 */
      unsigned int RED:1;               /*  = [4..4] = 0x00000010 */
...
typedef union { /* 32 bits */
   struct {
      unsigned int GTC0:1;              /*  = [0..0] = 0x00000001 */
      unsigned int GTC1:1;              /*  = [1..1] = 0x00000002 */
      unsigned int GTC2:1;              /*  = [2..2] = 0x00000004 */
      unsigned int GTC3:1;              /*  = [3..3] = 0x00000008 */
      unsigned int GTC4:1;              /*  = [4..4] = 0x00000010 */
      unsigned int GTC5:1;              /*  = [5..5] = 0x00000020 */
      unsigned int GTC6:1;              /*  = [6..6] = 0x00000040 */
      unsigned int GTC7:1;              /*  = [7..7] = 0x00000080 */
      unsigned int GTC8:1;              /*  = [8..8] = 0x00000100 */
      unsigned int GTC9:1;              /*  = [9..9] = 0x00000200 */
