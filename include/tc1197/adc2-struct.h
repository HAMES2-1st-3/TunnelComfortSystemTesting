...
#ifndef _TC1197_ADC2_STRUCTS_H_
#define _TC1197_ADC2_STRUCTS_H_
/*
   TriCore TC1197
   Some struct definitions for conveniance
*/

#include <tc1197/adc2.h>
#ifndef ADC2_BASE
#define ADC2_BASE 0xf0101800
#endif /* ADC2_BASE */
...
typedef struct
{
    ...
    unsigned int    reserved6[0x3];     /* 0x24 */
    ...
    unsigned int    reserved91[0x1];    /* 0x214 */
    ADCn_APR_t      APR;                /* 0x218 */
    unsigned int    reserved93[0x1];    /* 0x21c */
    ADCn_EMCTR_t    EMCTR;              /* 0x220 */
} ADC2_t;

#endif /* _TC1197_ADC2_STRUCTS_H_ */
