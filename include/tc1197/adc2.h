...
/* block "ADC2" of TriCore TC1197 (116 SFRs) */

#include <tc1197/adc2/addr.h>

#include <tc1197/adc2/masks.h>
#include <tc1197/adc0_adc1_adc2/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1197/adc2/types.h>
...
SFR_NOABS (ADC2_RSIR1, ADCn_RSIRm_t, ADC2_RSIR1_ADDR); /* "Request Source 0 Input Register" */
SFR_NOABS (ADC2_RSIR2, ADCn_RSIRm_t, ADC2_RSIR2_ADDR); /* "Request Source 0 Input Register" */
SFR_NOABS (ADC2_RSIR3, ADCn_RSIRm_t, ADC2_RSIR3_ADDR); /* "Request Source 0 Input Register" */
SFR_NOABS (ADC2_RSIR4, ADCn_RSIRm_t, ADC2_RSIR4_ADDR); /* "Request Source 0 Input Register" */
