...
typedef struct
{
    unsigned int RG00: 1;                   /** \brief [0:0] Register Group x, Channels 0 - 3 (rw) */
    unsigned int RG01: 1;                   /** \brief [1:1] Register Group x, Channels 0 - 3 (rw) */
    unsigned int RG02: 1;                   /** \brief [2:2] Register Group x, Channels 0 - 3 (rw) */
    unsigned int RG03: 1;                   /** \brief [3:3] Register Group x, Channels 0 - 3 (rw) */
    unsigned int RG04: 1;                   /** \brief [4:4] Register Group x, Channels 0 - 3 (rw) */
    ...
    unsigned int RG40: 1;                   /** \brief [16:16] Register Group x, Channels 4 - 5 (rw) */
    unsigned int RG41: 1;                   /** \brief [17:17] Register Group x, Channels 4 - 5 (rw) */
    unsigned int RG42: 1;                   /** \brief [18:18] Register Group x, Channels 4 - 5 (rw) */
    unsigned int RG43: 1;                   /** \brief [19:19] Register Group x, Channels 4 - 5 (rw) */
    unsigned int RG44: 1;                   /** \brief [20:20] Register Group x, Channels 4 - 5 (rw) */
...
typedef struct
{
    ...
    unsigned int ITRMODE: 2;                /** \brief [9:8] Integrator Trigger ModeThe integration trigger mode controls bit INTEN in register and hence the operation of the integrator: Bit INTEN is set when ITRMODE=11 or when the selected trigger signal transition occurs. Bit INTEN is cleared when ITRMODE=00 or when the inverse trigger signal transition occurs. (rw) */
    unsigned int TSTRMODE: 2;               /** \brief [11:10] Timestamp Trigger ModeThe timestamp trigger mode controls capturing the timestamp information to register . (rw) */
...
typedef struct
{
    unsigned int CFADF: 8;                  /** \brief [7:0] Comb Filter (Auxiliary) Decimation Factor (rw) */
    unsigned int CFAC: 2;                   /** \brief [9:8] Comb Filter (Auxiliary) Configuration (rw) */
    ...
    unsigned int reserved_15: 9;
    unsigned int CFADCNT: 8;                /** \brief [31:24] Comb Filter (Auxiliary) Decimation Counter (rh) */
} Ifx_DSADC_CH_FCFGA_Bits;

/** Filter Configuration Register, Main Comb Filter */
typedef struct
{
    unsigned int CFMDF: 8;                  /** \brief [7:0] Comb Filter (Main Chain) Decimation Factor (rw) */
    unsigned int CFMC: 2;                   /** \brief [9:8] Comb Filter (Main Chain) Configuration (rw) */
    unsigned int CFEN: 1;                   /** \brief [10:10] Comb Filter Enable (rw) */
    unsigned int reserved_11: 3;
    unsigned int SRGM: 2;                   /** \brief [15:14] Service Request Generation Main Chain (rw) */
    unsigned int CFMSV: 8;                  /** \brief [23:16] Comb Filter (Main Chain) Start Value (rw) */
    unsigned int CFMDCNT: 8;                /** \brief [31:24] Comb Filter (Main Chain) Decimation Counter (rh) */
} Ifx_DSADC_CH_FCFGC_Bits;

/** Filter Configuration Register, Main Filter Chain */
typedef struct
{
...
typedef struct
{
    ...
    unsigned int INTEN: 1;                  /** \brief [7:7] Integration EnableFor the control of bit INTEN, see also bitfield ITRMODE in register . (rh) */
...
typedef struct
{
    ...
    unsigned int INCCFGN: 2;                /** \brief [3:2] Configuration of Negative Input Line (rw) */
...
typedef struct
{
    ...
    unsigned int SDVAL: 1;                  /** \brief [15:15] Valid Flag (rh) */
    unsigned int reserved_16: 14;
    unsigned int SDNCS: 1;                  /** \brief [30:30] Selected Carrier Sign Signal (rh) */
...
{
    unsigned int RESULT: 16;                /** \brief [15:0] Result of most recent conversion (rh) */
    unsigned int CFMDCNT: 8;                /** \brief [23:16] Comb Filter (Main Chain) Decimation Counter (rh) */
...
typedef struct
{
    unsigned int CHRUN: 16;                 /** \brief [15:0] Channel x Run Control (rw) */
    unsigned int MRUN: 16;                  /** \brief [31:16] Modulator x Run Control (rw) */
...
typedef volatile struct
{
    ...
    Ifx_DSADC_CH_FCFGC FCFGC;               /** \brief 14, Filter Configuration Register, Main Comb Filter */
    ...
    unsigned char reserved_24[4];           /** \brief 24 */
...
typedef volatile struct
{
    ...
    unsigned char reserved_8C[4];           /** \brief 8C */
