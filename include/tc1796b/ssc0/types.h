...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_FSTAT_t_nonv;

typedef volatile SSC0_FSTAT_t_nonv SSC0_FSTAT_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int RXFFLU:1;            /*  = [1..1] = 0x00000002 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_RXFCON_t_nonv;

typedef volatile SSC0_RXFCON_t_nonv SSC0_RXFCON_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int TXFFLU:1;            /*  = [1..1] = 0x00000002 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) SSC0_TXFCON_t_nonv;

typedef volatile SSC0_TXFCON_t_nonv SSC0_TXFCON_t;
