...
typedef union { /* 32 bits */
   struct {
      unsigned int THMINn:8;            /*  = [0..7] = 0x000000ff */
      unsigned int THMEDn:8;            /*  = [8..15] = 0x0000ff00 */
      unsigned int THMAXn:8;            /*  = [16..23] = 0x00ff0000 */
      unsigned int THCOUNT:8;           /*  = [24..31] = 0xff000000 */
   } bits;
   unsigned long reg; 
} __attribute__((aligned(4))) SCU_TCLRm_t_nonv;

typedef volatile SCU_TCLRm_t_nonv SCU_TCLRm_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) TGADCn_t_nonv;

typedef volatile TGADCn_t_nonv TGADCn_t;
