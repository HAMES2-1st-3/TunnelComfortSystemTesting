...
#include <tc1796b/p2/addr.h>

#include <tc1796b/p2/masks.h>
#include <tc1796b/p0_p1_p2_p3_p4_p5_p6_p7_p8_p9/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1796b/p2/types.h>
...
SFR_ABS (P2_ESR, P2_ESR_t, P2_ESR_ADDR);          /* "Port 2 Emergency Stop Register" */
...
SFR_ABS (P2_OUT, P2_OUT_t, P2_OUT_ADDR);          /* "Port 2 Output Register" */
SFR_ABS (P2_PDR, P2_PDR_t, P2_PDR_ADDR);          /* "Port 2 Pad Driver Mode Register" */


#endif /* /NO_TRICORE_SFRTYPEDEFS */
#endif /* _HAVE_TRICORE_P2_H_ (block "Port2") */
