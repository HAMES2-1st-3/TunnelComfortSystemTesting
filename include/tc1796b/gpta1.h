...
/* block "GPTA1" of TriCore TC1796B (286 SFRs) */

#include <tc1796b/gpta1/addr.h>

#include <tc1796b/gpta1/masks.h>
#include <tc1796b/gpta0_gpta1/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1796b/gpta1/types.h>
...
SFR_ABS (GPTA1_ID, GPTAn_ID_t, GPTA1_ID_ADDR);    /* "GPTA1 Module Identification Register" */
...
SFR_ABS (GPTA1_SRC00, GPTAn_SRCm_t, GPTA1_SRC00_ADDR); /* "GPTA1 Service Request Control Register 00" */
SFR_ABS (GPTA1_SRC01, GPTAn_SRCm_t, GPTA1_SRC01_ADDR); /* "GPTA1 Service Request Control Register 01" */
SFR_ABS (GPTA1_SRC02, GPTAn_SRCm_t, GPTA1_SRC02_ADDR); /* "GPTA1 Service Request Control Register 02" */
SFR_ABS (GPTA1_SRC03, GPTAn_SRCm_t, GPTA1_SRC03_ADDR); /* "GPTA1 Service Request Control Register 03" */
SFR_ABS (GPTA1_SRC04, GPTAn_SRCm_t, GPTA1_SRC04_ADDR); /* "GPTA1 Service Request Control Register 04" */
SFR_ABS (GPTA1_SRC05, GPTAn_SRCm_t, GPTA1_SRC05_ADDR); /* "GPTA1 Service Request Control Register 05" */
SFR_ABS (GPTA1_SRC06, GPTAn_SRCm_t, GPTA1_SRC06_ADDR); /* "GPTA1 Service Request Control Register 06" */
SFR_ABS (GPTA1_SRC07, GPTAn_SRCm_t, GPTA1_SRC07_ADDR); /* "GPTA1 Service Request Control Register 07" */
SFR_ABS (GPTA1_SRC08, GPTAn_SRCm_t, GPTA1_SRC08_ADDR); /* "GPTA1 Service Request Control Register 08" */
SFR_ABS (GPTA1_SRC09, GPTAn_SRCm_t, GPTA1_SRC09_ADDR); /* "GPTA1 Service Request Control Register 09" */
SFR_ABS (GPTA1_SRC10, GPTAn_SRCm_t, GPTA1_SRC10_ADDR); /* "GPTA1 Service Request Control Register 10" */
SFR_ABS (GPTA1_SRC11, GPTAn_SRCm_t, GPTA1_SRC11_ADDR); /* "GPTA1 Service Request Control Register 11" */
SFR_ABS (GPTA1_SRC12, GPTAn_SRCm_t, GPTA1_SRC12_ADDR); /* "GPTA1 Service Request Control Register 12" */
SFR_ABS (GPTA1_SRC13, GPTAn_SRCm_t, GPTA1_SRC13_ADDR); /* "GPTA1 Service Request Control Register 13" */
SFR_ABS (GPTA1_SRC14, GPTAn_SRCm_t, GPTA1_SRC14_ADDR); /* "GPTA1 Service Request Control Register 14" */
SFR_ABS (GPTA1_SRC15, GPTAn_SRCm_t, GPTA1_SRC15_ADDR); /* "GPTA1 Service Request Control Register 15" */
SFR_ABS (GPTA1_SRC16, GPTAn_SRCm_t, GPTA1_SRC16_ADDR); /* "GPTA1 Service Request Control Register 16" */
SFR_ABS (GPTA1_SRC17, GPTAn_SRCm_t, GPTA1_SRC17_ADDR); /* "GPTA1 Service Request Control Register 17" */
SFR_ABS (GPTA1_SRC18, GPTAn_SRCm_t, GPTA1_SRC18_ADDR); /* "GPTA1 Service Request Control Register 18" */
SFR_ABS (GPTA1_SRC19, GPTAn_SRCm_t, GPTA1_SRC19_ADDR); /* "GPTA1 Service Request Control Register 19" */
SFR_ABS (GPTA1_SRC20, GPTAn_SRCm_t, GPTA1_SRC20_ADDR); /* "GPTA1 Service Request Control Register 20" */
SFR_ABS (GPTA1_SRC21, GPTAn_SRCm_t, GPTA1_SRC21_ADDR); /* "GPTA1 Service Request Control Register 21" */
SFR_ABS (GPTA1_SRC22, GPTAn_SRCm_t, GPTA1_SRC22_ADDR); /* "GPTA1 Service Request Control Register 22" */
SFR_ABS (GPTA1_SRC23, GPTAn_SRCm_t, GPTA1_SRC23_ADDR); /* "GPTA1 Service Request Control Register 23" */
SFR_ABS (GPTA1_SRC24, GPTAn_SRCm_t, GPTA1_SRC24_ADDR); /* "GPTA1 Service Request Control Register 24" */
SFR_ABS (GPTA1_SRC25, GPTAn_SRCm_t, GPTA1_SRC25_ADDR); /* "GPTA1 Service Request Control Register 25" */
SFR_ABS (GPTA1_SRC26, GPTAn_SRCm_t, GPTA1_SRC26_ADDR); /* "GPTA1 Service Request Control Register 26" */
SFR_ABS (GPTA1_SRC27, GPTAn_SRCm_t, GPTA1_SRC27_ADDR); /* "GPTA1 Service Request Control Register 27" */
SFR_ABS (GPTA1_SRC28, GPTAn_SRCm_t, GPTA1_SRC28_ADDR); /* "GPTA1 Service Request Control Register 28" */
SFR_ABS (GPTA1_SRC29, GPTAn_SRCm_t, GPTA1_SRC29_ADDR); /* "GPTA1 Service Request Control Register 29" */
SFR_ABS (GPTA1_SRC30, GPTAn_SRCm_t, GPTA1_SRC30_ADDR); /* "GPTA1 Service Request Control Register 30" */
SFR_ABS (GPTA1_SRC31, GPTAn_SRCm_t, GPTA1_SRC31_ADDR); /* "GPTA1 Service Request Control Register 31" */
SFR_ABS (GPTA1_SRC32, GPTAn_SRCm_t, GPTA1_SRC32_ADDR); /* "GPTA1 Service Request Control Register 32" */
SFR_ABS (GPTA1_SRC33, GPTAn_SRCm_t, GPTA1_SRC33_ADDR); /* "GPTA1 Service Request Control Register 33" */
SFR_ABS (GPTA1_SRC34, GPTAn_SRCm_t, GPTA1_SRC34_ADDR); /* "GPTA1 Service Request Control Register 34" */
SFR_ABS (GPTA1_SRC35, GPTAn_SRCm_t, GPTA1_SRC35_ADDR); /* "GPTA1 Service Request Control Register 35" */
SFR_ABS (GPTA1_SRC36, GPTAn_SRCm_t, GPTA1_SRC36_ADDR); /* "GPTA1 Service Request Control Register 36" */
SFR_ABS (GPTA1_SRC37, GPTAn_SRCm_t, GPTA1_SRC37_ADDR); /* "GPTA1 Service Request Control Register 37" */
