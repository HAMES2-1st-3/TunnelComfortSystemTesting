...
#ifndef _TC1796B_CAN_STRUCTS_H_
#define _TC1796B_CAN_STRUCTS_H_
/*
   TriCore TC1796B
...
typedef struct
{
    ...
    unsigned int    reserved52[0x19];   /* 0x21c */
    CAN_LTR_t       LTR;                /* 0x280 */
    ...
    unsigned int    reserved63[0x6];    /* 0x2a8 */
    ...
    unsigned int    reserved71[0x5];    /* 0x2dc */
    CAN_STSRL_t     STSRL;              /* 0x2f0 */
    CAN_STSRH_t     STSRH;              /* 0x2f4 */
    CAN_SISR_t      SISR;               /* 0x2f8 */
    unsigned int    reserved75[0x1];    /* 0x2fc */
    CAN_NODE_t      NODE1;              /* 0x300 */
    unsigned int    reserved77[0x39];   /* 0x31c */
    CAN_NODE_t      NODE2;              /* 0x400 */
    unsigned int    reserved79[0x39];   /* 0x41c */
    CAN_NODE_t      NODE3;              /* 0x500 */
    unsigned int    reserved81[0x39];   /* 0x51c */
    CAN_MO_t        MO[0x80];           /* 0x600 */
    unsigned int    reserved83[0x7f];   /* 0x1600 */
    CAN_STPTR0_t    STPTR0;             /* 0x17fc */
} CAN_t;

#endif /* _TC1796B_CAN_STRUCTS_H_ */
