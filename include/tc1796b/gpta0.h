...
/* block "GPTA0" of TriCore TC1796B (294 SFRs) */

#include <tc1796b/gpta0/addr.h>

#include <tc1796b/gpta0/masks.h>
#include <tc1796b/gpta0_gpta1/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1796b/gpta0/types.h>
#include <tc1796b/gpta0_gpta1/sharetypes.h>
...
SFR_ABS (GPTA0_CLC, GPTA0_CLC_t, GPTA0_CLC_ADDR); /* "GPTA0 Clock Control Register" */
SFR_ABS (GPTA0_DBGCTR, GPTA0_DBGCTR_t, GPTA0_DBGCTR_ADDR); /* "GPTA0 Debug Clock Control Register" */
...
SFR_ABS (GPTA0_EDCTR, GPTA0_EDCTR_t, GPTA0_EDCTR_ADDR); /* "GPTA0 Clock Enable/Disable Control Register" */
SFR_ABS (GPTA0_FDR, GPTA0_FDR_t, GPTA0_FDR_ADDR); /* "GPTA0 Fractional Divider Register" */
...
SFR_ABS (GPTA0_ID, GPTAn_ID_t, GPTA0_ID_ADDR);    /* "GPTA0 Module Identification Register" */
...
SFR_ABS (GPTA0_SRC00, GPTAn_SRCm_t, GPTA0_SRC00_ADDR); /* "GPTA0 Service Request Control Register 00" */
SFR_ABS (GPTA0_SRC01, GPTAn_SRCm_t, GPTA0_SRC01_ADDR); /* "GPTA0 Service Request Control Register 01" */
SFR_ABS (GPTA0_SRC02, GPTAn_SRCm_t, GPTA0_SRC02_ADDR); /* "GPTA0 Service Request Control Register 02" */
SFR_ABS (GPTA0_SRC03, GPTAn_SRCm_t, GPTA0_SRC03_ADDR); /* "GPTA0 Service Request Control Register 03" */
SFR_ABS (GPTA0_SRC04, GPTAn_SRCm_t, GPTA0_SRC04_ADDR); /* "GPTA0 Service Request Control Register 04" */
SFR_ABS (GPTA0_SRC05, GPTAn_SRCm_t, GPTA0_SRC05_ADDR); /* "GPTA0 Service Request Control Register 05" */
SFR_ABS (GPTA0_SRC06, GPTAn_SRCm_t, GPTA0_SRC06_ADDR); /* "GPTA0 Service Request Control Register 06" */
SFR_ABS (GPTA0_SRC07, GPTAn_SRCm_t, GPTA0_SRC07_ADDR); /* "GPTA0 Service Request Control Register 07" */
SFR_ABS (GPTA0_SRC08, GPTAn_SRCm_t, GPTA0_SRC08_ADDR); /* "GPTA0 Service Request Control Register 08" */
SFR_ABS (GPTA0_SRC09, GPTAn_SRCm_t, GPTA0_SRC09_ADDR); /* "GPTA0 Service Request Control Register 09" */
SFR_ABS (GPTA0_SRC10, GPTAn_SRCm_t, GPTA0_SRC10_ADDR); /* "GPTA0 Service Request Control Register 10" */
SFR_ABS (GPTA0_SRC11, GPTAn_SRCm_t, GPTA0_SRC11_ADDR); /* "GPTA0 Service Request Control Register 11" */
SFR_ABS (GPTA0_SRC12, GPTAn_SRCm_t, GPTA0_SRC12_ADDR); /* "GPTA0 Service Request Control Register 12" */
SFR_ABS (GPTA0_SRC13, GPTAn_SRCm_t, GPTA0_SRC13_ADDR); /* "GPTA0 Service Request Control Register 13" */
SFR_ABS (GPTA0_SRC14, GPTAn_SRCm_t, GPTA0_SRC14_ADDR); /* "GPTA0 Service Request Control Register 14" */
SFR_ABS (GPTA0_SRC15, GPTAn_SRCm_t, GPTA0_SRC15_ADDR); /* "GPTA0 Service Request Control Register 15" */
SFR_ABS (GPTA0_SRC16, GPTAn_SRCm_t, GPTA0_SRC16_ADDR); /* "GPTA0 Service Request Control Register 16" */
SFR_ABS (GPTA0_SRC17, GPTAn_SRCm_t, GPTA0_SRC17_ADDR); /* "GPTA0 Service Request Control Register 17" */
SFR_ABS (GPTA0_SRC18, GPTAn_SRCm_t, GPTA0_SRC18_ADDR); /* "GPTA0 Service Request Control Register 18" */
SFR_ABS (GPTA0_SRC19, GPTAn_SRCm_t, GPTA0_SRC19_ADDR); /* "GPTA0 Service Request Control Register 19" */
SFR_ABS (GPTA0_SRC20, GPTAn_SRCm_t, GPTA0_SRC20_ADDR); /* "GPTA0 Service Request Control Register 20" */
SFR_ABS (GPTA0_SRC21, GPTAn_SRCm_t, GPTA0_SRC21_ADDR); /* "GPTA0 Service Request Control Register 21" */
SFR_ABS (GPTA0_SRC22, GPTAn_SRCm_t, GPTA0_SRC22_ADDR); /* "GPTA0 Service Request Control Register 22" */
SFR_ABS (GPTA0_SRC23, GPTAn_SRCm_t, GPTA0_SRC23_ADDR); /* "GPTA0 Service Request Control Register 23" */
SFR_ABS (GPTA0_SRC24, GPTAn_SRCm_t, GPTA0_SRC24_ADDR); /* "GPTA0 Service Request Control Register 24" */
SFR_ABS (GPTA0_SRC25, GPTAn_SRCm_t, GPTA0_SRC25_ADDR); /* "GPTA0 Service Request Control Register 25" */
SFR_ABS (GPTA0_SRC26, GPTAn_SRCm_t, GPTA0_SRC26_ADDR); /* "GPTA0 Service Request Control Register 26" */
SFR_ABS (GPTA0_SRC27, GPTAn_SRCm_t, GPTA0_SRC27_ADDR); /* "GPTA0 Service Request Control Register 27" */
SFR_ABS (GPTA0_SRC28, GPTAn_SRCm_t, GPTA0_SRC28_ADDR); /* "GPTA0 Service Request Control Register 28" */
SFR_ABS (GPTA0_SRC29, GPTAn_SRCm_t, GPTA0_SRC29_ADDR); /* "GPTA0 Service Request Control Register 29" */
SFR_ABS (GPTA0_SRC30, GPTAn_SRCm_t, GPTA0_SRC30_ADDR); /* "GPTA0 Service Request Control Register 30" */
SFR_ABS (GPTA0_SRC31, GPTAn_SRCm_t, GPTA0_SRC31_ADDR); /* "GPTA0 Service Request Control Register 31" */
SFR_ABS (GPTA0_SRC32, GPTAn_SRCm_t, GPTA0_SRC32_ADDR); /* "GPTA0 Service Request Control Register 32" */
SFR_ABS (GPTA0_SRC33, GPTAn_SRCm_t, GPTA0_SRC33_ADDR); /* "GPTA0 Service Request Control Register 33" */
SFR_ABS (GPTA0_SRC34, GPTAn_SRCm_t, GPTA0_SRC34_ADDR); /* "GPTA0 Service Request Control Register 34" */
SFR_ABS (GPTA0_SRC35, GPTAn_SRCm_t, GPTA0_SRC35_ADDR); /* "GPTA0 Service Request Control Register 35" */
SFR_ABS (GPTA0_SRC36, GPTAn_SRCm_t, GPTA0_SRC36_ADDR); /* "GPTA0 Service Request Control Register 36" */
SFR_ABS (GPTA0_SRC37, GPTAn_SRCm_t, GPTA0_SRC37_ADDR); /* "GPTA0 Service Request Control Register 37" */
