...
#ifndef _HAVE_TRICORE_PBCU_TYPES_H_
#define _HAVE_TRICORE_PBCU_TYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) PBCU_ID_t_nonv;

typedef volatile PBCU_ID_t_nonv PBCU_ID_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) PBCU_LEADDR_t_nonv;

typedef volatile PBCU_LEADDR_t_nonv PBCU_LEADDR_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) PBCU_LEATT_t_nonv;

typedef volatile PBCU_LEATT_t_nonv PBCU_LEATT_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) PBCU_LEDATH_t_nonv;

typedef volatile PBCU_LEDATH_t_nonv PBCU_LEDATH_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) PBCU_LEDATL_t_nonv;

typedef volatile PBCU_LEDATL_t_nonv PBCU_LEDATL_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) PBCU_SRC_t_nonv;

typedef volatile PBCU_SRC_t_nonv PBCU_SRC_t;


#endif /* _HAVE_TRICORE_PBCU_TYPES_H_ */
