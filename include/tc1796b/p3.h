...
#include <tc1796b/p3/addr.h>

#include <tc1796b/p3/masks.h>
#include <tc1796b/p0_p1_p2_p3_p4_p5_p6_p7_p8_p9/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1796b/p3/types.h>
...
SFR_ABS (P3_IN, P3_IN_t, P3_IN_ADDR);             /* "Port 3 Input Register" */
...
SFR_ABS (P3_OUT, P3_OUT_t, P3_OUT_ADDR);          /* "Port 3 Output Register" */
SFR_ABS (P3_PDR, Pn_PDR_t, P3_PDR_ADDR);          /* "Port 3 Pad Driver Mode Register" */


#endif /* /NO_TRICORE_SFRTYPEDEFS */
#endif /* _HAVE_TRICORE_P3_H_ (block "Port3") */
