...
#ifndef _TC1796B_LTCA_STRUCTS_H_
#define _TC1796B_LTCA_STRUCTS_H_
/*
   TriCore TC1796B
...
#ifndef _LTCA_LTC63_T_
#define _LTCA_LTC63_T_
typedef struct 
{
    LTCA2_LTCCTR63_t CTR;               /* 0x0 */    
    LTCA2_LTCXR63_t XR;                 /* 0x4 */    
} LTCA_LTC63_t;
#endif /* _LTCA_LTC63_T_ */
...
typedef struct
{
    ...
    LTCA_LTC_t      LTC[0x3f];          /* 0x200 */
    LTCA_LTC63_t    LTC63;              /* 0x3f8 */
...
#endif /* _TC1796B_LTCA_STRUCTS_H_ */
