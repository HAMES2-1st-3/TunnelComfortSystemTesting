...
#include <tc1796b/can/addr.h>

#include <tc1796b/can/masks.h>
#include <tc1796b/can/sharemasks.h>

#ifndef NO_TRICORE_SFRTYPEDEFS

#include <tc1796b/can/types.h>
#include <tc1796b/can/sharetypes.h>
...
SFR_NOABS (CAN_AWDR, CAN_AWDR_t, CAN_AWDR_ADDR);  /* "CAN Application Watchdog Register" */
SFR_NOABS (CAN_CLC, CAN_CLC_t, CAN_CLC_ADDR);     /* "CAN Clock Control Register" */
SFR_NOABS (CAN_CYCTMR, CAN_CYCTMR_t, CAN_CYCTMR_ADDR); /* "CAN Cycle Time Register" */
SFR_NOABS (CAN_FDR, CAN_FDR_t, CAN_FDR_ADDR);     /* "CAN Fractional Divider Register" */
SFR_NOABS (CAN_GMR, CAN_GMR_t, CAN_GMR_ADDR);     /* "CAN Global Mark Register" */
SFR_NOABS (CAN_ID, CAN_ID_t, CAN_ID_ADDR);        /* "CAN Module Identification Register" */
SFR_NOABS (CAN_LGMR, CAN_LGMR_t, CAN_LGMR_ADDR);  /* "CAN Last Global Mark Register" */
...
SFR_NOABS (CAN_LOR, CAN_LOR_t, CAN_LOR_ADDR);     /* "CAN Local Offset Register" */
SFR_NOABS (CAN_LREFMR, CAN_LREFMR_t, CAN_LREFMR_ADDR); /* "CAN Last Reference Mark Register" */
SFR_NOABS (CAN_LTR, CAN_LTR_t, CAN_LTR_ADDR);     /* "CAN Local Time Register" */
...
SFR_NOABS (CAN_MOSTAT0, CAN_MOSTATm_t, CAN_MOSTAT0_ADDR); /* "Message Object 0" */
SFR_NOABS (CAN_MOSTAT1, CAN_MOSTATm_t, CAN_MOSTAT1_ADDR); /* "Message Object 1" */
SFR_NOABS (CAN_MOSTAT10, CAN_MOSTATm_t, CAN_MOSTAT10_ADDR); /* "Message Object 10" */
SFR_NOABS (CAN_MOSTAT100, CAN_MOSTATm_t, CAN_MOSTAT100_ADDR); /* "Message Object 100" */
SFR_NOABS (CAN_MOSTAT101, CAN_MOSTATm_t, CAN_MOSTAT101_ADDR); /* "Message Object 101" */
SFR_NOABS (CAN_MOSTAT102, CAN_MOSTATm_t, CAN_MOSTAT102_ADDR); /* "Message Object 102" */
SFR_NOABS (CAN_MOSTAT103, CAN_MOSTATm_t, CAN_MOSTAT103_ADDR); /* "Message Object 103" */
SFR_NOABS (CAN_MOSTAT104, CAN_MOSTATm_t, CAN_MOSTAT104_ADDR); /* "Message Object 104" */
SFR_NOABS (CAN_MOSTAT105, CAN_MOSTATm_t, CAN_MOSTAT105_ADDR); /* "Message Object 105" */
SFR_NOABS (CAN_MOSTAT106, CAN_MOSTATm_t, CAN_MOSTAT106_ADDR); /* "Message Object 106" */
SFR_NOABS (CAN_MOSTAT107, CAN_MOSTATm_t, CAN_MOSTAT107_ADDR); /* "Message Object 107" */
SFR_NOABS (CAN_MOSTAT108, CAN_MOSTATm_t, CAN_MOSTAT108_ADDR); /* "Message Object 108" */
SFR_NOABS (CAN_MOSTAT109, CAN_MOSTATm_t, CAN_MOSTAT109_ADDR); /* "Message Object 109" */
SFR_NOABS (CAN_MOSTAT11, CAN_MOSTATm_t, CAN_MOSTAT11_ADDR); /* "Message Object 11" */
SFR_NOABS (CAN_MOSTAT110, CAN_MOSTATm_t, CAN_MOSTAT110_ADDR); /* "Message Object 110" */
SFR_NOABS (CAN_MOSTAT111, CAN_MOSTATm_t, CAN_MOSTAT111_ADDR); /* "Message Object 111" */
SFR_NOABS (CAN_MOSTAT112, CAN_MOSTATm_t, CAN_MOSTAT112_ADDR); /* "Message Object 112" */
SFR_NOABS (CAN_MOSTAT113, CAN_MOSTATm_t, CAN_MOSTAT113_ADDR); /* "Message Object 113" */
SFR_NOABS (CAN_MOSTAT114, CAN_MOSTATm_t, CAN_MOSTAT114_ADDR); /* "Message Object 114" */
SFR_NOABS (CAN_MOSTAT115, CAN_MOSTATm_t, CAN_MOSTAT115_ADDR); /* "Message Object 115" */
SFR_NOABS (CAN_MOSTAT116, CAN_MOSTATm_t, CAN_MOSTAT116_ADDR); /* "Message Object 116" */
SFR_NOABS (CAN_MOSTAT117, CAN_MOSTATm_t, CAN_MOSTAT117_ADDR); /* "Message Object 117" */
SFR_NOABS (CAN_MOSTAT118, CAN_MOSTATm_t, CAN_MOSTAT118_ADDR); /* "Message Object 118" */
SFR_NOABS (CAN_MOSTAT119, CAN_MOSTATm_t, CAN_MOSTAT119_ADDR); /* "Message Object 119" */
SFR_NOABS (CAN_MOSTAT12, CAN_MOSTATm_t, CAN_MOSTAT12_ADDR); /* "Message Object 12" */
SFR_NOABS (CAN_MOSTAT120, CAN_MOSTATm_t, CAN_MOSTAT120_ADDR); /* "Message Object 120" */
SFR_NOABS (CAN_MOSTAT121, CAN_MOSTATm_t, CAN_MOSTAT121_ADDR); /* "Message Object 121" */
SFR_NOABS (CAN_MOSTAT122, CAN_MOSTATm_t, CAN_MOSTAT122_ADDR); /* "Message Object 122" */
SFR_NOABS (CAN_MOSTAT123, CAN_MOSTATm_t, CAN_MOSTAT123_ADDR); /* "Message Object 123" */
SFR_NOABS (CAN_MOSTAT124, CAN_MOSTATm_t, CAN_MOSTAT124_ADDR); /* "Message Object 124" */
SFR_NOABS (CAN_MOSTAT125, CAN_MOSTATm_t, CAN_MOSTAT125_ADDR); /* "Message Object 125" */
SFR_NOABS (CAN_MOSTAT126, CAN_MOSTATm_t, CAN_MOSTAT126_ADDR); /* "Message Object 126" */
SFR_NOABS (CAN_MOSTAT127, CAN_MOSTATm_t, CAN_MOSTAT127_ADDR); /* "Message Object 127" */
SFR_NOABS (CAN_MOSTAT13, CAN_MOSTATm_t, CAN_MOSTAT13_ADDR); /* "Message Object 13" */
SFR_NOABS (CAN_MOSTAT14, CAN_MOSTATm_t, CAN_MOSTAT14_ADDR); /* "Message Object 14" */
SFR_NOABS (CAN_MOSTAT15, CAN_MOSTATm_t, CAN_MOSTAT15_ADDR); /* "Message Object 15" */
SFR_NOABS (CAN_MOSTAT16, CAN_MOSTATm_t, CAN_MOSTAT16_ADDR); /* "Message Object 16" */
SFR_NOABS (CAN_MOSTAT17, CAN_MOSTATm_t, CAN_MOSTAT17_ADDR); /* "Message Object 17" */
SFR_NOABS (CAN_MOSTAT18, CAN_MOSTATm_t, CAN_MOSTAT18_ADDR); /* "Message Object 18" */
SFR_NOABS (CAN_MOSTAT19, CAN_MOSTATm_t, CAN_MOSTAT19_ADDR); /* "Message Object 19" */
SFR_NOABS (CAN_MOSTAT2, CAN_MOSTATm_t, CAN_MOSTAT2_ADDR); /* "Message Object 2" */
SFR_NOABS (CAN_MOSTAT20, CAN_MOSTATm_t, CAN_MOSTAT20_ADDR); /* "Message Object 20" */
SFR_NOABS (CAN_MOSTAT21, CAN_MOSTATm_t, CAN_MOSTAT21_ADDR); /* "Message Object 21" */
SFR_NOABS (CAN_MOSTAT22, CAN_MOSTATm_t, CAN_MOSTAT22_ADDR); /* "Message Object 22" */
SFR_NOABS (CAN_MOSTAT23, CAN_MOSTATm_t, CAN_MOSTAT23_ADDR); /* "Message Object 23" */
SFR_NOABS (CAN_MOSTAT24, CAN_MOSTATm_t, CAN_MOSTAT24_ADDR); /* "Message Object 24" */
SFR_NOABS (CAN_MOSTAT25, CAN_MOSTATm_t, CAN_MOSTAT25_ADDR); /* "Message Object 25" */
SFR_NOABS (CAN_MOSTAT26, CAN_MOSTATm_t, CAN_MOSTAT26_ADDR); /* "Message Object 26" */
SFR_NOABS (CAN_MOSTAT27, CAN_MOSTATm_t, CAN_MOSTAT27_ADDR); /* "Message Object 27" */
SFR_NOABS (CAN_MOSTAT28, CAN_MOSTATm_t, CAN_MOSTAT28_ADDR); /* "Message Object 28" */
SFR_NOABS (CAN_MOSTAT29, CAN_MOSTATm_t, CAN_MOSTAT29_ADDR); /* "Message Object 29" */
SFR_NOABS (CAN_MOSTAT3, CAN_MOSTATm_t, CAN_MOSTAT3_ADDR); /* "Message Object 3" */
SFR_NOABS (CAN_MOSTAT30, CAN_MOSTATm_t, CAN_MOSTAT30_ADDR); /* "Message Object 30" */
SFR_NOABS (CAN_MOSTAT31, CAN_MOSTATm_t, CAN_MOSTAT31_ADDR); /* "Message Object 31" */
SFR_NOABS (CAN_MOSTAT32, CAN_MOSTATm_t, CAN_MOSTAT32_ADDR); /* "Message Object 32" */
SFR_NOABS (CAN_MOSTAT33, CAN_MOSTATm_t, CAN_MOSTAT33_ADDR); /* "Message Object 33" */
SFR_NOABS (CAN_MOSTAT34, CAN_MOSTATm_t, CAN_MOSTAT34_ADDR); /* "Message Object 34" */
SFR_NOABS (CAN_MOSTAT35, CAN_MOSTATm_t, CAN_MOSTAT35_ADDR); /* "Message Object 35" */
SFR_NOABS (CAN_MOSTAT36, CAN_MOSTATm_t, CAN_MOSTAT36_ADDR); /* "Message Object 36" */
SFR_NOABS (CAN_MOSTAT37, CAN_MOSTATm_t, CAN_MOSTAT37_ADDR); /* "Message Object 37" */
SFR_NOABS (CAN_MOSTAT38, CAN_MOSTATm_t, CAN_MOSTAT38_ADDR); /* "Message Object 38" */
SFR_NOABS (CAN_MOSTAT39, CAN_MOSTATm_t, CAN_MOSTAT39_ADDR); /* "Message Object 39" */
SFR_NOABS (CAN_MOSTAT4, CAN_MOSTATm_t, CAN_MOSTAT4_ADDR); /* "Message Object 4" */
SFR_NOABS (CAN_MOSTAT40, CAN_MOSTATm_t, CAN_MOSTAT40_ADDR); /* "Message Object 40" */
SFR_NOABS (CAN_MOSTAT41, CAN_MOSTATm_t, CAN_MOSTAT41_ADDR); /* "Message Object 41" */
SFR_NOABS (CAN_MOSTAT42, CAN_MOSTATm_t, CAN_MOSTAT42_ADDR); /* "Message Object 42" */
SFR_NOABS (CAN_MOSTAT43, CAN_MOSTATm_t, CAN_MOSTAT43_ADDR); /* "Message Object 43" */
SFR_NOABS (CAN_MOSTAT44, CAN_MOSTATm_t, CAN_MOSTAT44_ADDR); /* "Message Object 44" */
SFR_NOABS (CAN_MOSTAT45, CAN_MOSTATm_t, CAN_MOSTAT45_ADDR); /* "Message Object 45" */
SFR_NOABS (CAN_MOSTAT46, CAN_MOSTATm_t, CAN_MOSTAT46_ADDR); /* "Message Object 46" */
SFR_NOABS (CAN_MOSTAT47, CAN_MOSTATm_t, CAN_MOSTAT47_ADDR); /* "Message Object 47" */
SFR_NOABS (CAN_MOSTAT48, CAN_MOSTATm_t, CAN_MOSTAT48_ADDR); /* "Message Object 48" */
SFR_NOABS (CAN_MOSTAT49, CAN_MOSTATm_t, CAN_MOSTAT49_ADDR); /* "Message Object 49" */
SFR_NOABS (CAN_MOSTAT5, CAN_MOSTATm_t, CAN_MOSTAT5_ADDR); /* "Message Object 5" */
SFR_NOABS (CAN_MOSTAT50, CAN_MOSTATm_t, CAN_MOSTAT50_ADDR); /* "Message Object 50" */
SFR_NOABS (CAN_MOSTAT51, CAN_MOSTATm_t, CAN_MOSTAT51_ADDR); /* "Message Object 51" */
SFR_NOABS (CAN_MOSTAT52, CAN_MOSTATm_t, CAN_MOSTAT52_ADDR); /* "Message Object 52" */
SFR_NOABS (CAN_MOSTAT53, CAN_MOSTATm_t, CAN_MOSTAT53_ADDR); /* "Message Object 53" */
SFR_NOABS (CAN_MOSTAT54, CAN_MOSTATm_t, CAN_MOSTAT54_ADDR); /* "Message Object 54" */
SFR_NOABS (CAN_MOSTAT55, CAN_MOSTATm_t, CAN_MOSTAT55_ADDR); /* "Message Object 55" */
SFR_NOABS (CAN_MOSTAT56, CAN_MOSTATm_t, CAN_MOSTAT56_ADDR); /* "Message Object 56" */
SFR_NOABS (CAN_MOSTAT57, CAN_MOSTATm_t, CAN_MOSTAT57_ADDR); /* "Message Object 57" */
SFR_NOABS (CAN_MOSTAT58, CAN_MOSTATm_t, CAN_MOSTAT58_ADDR); /* "Message Object 58" */
SFR_NOABS (CAN_MOSTAT59, CAN_MOSTATm_t, CAN_MOSTAT59_ADDR); /* "Message Object 59" */
SFR_NOABS (CAN_MOSTAT6, CAN_MOSTATm_t, CAN_MOSTAT6_ADDR); /* "Message Object 6" */
SFR_NOABS (CAN_MOSTAT60, CAN_MOSTATm_t, CAN_MOSTAT60_ADDR); /* "Message Object 60" */
SFR_NOABS (CAN_MOSTAT61, CAN_MOSTATm_t, CAN_MOSTAT61_ADDR); /* "Message Object 61" */
SFR_NOABS (CAN_MOSTAT62, CAN_MOSTATm_t, CAN_MOSTAT62_ADDR); /* "Message Object 62" */
SFR_NOABS (CAN_MOSTAT63, CAN_MOSTATm_t, CAN_MOSTAT63_ADDR); /* "Message Object 63" */
SFR_NOABS (CAN_MOSTAT64, CAN_MOSTATm_t, CAN_MOSTAT64_ADDR); /* "Message Object 64" */
SFR_NOABS (CAN_MOSTAT65, CAN_MOSTATm_t, CAN_MOSTAT65_ADDR); /* "Message Object 65" */
SFR_NOABS (CAN_MOSTAT66, CAN_MOSTATm_t, CAN_MOSTAT66_ADDR); /* "Message Object 66" */
SFR_NOABS (CAN_MOSTAT67, CAN_MOSTATm_t, CAN_MOSTAT67_ADDR); /* "Message Object 67" */
SFR_NOABS (CAN_MOSTAT68, CAN_MOSTATm_t, CAN_MOSTAT68_ADDR); /* "Message Object 68" */
SFR_NOABS (CAN_MOSTAT69, CAN_MOSTATm_t, CAN_MOSTAT69_ADDR); /* "Message Object 69" */
SFR_NOABS (CAN_MOSTAT7, CAN_MOSTATm_t, CAN_MOSTAT7_ADDR); /* "Message Object 7" */
SFR_NOABS (CAN_MOSTAT70, CAN_MOSTATm_t, CAN_MOSTAT70_ADDR); /* "Message Object 70" */
SFR_NOABS (CAN_MOSTAT71, CAN_MOSTATm_t, CAN_MOSTAT71_ADDR); /* "Message Object 71" */
SFR_NOABS (CAN_MOSTAT72, CAN_MOSTATm_t, CAN_MOSTAT72_ADDR); /* "Message Object 72" */
SFR_NOABS (CAN_MOSTAT73, CAN_MOSTATm_t, CAN_MOSTAT73_ADDR); /* "Message Object 73" */
SFR_NOABS (CAN_MOSTAT74, CAN_MOSTATm_t, CAN_MOSTAT74_ADDR); /* "Message Object 74" */
SFR_NOABS (CAN_MOSTAT75, CAN_MOSTATm_t, CAN_MOSTAT75_ADDR); /* "Message Object 75" */
SFR_NOABS (CAN_MOSTAT76, CAN_MOSTATm_t, CAN_MOSTAT76_ADDR); /* "Message Object 76" */
SFR_NOABS (CAN_MOSTAT77, CAN_MOSTATm_t, CAN_MOSTAT77_ADDR); /* "Message Object 77" */
SFR_NOABS (CAN_MOSTAT78, CAN_MOSTATm_t, CAN_MOSTAT78_ADDR); /* "Message Object 78" */
SFR_NOABS (CAN_MOSTAT79, CAN_MOSTATm_t, CAN_MOSTAT79_ADDR); /* "Message Object 79" */
SFR_NOABS (CAN_MOSTAT8, CAN_MOSTATm_t, CAN_MOSTAT8_ADDR); /* "Message Object 8" */
SFR_NOABS (CAN_MOSTAT80, CAN_MOSTATm_t, CAN_MOSTAT80_ADDR); /* "Message Object 80" */
SFR_NOABS (CAN_MOSTAT81, CAN_MOSTATm_t, CAN_MOSTAT81_ADDR); /* "Message Object 81" */
SFR_NOABS (CAN_MOSTAT82, CAN_MOSTATm_t, CAN_MOSTAT82_ADDR); /* "Message Object 82" */
SFR_NOABS (CAN_MOSTAT83, CAN_MOSTATm_t, CAN_MOSTAT83_ADDR); /* "Message Object 83" */
SFR_NOABS (CAN_MOSTAT84, CAN_MOSTATm_t, CAN_MOSTAT84_ADDR); /* "Message Object 84" */
SFR_NOABS (CAN_MOSTAT85, CAN_MOSTATm_t, CAN_MOSTAT85_ADDR); /* "Message Object 85" */
SFR_NOABS (CAN_MOSTAT86, CAN_MOSTATm_t, CAN_MOSTAT86_ADDR); /* "Message Object 86" */
SFR_NOABS (CAN_MOSTAT87, CAN_MOSTATm_t, CAN_MOSTAT87_ADDR); /* "Message Object 87" */
SFR_NOABS (CAN_MOSTAT88, CAN_MOSTATm_t, CAN_MOSTAT88_ADDR); /* "Message Object 88" */
SFR_NOABS (CAN_MOSTAT89, CAN_MOSTATm_t, CAN_MOSTAT89_ADDR); /* "Message Object 89" */
SFR_NOABS (CAN_MOSTAT9, CAN_MOSTATm_t, CAN_MOSTAT9_ADDR); /* "Message Object 9" */
SFR_NOABS (CAN_MOSTAT90, CAN_MOSTATm_t, CAN_MOSTAT90_ADDR); /* "Message Object 90" */
SFR_NOABS (CAN_MOSTAT91, CAN_MOSTATm_t, CAN_MOSTAT91_ADDR); /* "Message Object 91" */
SFR_NOABS (CAN_MOSTAT92, CAN_MOSTATm_t, CAN_MOSTAT92_ADDR); /* "Message Object 92" */
SFR_NOABS (CAN_MOSTAT93, CAN_MOSTATm_t, CAN_MOSTAT93_ADDR); /* "Message Object 93" */
SFR_NOABS (CAN_MOSTAT94, CAN_MOSTATm_t, CAN_MOSTAT94_ADDR); /* "Message Object 94" */
SFR_NOABS (CAN_MOSTAT95, CAN_MOSTATm_t, CAN_MOSTAT95_ADDR); /* "Message Object 95" */
SFR_NOABS (CAN_MOSTAT96, CAN_MOSTATm_t, CAN_MOSTAT96_ADDR); /* "Message Object 96" */
SFR_NOABS (CAN_MOSTAT97, CAN_MOSTATm_t, CAN_MOSTAT97_ADDR); /* "Message Object 97" */
SFR_NOABS (CAN_MOSTAT98, CAN_MOSTATm_t, CAN_MOSTAT98_ADDR); /* "Message Object 98" */
SFR_NOABS (CAN_MOSTAT99, CAN_MOSTATm_t, CAN_MOSTAT99_ADDR); /* "Message Object 99" */
...
SFR_NOABS (CAN_NBTR2, CAN_NBTRm_t, CAN_NBTR2_ADDR); /* "CAN Node 2 Bit Timing Register" */
...
SFR_NOABS (CAN_NCR2, CAN_NCRm_t, CAN_NCR2_ADDR);  /* "CAN Node 2 Control Register" */
...
SFR_NOABS (CAN_NECNT2, CAN_NECNTm_t, CAN_NECNT2_ADDR); /* "CAN Node 2 Error Counter Register" */
...
SFR_NOABS (CAN_NFCR2, CAN_NFCRm_t, CAN_NFCR2_ADDR); /* "CAN Node 2 Frame Counter Register" */
...
SFR_NOABS (CAN_NIPR2, CAN_NIPRm_t, CAN_NIPR2_ADDR); /* "CAN Node 2 Interrupt Pointer Register" */
...
SFR_NOABS (CAN_NPCR2, CAN_NPCRm_t, CAN_NPCR2_ADDR); /* "CAN Node 2 Port Control Register" */
...
SFR_NOABS (CAN_NSR2, CAN_NSRm_t, CAN_NSR2_ADDR);  /* "CAN Node 2 Status Register" */
...
SFR_NOABS (CAN_REFMR, CAN_REFMR_t, CAN_REFMR_ADDR); /* "CAN Reference Mark Register" */
SFR_NOABS (CAN_SISR, CAN_SISR_t, CAN_SISR_ADDR);  /* "CAN Scheduler Instruction Status Register" */
...
SFR_NOABS (CAN_STPTR0, CAN_STPTR0_t, CAN_STPTR0_ADDR); /* "CAN Scheduler Start Pointer Node 0 Register" */
SFR_NOABS (CAN_STSRH, CAN_STSRH_t, CAN_STSRH_ADDR); /* "CAN Scheduler Timing Status Register High" */
SFR_NOABS (CAN_STSRL, CAN_STSRL_t, CAN_STSRL_ADDR); /* "CAN Scheduler Timing Status Register Low" */
SFR_NOABS (CAN_SYNMR, CAN_SYNMR_t, CAN_SYNMR_ADDR); /* "CAN Synchronization Mark Register" */
SFR_NOABS (CAN_TTCFGR, CAN_TTCFGR_t, CAN_TTCFGR_ADDR); /* "CAN Time Trigger Configuration Register" */
SFR_NOABS (CAN_TTCR, CAN_TTCR_t, CAN_TTCR_ADDR);  /* "CAN Time Trigger Control Register" */
SFR_NOABS (CAN_TTFMR, CAN_TTFMR_t, CAN_TTFMR_ADDR); /* "CAN Time Trigger Flag Modification Register" */
SFR_NOABS (CAN_TTIER, CAN_TTIER_t, CAN_TTIER_ADDR); /* "CAN Time Trigger Interrupt Enable Register" */
SFR_NOABS (CAN_TTINPR, CAN_TTINPR_t, CAN_TTINPR_ADDR); /* "CAN Time Trigger Interrupt Node Pointer Register" */
SFR_NOABS (CAN_TTIRR, CAN_TTIRR_t, CAN_TTIRR_ADDR); /* "CAN Time Trigger Interrupt Request Register" */
SFR_NOABS (CAN_TTSR, CAN_TTSR_t, CAN_TTSR_ADDR);  /* "CAN Time Trigger Status Register" */
SFR_NOABS (CAN_TURR, CAN_TURR_t, CAN_TURR_ADDR);  /* "CAN Time Unit Ratio Register" */
