...
#ifndef _HAVE_TRICORE_P8_TYPES_H_
#define _HAVE_TRICORE_P8_TYPES_H_
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P8_ESR_t_nonv;

typedef volatile P8_ESR_t_nonv P8_ESR_t;
...
typedef union { /* 32 bits */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P8_OMR_t_nonv;

typedef volatile P8_OMR_t_nonv P8_OMR_t;
...
typedef union { /* 32 bits */
   struct {
      ...
      unsigned int _bit14:1;            /* 0 = [14..14] = 0x00004000 */
      unsigned int _bit15:1;            /* 0 = [15..15] = 0x00008000 */
      unsigned int PDMLI1:3;            /*  = [16..18] = 0x00070000 */
      unsigned int _bit19:1;            /* 0 = [19..19] = 0x00080000 */
      unsigned int _bit20:1;            /* 0 = [20..20] = 0x00100000 */
      unsigned int _bit21:1;            /* 0 = [21..21] = 0x00200000 */
      unsigned int _bit22:1;            /* 0 = [22..22] = 0x00400000 */
   ...
   unsigned long reg; 
} __attribute__((aligned(4))) P8_PDR_t_nonv;

typedef volatile P8_PDR_t_nonv P8_PDR_t;


#endif /* _HAVE_TRICORE_P8_TYPES_H_ */
